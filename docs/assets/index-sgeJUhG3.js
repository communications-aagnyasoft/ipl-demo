...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function Vf(){return new ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gh(),fragmentShader:`
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function Hf(){return new ji({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gh(),fragmentShader:`
...
`)}function IT(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ao).join(`
`)}function PT(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function DT(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ao(i){return i!==""}function Qf(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ep(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const LT=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yu(i){return i.replace(LT,OT)}const NT=new Map;function OT(i,e){let t=Ve[e];if(t===void 0){const n=NT.get(e);if(n!==void 0)t=Ve[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Yu(t)}const UT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function tp(i){return i.replace(UT,FT)}function FT(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function np(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function kT(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Am?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Rm?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===di&&(e="SHADOWMAP_TYPE_VSM"),e}function BT(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ws:case Cs:e="ENVMAP_TYPE_CUBE";break;case Cl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zT(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Cs:e="ENVMAP_MODE_REFRACTION";break}return e}function VT(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Im:e="ENVMAP_BLENDING_MULTIPLY";break;case q0:e="ENVMAP_BLENDING_MIX";break;case Y0:e="ENVMAP_BLENDING_ADD";break}return e}function HT(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function GT(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=kT(t),c=BT(t),u=zT(t),h=VT(t),d=HT(t),f=IT(t),_=PT(s),g=r.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(ao).join(`
`)),o=Yu(o),o=Qf(o,t),o=ep(o,t),a=Yu(a),a=Qf(a,t),a=ep(a,t),o=tp(o),a=tp(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
*/var xn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Ds={duration:.5,overwrite:!1,delay:0},Wh,zt,mt,Zn=1e8,qt=1/Zn,$u=Math.PI*2,Mb=$u/4,Tb=0,g_=Math.sqrt,bb=Math.cos,wb=Math.sin,kt=function(e){return typeof e=="string"},Mt=function(e){return typeof e=="function"},Mi=function(e){return typeof e=="number"},Xh=function(e){return typeof e>"u"},ti=function(e){return typeof e=="object"},sn=function(e){return e!==!1},qh=function(){return typeof window<"u"},Oa=function(e){return Mt(e)||kt(e)},v_=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},$t=Array.isArray,Ku=/(?:-?\.?\d|\.)+/gi,x_=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,ds=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Dc=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,y_=/[+-]=-?[.\d]+/,S_=/[^,'"\[\]\s]+/gi,Cb=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,gt,Xn,ju,Yh,Sn={},el={},E_,M_=function(e){return(el=Ls(e,Sn))&&hn},$h=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},Ao=function(e,t){return!t&&console.warn(e)},T_=function(e,t){return e&&(Sn[e]=t)&&el&&(el[e]=t)||Sn},Ro=function(){return 0},Ab={suppressEvents:!0,isStart:!0,kill:!1},Xa={suppressEvents:!0,kill:!1},Rb={suppressEvents:!0},Kh={},Gi=[],Zu={},b_,_n={},Lc={},op=30,qa=[],jh="",Zh=function(e){var t=e[0],n,r;if(ti(t)||Mt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=qa.length;r--&&!qa[r].targetTest(t););n=qa[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new K_(e[r],n)))||e.splice(r,1);return e},Ir=function(e){return e._gsap||Zh(In(e))[0]._gsap},w_=function(e,t,n){return(n=e[t])&&Mt(n)?e[t]():Xh(n)&&e.getAttribute&&e.getAttribute(t)||n},on=function(e,t){return(e=e.split(",")).forEach(t)||e},bt=function(e){return Math.round(e*1e5)/1e5||0},Rt=function(e){return Math.round(e*1e7)/1e7||0},ys=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+r:n==="-"?e-r:n==="*"?e*r:e/r},Ib=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},tl=function(){var e=Gi.length,t=Gi.slice(0),n,r;for(Zu={},Gi.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},C_=function(e,t,n,r){Gi.length&&!zt&&tl(),e.render(t,n,zt&&t<0&&(e._initted||e._startAt)),Gi.length&&!zt&&tl()},A_=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(S_).length<2?t:kt(e)?e.trim():e},R_=function(e){return e},En=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},Pb=function(e){return function(t,n){for(var r in n)r in t||r==="duration"&&e||r==="ease"||(t[r]=n[r])}},Ls=function(e,t){for(var n in t)e[n]=t[n];return e},ap=function i(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=ti(t[n])?i(e[n]||(e[n]={}),t[n]):t[n]);return e},nl=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},mo=function(e){var t=e.parent||gt,n=e.keyframes?Pb($t(e.keyframes)):En;if(sn(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},Db=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},I_=function(e,t,n,r,s){var o=e[r],a;if(s)for(a=t[s];o&&o[s]>a;)o=o._prev;return o?(t._next=o._next,o._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=o,t.parent=t._dp=e,t},Pl=function(e,t,n,r){n===void 0&&(n="_first"),r===void 0&&(r="_last");var s=t._prev,o=t._next;s?s._next=o:e[n]===t&&(e[n]=o),o?o._prev=s:e[r]===t&&(e[r]=s),t._next=t._prev=t.parent=null},Zi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Pr=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},Lb=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Ju=function(e,t,n,r){return e._startAt&&(zt?e._startAt.revert(Xa):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},Nb=function i(e){return!e||e._ts&&i(e.parent)},lp=function(e){return e._repeat?Ns(e._tTime,e=e.duration()+e._rDelay)*e:0},Ns=function(e,t){var n=Math.floor(e=Rt(e/t));return e&&n===e?n-1:n},il=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Dl=function(e){return e._end=Rt(e._start+(e._tDur/Math.abs(e._ts||e._rts||qt)||0))},Ll=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=Rt(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Dl(e),n._dirty||Pr(n,e)),e},P_=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=il(e.rawTime(),t),(!t._dur||ea(0,t.totalDuration(),n)-t._tTime>qt)&&t.render(n,!0)),Pr(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-1e-8}},Yn=function(e,t,n,r){return t.parent&&Zi(t),t._start=Rt((Mi(n)?n:n||e!==gt?wn(e,n,t):e._time)+t._delay),t._end=Rt(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),I_(e,t,"_first","_last",e._sort?"_start":0),Qu(t)||(e._recent=t),r||P_(e,t),e._ts<0&&Ll(e,e._tTime),e},D_=function(e,t){return(Sn.ScrollTrigger||$h("scrollTrigger",t))&&Sn.ScrollTrigger.create(t,e)},L_=function(e,t,n,r,s){if(Qh(e,t,s),!e._initted)return 1;if(!n&&e._pt&&!zt&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&b_!==gn.frame)return Gi.push(e),e._lazy=[s,r],1},Ob=function i(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||i(t))},Qu=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},Ub=function(e,t,n,r){var s=e.ratio,o=t<0||!t&&(!e._start&&Ob(e)&&!(!e._initted&&Qu(e))||(e._ts<0||e._dp._ts<0)&&!Qu(e))?0:1,a=e._rDelay,l=0,c,u,h;if(a&&e._repeat&&(l=ea(0,e._tDur,t),u=Ns(l,a),e._yoyo&&u&1&&(o=1-o),u!==Ns(e._tTime,a)&&(s=1-o,e.vars.repeatRefresh&&e._initted&&e.invalidate())),o!==s||zt||r||e._zTime===qt||!t&&e._zTime){if(!e._initted&&L_(e,t,r,n,l))return;for(h=e._zTime,e._zTime=t||(n?qt:0),n||(n=t&&!h),e.ratio=o,e._from&&(o=1-o),e._time=0,e._tTime=l,c=e._pt;c;)c.r(o,c.d),c=c._next;t<0&&Ju(e,t,n,!0),e._onUpdate&&!n&&vn(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&vn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===o&&(o&&Zi(e,1),!n&&!zt&&(vn(e,o?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},Fb=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data==="isPause"&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data==="isPause"&&r._start<t)return r;r=r._prev}},Os=function(e,t,n,r){var s=e._repeat,o=Rt(t)||0,a=e._tTime/e._tDur;return a&&!r&&(e._time*=o/e._dur),e._dur=o,e._tDur=s?s<0?1e10:Rt(o*(s+1)+e._rDelay*s):o,a>0&&!r&&Ll(e,e._tTime=e._tDur*a),e.parent&&Dl(e),n||Pr(e.parent,e),e},cp=function(e){return e instanceof Zt?Pr(e):Os(e,e._dur)},kb={_start:0,endTime:Ro,totalDuration:Ro},wn=function i(e,t,n){var r=e.labels,s=e._recent||kb,o=e.duration()>=Zn?s.endTime(!1):e._dur,a,l,c;return kt(t)&&(isNaN(t)||t in r)?(l=t.charAt(0),c=t.substr(-1)==="%",a=t.indexOf("="),l==="<"||l===">"?(a>=0&&(t=t.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(a<0?s:n).totalDuration()/100:1)):a<0?(t in r||(r[t]=o),r[t]):(l=parseFloat(t.charAt(a-1)+t.substr(a+1)),c&&n&&(l=l/100*($t(n)?n[0]:n).totalDuration()),a>1?i(e,t.substr(0,a-1),n)+l:o+l)):t==null?o:+t},_o=function(e,t,n){var r=Mi(t[1]),s=(r?2:1)+(e<2?0:1),o=t[s],a,l;if(r&&(o.duration=t[1]),o.parent=n,e){for(a=o,l=n;l&&!("immediateRender"in a);)a=l.vars.defaults||{},l=sn(l.vars.inherit)&&l.parent;o.immediateRender=sn(a.immediateRender),e<2?o.runBackwards=1:o.startAt=t[s-1]}return new At(t[0],o,t[s+1])},rr=function(e,t){return e||e===0?t(e):t},ea=function(e,t,n){return n<e?e:n>t?t:n},Xt=function(e,t){return!kt(e)||!(t=Cb.exec(e))?"":t[1]},Bb=function(e,t,n){return rr(n,function(r){return ea(e,t,r)})},eh=[].slice,N_=function(e,t){return e&&ti(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&ti(e[0]))&&!e.nodeType&&e!==Xn},zb=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(r){var s;return kt(r)&&!t||N_(r,1)?(s=n).push.apply(s,In(r)):n.push(r)})||n},In=function(e,t,n){return mt&&!t&&mt.selector?mt.selector(e):kt(e)&&!n&&(ju||!Us())?eh.call((t||Yh).querySelectorAll(e),0):$t(e)?zb(e,n):N_(e)?eh.call(e,0):e?[e]:[]},th=function(e){return e=In(e)[0]||Ao("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return In(t,n.querySelectorAll?n:n===e?Ao("Invalid scope")||Yh.createElement("div"):e)}},O_=function(e){return e.sort(function(){return .5-Math.random()})},U_=function(e){if(Mt(e))return e;var t=ti(e)?e:{each:e},n=Dr(t.ease),r=t.from||0,s=parseFloat(t.base)||0,o={},a=r>0&&r<1,l=isNaN(r)||a,c=t.axis,u=r,h=r;return kt(r)?u=h={center:.5,edges:.5,end:1}[r]||0:!a&&l&&(u=r[0],h=r[1]),function(d,f,_){var g=(_||t).length,m=o[g],p,T,x,v,C,A,b,I,y;if(!m){if(y=t.grid==="auto"?0:(t.grid||[1,Zn])[1],!y){for(b=-1e8;b<(b=_[y++].getBoundingClientRect().left)&&y<g;);y<g&&y--}for(m=o[g]=[],p=l?Math.min(y,g)*u-.5:r%y,T=y===Zn?0:l?g*h/y-.5:r/y|0,b=0,I=Zn,A=0;A<g;A++)x=A%y-p,v=T-(A/y|0),m[A]=C=c?Math.abs(c==="y"?v:x):g_(x*x+v*v),C>b&&(b=C),C<I&&(I=C);r==="random"&&O_(m),m.max=b-I,m.min=I,m.v=g=(parseFloat(t.amount)||parseFloat(t.each)*(y>g?g-1:c?c==="y"?g/y:y:Math.max(y,g/y))||0)*(r==="edges"?-1:1),m.b=g<0?s-g:s,m.u=Xt(t.amount||t.each)||0,n=n&&g<0?q_(n):n}return g=(m[d]-m.min)/m.max||0,Rt(m.b+(n?n(g):g)*m.v)+m.u}},nh=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var r=Rt(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+(Mi(n)?0:Xt(n))}},F_=function(e,t){var n=$t(e),r,s;return!n&&ti(e)&&(r=n=e.radius||Zn,e.values?(e=In(e.values),(s=!Mi(e[0]))&&(r*=r)):e=nh(e.increment)),rr(t,n?Mt(e)?function(o){return s=e(o),Math.abs(s-o)<=r?s:o}:function(o){for(var a=parseFloat(s?o.x:o),l=parseFloat(s?o.y:0),c=Zn,u=0,h=e.length,d,f;h--;)s?(d=e[h].x-a,f=e[h].y-l,d=d*d+f*f):d=Math.abs(e[h]-a),d<c&&(c=d,u=h);return u=!r||c<=r?e[u]:o,s||u===o||Mi(o)?u:u+Xt(o)}:nh(e))},k_=function(e,t,n,r){return rr($t(e)?!t:n===!0?!!(n=0):!r,function(){return $t(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(r=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},Vb=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(r){return t.reduce(function(s,o){return o(s)},r)}},Hb=function(e,t){return function(n){return e(parseFloat(n))+(t||Xt(n))}},Gb=function(e,t,n){return z_(e,t,0,1,n)},B_=function(e,t,n){return rr(n,function(r){return e[~~t(r)]})},Wb=function i(e,t,n){var r=t-e;return $t(e)?B_(e,i(0,e.length),t):rr(n,function(s){return(r+(s-e)%r)%r+e})},Xb=function i(e,t,n){var r=t-e,s=r*2;return $t(e)?B_(e,i(0,e.length-1),t):rr(n,function(o){return o=(s+(o-e)%s)%s||0,e+(o>r?s-o:o)})},Io=function(e){for(var t=0,n="",r,s,o,a;~(r=e.indexOf("random(",t));)o=e.indexOf(")",r),a=e.charAt(r+7)==="[",s=e.substr(r+7,o-r-7).match(a?S_:Ku),n+=e.substr(t,r-t)+k_(a?s:+s[0],a?0:+s[1],+s[2]||1e-5),t=o+1;return n+e.substr(t,e.length-t)},z_=function(e,t,n,r,s){var o=t-e,a=r-n;return rr(s,function(l){return n+((l-e)/o*a||0)})},qb=function i(e,t,n,r){var s=isNaN(e+t)?0:function(f){return(1-f)*e+f*t};if(!s){var o=kt(e),a={},l,c,u,h,d;if(n===!0&&(r=1)&&(n=null),o)e={p:e},t={p:t};else if($t(e)&&!$t(t)){for(u=[],h=e.length,d=h-2,c=1;c<h;c++)u.push(i(e[c-1],e[c]));h--,s=function(_){_*=h;var g=Math.min(d,~~_);return u[g](_-g)},n=t}else r||(e=Ls($t(e)?[]:{},e));if(!u){for(l in t)Jh.call(a,e,l,"get",t[l]);s=function(_){return nd(_,a)||(o?e.p:e)}}}return rr(n,s)},up=function(e,t,n){var r=e.labels,s=Zn,o,a,l;for(o in r)a=r[o]-t,a<0==!!n&&a&&s>(a=Math.abs(a))&&(l=o,s=a);return l},vn=function(e,t,n){var r=e.vars,s=r[t],o=mt,a=e._ctx,l,c,u;if(s)return l=r[t+"Params"],c=r.callbackScope||e,n&&Gi.length&&tl(),a&&(mt=a),u=l?s.apply(c,l):s.call(c),mt=o,u},lo=function(e){return Zi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!zt),e.progress()<1&&vn(e,"onInterrupt"),e},fs,V_=[],H_=function(e){if(e)if(e=!e.name&&e.default||e,qh()||e.headless){var t=e.name,n=Mt(e),r=t&&!n&&e.init?function(){this._props=[]}:e,s={init:Ro,render:nd,add:Jh,kill:lw,modifier:aw,rawVars:0},o={targetTest:0,get:0,getSetter:td,aliases:{},register:0};if(Us(),e!==r){if(_n[t])return;En(r,En(nl(e,s),o)),Ls(r.prototype,Ls(s,nl(e,o))),_n[r.prop=t]=r,e.targetTest&&(qa.push(r),Kh[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}T_(t,r),e.register&&e.register(hn,r,an)}else V_.push(e)},lt=255,co={aqua:[0,lt,lt],lime:[0,lt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,lt],navy:[0,0,128],white:[lt,lt,lt],olive:[128,128,0],yellow:[lt,lt,0],orange:[lt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[lt,0,0],pink:[lt,192,203],cyan:[0,lt,lt],transparent:[lt,lt,lt,0]},Nc=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*lt+.5|0},G_=function(e,t,n){var r=e?Mi(e)?[e>>16,e>>8&lt,e&lt]:0:co.black,s,o,a,l,c,u,h,d,f,_;if(!r){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),co[e])r=co[e];else if(e.charAt(0)==="#"){if(e.length<6&&(s=e.charAt(1),o=e.charAt(2),a=e.charAt(3),e="#"+s+s+o+o+a+a+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&lt,r&lt,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&lt,e&lt]}else if(e.substr(0,3)==="hsl"){if(r=_=e.match(Ku),!t)l=+r[0]%360/360,c=+r[1]/100,u=+r[2]/100,o=u<=.5?u*(c+1):u+c-u*c,s=u*2-o,r.length>3&&(r[3]*=1),r[0]=Nc(l+1/3,s,o),r[1]=Nc(l,s,o),r[2]=Nc(l-1/3,s,o);else if(~e.indexOf("="))return r=e.match(x_),n&&r.length<4&&(r[3]=1),r}else r=e.match(Ku)||co.transparent;r=r.map(Number)}return t&&!_&&(s=r[0]/lt,o=r[1]/lt,a=r[2]/lt,h=Math.max(s,o,a),d=Math.min(s,o,a),u=(h+d)/2,h===d?l=c=0:(f=h-d,c=u>.5?f/(2-h-d):f/(h+d),l=h===s?(o-a)/f+(o<a?6:0):h===o?(a-s)/f+2:(s-o)/f+4,l*=60),r[0]=~~(l+.5),r[1]=~~(c*100+.5),r[2]=~~(u*100+.5)),n&&r.length<4&&(r[3]=1),r},W_=function(e){var t=[],n=[],r=-1;return e.split(Wi).forEach(function(s){var o=s.match(ds)||[];t.push.apply(t,o),n.push(r+=o.length+1)}),t.c=n,t},hp=function(e,t,n){var r="",s=(e+r).match(Wi),o=t?"hsla(":"rgba(",a=0,l,c,u,h;if(!s)return e;if(s=s.map(function(d){return(d=G_(d,t,1))&&o+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(u=W_(e),l=n.c,l.join(r)!==u.c.join(r)))for(c=e.replace(Wi,"1").split(ds),h=c.length-1;a<h;a++)r+=c[a]+(~l.indexOf(a)?s.shift()||o+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=e.split(Wi),h=c.length-1;a<h;a++)r+=c[a]+s[a];return r+c[h]},Wi=function(){var i="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in co)i+="|"+e+"\\b";return new RegExp(i+")","gi")}(),Yb=/hsl[a]?\(/,X_=function(e){var t=e.join(" "),n;if(Wi.lastIndex=0,Wi.test(t))return n=Yb.test(t),e[1]=hp(e[1],n),e[0]=hp(e[0],n,W_(e[1])),!0},Po,gn=function(){var i=Date.now,e=500,t=33,n=i(),r=n,s=1e3/240,o=s,a=[],l,c,u,h,d,f,_=function g(m){var p=i()-r,T=m===!0,x,v,C,A;if((p>e||p<0)&&(n+=p-t),r+=p,C=r-n,x=C-o,(x>0||T)&&(A=++h.frame,d=C-h.time*1e3,h.time=C=C/1e3,o+=x+(x>=s?4:s-x),v=1),T||(l=c(g)),v)for(f=0;f<a.length;f++)a[f](C,d,A,m)};return h={time:0,frame:0,tick:function(){_(!0)},deltaRatio:function(m){return d/(1e3/(m||60))},wake:function(){E_&&(!ju&&qh()&&(Xn=ju=window,Yh=Xn.document||{},Sn.gsap=hn,(Xn.gsapVersions||(Xn.gsapVersions=[])).push(hn.version),M_(el||Xn.GreenSockGlobals||!Xn.gsap&&Xn||{}),V_.forEach(H_)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(m){return setTimeout(m,o-h.time*1e3+1|0)},Po=1,_(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),Po=0,c=Ro},lagSmoothing:function(m,p){e=m||1/0,t=Math.min(p||33,e)},fps:function(m){s=1e3/(m||240),o=h.time*1e3+s},add:function(m,p,T){var x=p?function(v,C,A,b){m(v,C,A,b),h.remove(x)}:m;return h.remove(m),a[T?"unshift":"push"](x),Us(),x},remove:function(m,p){~(p=a.indexOf(m))&&a.splice(p,1)&&f>=p&&f--},_listeners:a},h}(),Us=function(){return!Po&&gn.wake()},$e={},$b=/^[\d.\-M][\d.\-,\s]/,Kb=/["']/g,jb=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),r=n[0],s=1,o=n.length,a,l,c;s<o;s++)l=n[s],a=s!==o-1?l.lastIndexOf(","):l.length,c=l.substr(0,a),t[r]=isNaN(c)?c.replace(Kb,"").trim():+c,r=l.substr(a+1).trim();return t},Zb=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),r=e.indexOf("(",t);return e.substring(t,~r&&r<n?e.indexOf(")",n+1):n)},Jb=function(e){var t=(e+"").split("("),n=$e[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[jb(t[1])]:Zb(e).split(",").map(A_)):$e._CE&&$b.test(e)?$e._CE("",e):n},q_=function(e){return function(t){return 1-e(1-t)}},Y_=function i(e,t){for(var n=e._first,r;n;)n instanceof Zt?i(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?i(n.timeline,t):(r=n._ease,n._ease=n._yEase,n._yEase=r,n._yoyo=t)),n=n._next},Dr=function(e,t){return e&&(Mt(e)?e:$e[e]||Jb(e))||t},Wr=function(e,t,n,r){n===void 0&&(n=function(l){return 1-t(1-l)}),r===void 0&&(r=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var s={easeIn:t,easeOut:n,easeInOut:r},o;return on(e,function(a){$e[a]=Sn[a]=s,$e[o=a.toLowerCase()]=n;for(var l in s)$e[o+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=$e[a+"."+l]=s[l]}),s},$_=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},Oc=function i(e,t,n){var r=t>=1?t:1,s=(n||(e?.3:.45))/(t<1?t:1),o=s/$u*(Math.asin(1/r)||0),a=function(u){return u===1?1:r*Math.pow(2,-10*u)*wb((u-o)*s)+1},l=e==="out"?a:e==="in"?function(c){return 1-a(1-c)}:$_(a);return s=$u/s,l.config=function(c,u){return i(e,c,u)},l},Uc=function i(e,t){t===void 0&&(t=1.70158);var n=function(o){return o?--o*o*((t+1)*o+t)+1:0},r=e==="out"?n:e==="in"?function(s){return 1-n(1-s)}:$_(n);return r.config=function(s){return i(e,s)},r};on("Linear,Quad,Cubic,Quart,Quint,Strong",function(i,e){var t=e<5?e+1:e;Wr(i+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});$e.Linear.easeNone=$e.none=$e.Linear.easeIn;Wr("Elastic",Oc("in"),Oc("out"),Oc());(function(i,e){var t=1/e,n=2*t,r=2.5*t,s=function(a){return a<t?i*a*a:a<n?i*Math.pow(a-1.5/e,2)+.75:a<r?i*(a-=2.25/e)*a+.9375:i*Math.pow(a-2.625/e,2)+.984375};Wr("Bounce",function(o){return 1-s(1-o)},s)})(7.5625,2.75);Wr("Expo",function(i){return Math.pow(2,10*(i-1))*i+i*i*i*i*i*i*(1-i)});Wr("Circ",function(i){return-(g_(1-i*i)-1)});Wr("Sine",function(i){return i===1?1:-bb(i*Mb)+1});Wr("Back",Uc("in"),Uc("out"),Uc());$e.SteppedEase=$e.steps=Sn.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+(t?0:1),s=t?1:0,o=1-qt;return function(a){return((r*ea(0,o,a)|0)+s)*n}}};Ds.ease=$e["quad.out"];on("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(i){return jh+=i+","+i+"Params,"});var K_=function(e,t){this.id=Tb++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:w_,this.set=t?t.getSetter:td},Do=function(){function i(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Os(this,+t.duration,1,1),this.data=t.data,mt&&(this._ctx=mt,mt.data.push(this)),Po||gn.wake()}var e=i.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Os(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,r){if(Us(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(Ll(this,n),!s._dp||s.parent||P_(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Yn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!r||this._initted&&Math.abs(this._zTime)===qt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),C_(this,n,r)),this},e.time=function(n,r){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+lp(this))%(this._dur+this._rDelay)||(n?this._dur:0),r):this._time},e.totalProgress=function(n,r){return arguments.length?this.totalTime(this.totalDuration()*n,r):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,r){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+lp(this),r):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,r){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,r):this._repeat?Ns(this._tTime,s)+1:1},e.timeScale=function(n,r){if(!arguments.length)return this._rts===-1e-8?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?il(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-1e-8?0:this._rts,this.totalTime(ea(-Math.abs(this._delay),this._tDur,s),r!==!1),Dl(this),Lb(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Us(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==qt&&(this._tTime-=qt)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=n;var r=this.parent||this._dp;return r&&(r._sort||!this.parent)&&Yn(r,this,n-this._delay),this}return this._start},e.endTime=function(n){return this._start+(sn(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var r=this.parent||this._dp;return r?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?il(r.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=Rb);var r=zt;return zt=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),zt=r,this},e.globalTime=function(n){for(var r=this,s=arguments.length?n:r.rawTime();r;)s=r._start+s/(Math.abs(r._ts)||1),r=r._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,cp(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var r=this._time;return this._rDelay=n,cp(this),r?this.time(r):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,r){return this.totalTime(wn(this,n),sn(r))},e.restart=function(n,r){return this.play().totalTime(n?-this._delay:0,sn(r)),this._dur||(this._zTime=-1e-8),this},e.play=function(n,r){return n!=null&&this.seek(n,r),this.reversed(!1).paused(!1)},e.reverse=function(n,r){return n!=null&&this.seek(n||this.totalDuration(),r),this.reversed(!0).paused(!1)},e.pause=function(n,r){return n!=null&&this.seek(n,r),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-1e-8:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-1e-8,this},e.isActive=function(){var n=this.parent||this._dp,r=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=r&&s<this.endTime(!0)-qt)},e.eventCallback=function(n,r,s){var o=this.vars;return arguments.length>1?(r?(o[n]=r,s&&(o[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=r)):delete o[n],this):o[n]},e.then=function(n){var r=this;return new Promise(function(s){var o=Mt(n)?n:R_,a=function(){var c=r.then;r.then=null,Mt(o)&&(o=o(r))&&(o.then||o===r)&&(r.then=c),s(o),r.then=c};r._initted&&r.totalProgress()===1&&r._ts>=0||!r._tTime&&r._ts<0?a():r._prom=a})},e.kill=function(){lo(this)},i}();En(Do.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-1e-8,_prom:0,_ps:!1,_rts:1});var Zt=function(i){__(e,i);function e(n,r){var s;return n===void 0&&(n={}),s=i.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=sn(n.sortChildren),gt&&Yn(n.parent||gt,fi(s),r),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&D_(fi(s),n.scrollTrigger),s}var t=e.prototype;return t.to=function(r,s,o){return _o(0,arguments,this),this},t.from=function(r,s,o){return _o(1,arguments,this),this},t.fromTo=function(r,s,o,a){return _o(2,arguments,this),this},t.set=function(r,s,o){return s.duration=0,s.parent=this,mo(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new At(r,s,wn(this,o),1),this},t.call=function(r,s,o){return Yn(this,At.delayedCall(0,r,s),o)},t.staggerTo=function(r,s,o,a,l,c,u){return o.duration=s,o.stagger=o.stagger||a,o.onComplete=c,o.onCompleteParams=u,o.parent=this,new At(r,o,wn(this,l)),this},t.staggerFrom=function(r,s,o,a,l,c,u){return o.runBackwards=1,mo(o).immediateRender=sn(o.immediateRender),this.staggerTo(r,s,o,a,l,c,u)},t.staggerFromTo=function(r,s,o,a,l,c,u,h){return a.startAt=o,mo(a).immediateRender=sn(a.immediateRender),this.staggerTo(r,s,a,l,c,u,h)},t.render=function(r,s,o){var a=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=r<=0?0:Rt(r),h=this._zTime<0!=r<0&&(this._initted||!c),d,f,_,g,m,p,T,x,v,C,A,b;if(this!==gt&&u>l&&r>=0&&(u=l),u!==this._tTime||o||h){if(a!==this._time&&c&&(u+=this._time-a,r+=this._time-a),d=u,v=this._start,x=this._ts,p=!x,h&&(c||(a=this._zTime),(r||!s)&&(this._zTime=r)),this._repeat){if(A=this._yoyo,m=c+this._rDelay,this._repeat<-1&&r<0)return this.totalTime(m*100+r,s,o);if(d=Rt(u%m),u===l?(g=this._repeat,d=c):(C=Rt(u/m),g=~~C,g&&g===C&&(d=c,g--),d>c&&(d=c)),C=Ns(this._tTime,m),!a&&this._tTime&&C!==g&&this._tTime-C*m-this._dur<=0&&(C=g),A&&g&1&&(d=c-d,b=1),g!==C&&!this._lock){var I=A&&C&1,y=I===(A&&g&1);if(g<C&&(I=!I),a=I?0:u%c?c:u,this._lock=1,this.render(a||(b?0:Rt(g*m)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&vn(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),a&&a!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,y&&(this._lock=2,a=I?c:-1e-4,this.render(a,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;Y_(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(T=Fb(this,Rt(a),Rt(d)),T&&(u-=d-(d=T._start))),this._tTime=u,this._time=d,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=r,a=0),!a&&d&&!s&&!g&&(vn(this,"onStart"),this._tTime!==u))return this;if(d>=a&&r>=0)for(f=this._first;f;){if(_=f._next,(f._act||d>=f._start)&&f._ts&&T!==f){if(f.parent!==this)return this.render(r,s,o);if(f.render(f._ts>0?(d-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(d-f._start)*f._ts,s,o),d!==this._time||!this._ts&&!p){T=0,_&&(u+=this._zTime=-1e-8);break}}f=_}else{f=this._last;for(var E=r<0?r:d;f;){if(_=f._prev,(f._act||E<=f._end)&&f._ts&&T!==f){if(f.parent!==this)return this.render(r,s,o);if(f.render(f._ts>0?(E-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(E-f._start)*f._ts,s,o||zt&&(f._initted||f._startAt)),d!==this._time||!this._ts&&!p){T=0,_&&(u+=this._zTime=E?-1e-8:qt);break}}f=_}}if(T&&!s&&(this.pause(),T.render(d>=a?0:-1e-8)._zTime=d>=a?1:-1,this._ts))return this._start=v,Dl(this),this.render(r,s,o);this._onUpdate&&!s&&vn(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&a)&&(v===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((r||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&Zi(this,1),!s&&!(r<0&&!a)&&(u||a||!l)&&(vn(this,u===l&&r>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(r,s){var o=this;if(Mi(s)||(s=wn(this,s,r)),!(r instanceof Do)){if($t(r))return r.forEach(function(a){return o.add(a,s)}),this;if(kt(r))return this.addLabel(r,s);if(Mt(r))r=At.delayedCall(0,r);else return this}return this!==r?Yn(this,r,s):this},t.getChildren=function(r,s,o,a){r===void 0&&(r=!0),s===void 0&&(s=!0),o===void 0&&(o=!0),a===void 0&&(a=-1e8);for(var l=[],c=this._first;c;)c._start>=a&&(c instanceof At?s&&l.push(c):(o&&l.push(c),r&&l.push.apply(l,c.getChildren(!0,s,o)))),c=c._next;return l},t.getById=function(r){for(var s=this.getChildren(1,1,1),o=s.length;o--;)if(s[o].vars.id===r)return s[o]},t.remove=function(r){return kt(r)?this.removeLabel(r):Mt(r)?this.killTweensOf(r):(r.parent===this&&Pl(this,r),r===this._recent&&(this._recent=this._last),Pr(this))},t.totalTime=function(r,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=Rt(gn.time-(this._ts>0?r/this._ts:(this.totalDuration()-r)/-this._ts))),i.prototype.totalTime.call(this,r,s),this._forcing=0,this):this._tTime},t.addLabel=function(r,s){return this.labels[r]=wn(this,s),this},t.removeLabel=function(r){return delete this.labels[r],this},t.addPause=function(r,s,o){var a=At.delayedCall(0,s||Ro,o);return a.data="isPause",this._hasPause=1,Yn(this,a,wn(this,r))},t.removePause=function(r){var s=this._first;for(r=wn(this,r);s;)s._start===r&&s.data==="isPause"&&Zi(s),s=s._next},t.killTweensOf=function(r,s,o){for(var a=this.getTweensOf(r,o),l=a.length;l--;)ki!==a[l]&&a[l].kill(r,s);return this},t.getTweensOf=function(r,s){for(var o=[],a=In(r),l=this._first,c=Mi(s),u;l;)l instanceof At?Ib(l._targets,a)&&(c?(!ki||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&o.push(l):(u=l.getTweensOf(a,s)).length&&o.push.apply(o,u),l=l._next;return o},t.tweenTo=function(r,s){s=s||{};var o=this,a=wn(o,r),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,d=l.immediateRender,f,_=At.to(o,En({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:a,overwrite:"auto",duration:s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale())||qt,onStart:function(){if(o.pause(),!f){var m=s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale());_._dur!==m&&Os(_,m,0,1).render(_._time,!0,!0),f=1}u&&u.apply(_,h||[])}},s));return d?_.render(0):_},t.tweenFromTo=function(r,s,o){return this.tweenTo(s,En({startAt:{time:wn(this,r)}},o))},t.recent=function(){return this._recent},t.nextLabel=function(r){return r===void 0&&(r=this._time),up(this,wn(this,r))},t.previousLabel=function(r){return r===void 0&&(r=this._time),up(this,wn(this,r),1)},t.currentLabel=function(r){return arguments.length?this.seek(r,!0):this.previousLabel(this._time+qt)},t.shiftChildren=function(r,s,o){o===void 0&&(o=0);for(var a=this._first,l=this.labels,c;a;)a._start>=o&&(a._start+=r,a._end+=r),a=a._next;if(s)for(c in l)l[c]>=o&&(l[c]+=r);return Pr(this)},t.invalidate=function(r){var s=this._first;for(this._lock=0;s;)s.invalidate(r),s=s._next;return i.prototype.invalidate.call(this,r)},t.clear=function(r){r===void 0&&(r=!0);for(var s=this._first,o;s;)o=s._next,this.remove(s),s=o;return this._dp&&(this._time=this._tTime=this._pTime=0),r&&(this.labels={}),Pr(this)},t.totalDuration=function(r){var s=0,o=this,a=o._last,l=Zn,c,u,h;if(arguments.length)return o.timeScale((o._repeat<0?o.duration():o.totalDuration())/(o.reversed()?-r:r));if(o._dirty){for(h=o.parent;a;)c=a._prev,a._dirty&&a.totalDuration(),u=a._start,u>l&&o._sort&&a._ts&&!o._lock?(o._lock=1,Yn(o,a,u-a._delay,1)._lock=0):l=u,u<0&&a._ts&&(s-=u,(!h&&!o._dp||h&&h.smoothChildTiming)&&(o._start+=u/o._ts,o._time-=u,o._tTime-=u),o.shiftChildren(-u,!1,-1/0),l=0),a._end>s&&a._ts&&(s=a._end),a=c;Os(o,o===gt&&o._time>s?o._time:s,1,1),o._dirty=0}return o._tDur},e.updateRoot=function(r){if(gt._ts&&(C_(gt,il(r,gt)),b_=gn.frame),gn.frame>=op){op+=xn.autoSleep||120;var s=gt._first;if((!s||!s._ts)&&xn.autoSleep&&gn._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||gn.sleep()}}},e}(Do);En(Zt.prototype,{_lock:0,_hasPause:0,_forcing:0});var Qb=function(e,t,n,r,s,o,a){var l=new an(this._pt,e,t,0,1,tg,null,s),c=0,u=0,h,d,f,_,g,m,p,T;for(l.b=n,l.e=r,n+="",r+="",(p=~r.indexOf("random("))&&(r=Io(r)),o&&(T=[n,r],o(T,e,t),n=T[0],r=T[1]),d=n.match(Dc)||[];h=Dc.exec(r);)_=h[0],g=r.substring(c,h.index),f?f=(f+1)%5:g.substr(-5)==="rgba("&&(f=1),_!==d[u++]&&(m=parseFloat(d[u-1])||0,l._pt={_next:l._pt,p:g||u===1?g:",",s:m,c:_.charAt(1)==="="?ys(m,_)-m:parseFloat(_)-m,m:f&&f<4?Math.round:0},c=Dc.lastIndex);return l.c=c<r.length?r.substring(c,r.length):"",l.fp=a,(y_.test(r)||p)&&(l.e=0),this._pt=l,l},Jh=function(e,t,n,r,s,o,a,l,c,u){Mt(r)&&(r=r(s||0,e,o));var h=e[t],d=n!=="get"?n:Mt(h)?c?e[t.indexOf("set")||!Mt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():h,f=Mt(h)?c?rw:Q_:ed,_;if(kt(r)&&(~r.indexOf("random(")&&(r=Io(r)),r.charAt(1)==="="&&(_=ys(d,r)+(Xt(d)||0),(_||_===0)&&(r=_))),!u||d!==r||ih)return!isNaN(d*r)&&r!==""?(_=new an(this._pt,e,t,+d||0,r-(d||0),typeof h=="boolean"?ow:eg,0,f),c&&(_.fp=c),a&&_.modifier(a,this,e),this._pt=_):(!h&&!(t in e)&&$h(t,r),Qb.call(this,e,t,d,r,f,l||xn.stringFilter,c))},ew=function(e,t,n,r,s){if(Mt(e)&&(e=go(e,s,t,n,r)),!ti(e)||e.style&&e.nodeType||$t(e)||v_(e))return kt(e)?go(e,s,t,n,r):e;var o={},a;for(a in e)o[a]=go(e[a],s,t,n,r);return o},j_=function(e,t,n,r,s,o){var a,l,c,u;if(_n[e]&&(a=new _n[e]).init(s,a.rawVars?t[e]:ew(t[e],r,s,o,n),n,r,o)!==!1&&(n._pt=l=new an(n._pt,s,e,0,1,a.render,a,0,a.priority),n!==fs))for(c=n._ptLookup[n._targets.indexOf(s)],u=a._props.length;u--;)c[a._props[u]]=l;return a},ki,ih,Qh=function i(e,t,n){var r=e.vars,s=r.ease,o=r.startAt,a=r.immediateRender,l=r.lazy,c=r.onUpdate,u=r.runBackwards,h=r.yoyoEase,d=r.keyframes,f=r.autoRevert,_=e._dur,g=e._startAt,m=e._targets,p=e.parent,T=p&&p.data==="nested"?p.vars.targets:m,x=e._overwrite==="auto"&&!Wh,v=e.timeline,C,A,b,I,y,E,P,z,U,G,X,V,Y;if(v&&(!d||!s)&&(s="none"),e._ease=Dr(s,Ds.ease),e._yEase=h?q_(Dr(h===!0?s:h,Ds.ease)):0,h&&e._yoyo&&!e._repeat&&(h=e._yEase,e._yEase=e._ease,e._ease=h),e._from=!v&&!!r.runBackwards,!v||d&&!r.stagger){if(z=m[0]?Ir(m[0]).harness:0,V=z&&r[z.prop],C=nl(r,Kh),g&&(g._zTime<0&&g.progress(1),t<0&&u&&a&&!f?g.render(-1,!0):g.revert(u&&_?Xa:Ab),g._lazy=0),o){if(Zi(e._startAt=At.set(m,En({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!g&&sn(l),startAt:null,delay:0,onUpdate:c&&function(){return vn(e,"onUpdate")},stagger:0},o))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(zt||!a&&!f)&&e._startAt.revert(Xa),a&&_&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(u&&_&&!g){if(t&&(a=!1),b=En({overwrite:!1,data:"isFromStart",lazy:a&&!g&&sn(l),immediateRender:a,stagger:0,parent:p},C),V&&(b[z.prop]=V),Zi(e._startAt=At.set(m,b)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(zt?e._startAt.revert(Xa):e._startAt.render(-1,!0)),e._zTime=t,!a)i(e._startAt,qt,qt);else if(!t)return}for(e._pt=e._ptCache=0,l=_&&sn(l)||l&&!_,A=0;A<m.length;A++){if(y=m[A],P=y._gsap||Zh(m)[A]._gsap,e._ptLookup[A]=G={},Zu[P.id]&&Gi.length&&tl(),X=T===m?A:T.indexOf(y),z&&(U=new z).init(y,V||C,e,X,T)!==!1&&(e._pt=I=new an(e._pt,y,U.name,0,1,U.render,U,0,U.priority),U._props.forEach(function(H){G[H]=I}),U.priority&&(E=1)),!z||V)for(b in C)_n[b]&&(U=j_(b,C,e,X,y,T))?U.priority&&(E=1):G[b]=I=Jh.call(e,y,b,"get",C[b],X,T,0,r.stringFilter);e._op&&e._op[A]&&e.kill(y,e._op[A]),x&&e._pt&&(ki=e,gt.killTweensOf(y,G,e.globalTime(t)),Y=!e.parent,ki=0),e._pt&&l&&(Zu[P.id]=1)}E&&ng(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!Y,d&&t<=0&&v.render(Zn,!0,!0)},tw=function(e,t,n,r,s,o,a,l){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],u,h,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(u=d[f][t],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==t&&u.fp!==t;)u=u._next;if(!u)return ih=1,e.vars[t]="+=0",Qh(e,a),ih=0,l?Ao(t+" not eligible for reset"):1;c.push(u)}for(f=c.length;f--;)h=c[f],u=h._pt||h,u.s=(r||r===0)&&!s?r:u.s+(r||0)+o*u.c,u.c=n-u.s,h.e&&(h.e=bt(n)+Xt(h.e)),h.b&&(h.b=u.s+Xt(h.b))},nw=function(e,t){var n=e[0]?Ir(e[0]).harness:0,r=n&&n.aliases,s,o,a,l;if(!r)return t;s=Ls({},t);for(o in r)if(o in s)for(l=r[o].split(","),a=l.length;a--;)s[l[a]]=s[o];return s},iw=function(e,t,n,r){var s=t.ease||r||"power1.inOut",o,a;if($t(t))a=n[e]||(n[e]=[]),t.forEach(function(l,c){return a.push({t:c/(t.length-1)*100,v:l,e:s})});else for(o in t)a=n[o]||(n[o]=[]),o==="ease"||a.push({t:parseFloat(e),v:t[o],e:s})},go=function(e,t,n,r,s){return Mt(e)?e.call(t,n,r,s):kt(e)&&~e.indexOf("random(")?Io(e):e},Z_=jh+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",J_={};on(Z_+",id,stagger,delay,duration,paused,scrollTrigger",function(i){return J_[i]=1});var At=function(i){__(e,i);function e(n,r,s,o){var a;typeof r=="number"&&(s.duration=r,r=s,s=null),a=i.call(this,o?r:mo(r))||this;var l=a.vars,c=l.duration,u=l.delay,h=l.immediateRender,d=l.stagger,f=l.overwrite,_=l.keyframes,g=l.defaults,m=l.scrollTrigger,p=l.yoyoEase,T=r.parent||gt,x=($t(n)||v_(n)?Mi(n[0]):"length"in r)?[n]:In(n),v,C,A,b,I,y,E,P;if(a._targets=x.length?Zh(x):Ao("GSAP target "+n+" not found. https://gsap.com",!xn.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=f,_||d||Oa(c)||Oa(u)){if(r=a.vars,v=a.timeline=new Zt({data:"nested",defaults:g||{},targets:T&&T.data==="nested"?T.vars.targets:x}),v.kill(),v.parent=v._dp=fi(a),v._start=0,d||Oa(c)||Oa(u)){if(b=x.length,E=d&&U_(d),ti(d))for(I in d)~Z_.indexOf(I)&&(P||(P={}),P[I]=d[I]);for(C=0;C<b;C++)A=nl(r,J_),A.stagger=0,p&&(A.yoyoEase=p),P&&Ls(A,P),y=x[C],A.duration=+go(c,fi(a),C,y,x),A.delay=(+go(u,fi(a),C,y,x)||0)-a._delay,!d&&b===1&&A.delay&&(a._delay=u=A.delay,a._start+=u,A.delay=0),v.to(y,A,E?E(C,y,x):0),v._ease=$e.none;v.duration()?c=u=0:a.timeline=0}else if(_){mo(En(v.vars.defaults,{ease:"none"})),v._ease=Dr(_.ease||r.ease||"none");var z=0,U,G,X;if($t(_))_.forEach(function(V){return v.to(x,V,">")}),v.duration();else{A={};for(I in _)I==="ease"||I==="easeEach"||iw(I,_[I],A,_.easeEach);for(I in A)for(U=A[I].sort(function(V,Y){return V.t-Y.t}),z=0,C=0;C<U.length;C++)G=U[C],X={ease:G.e,duration:(G.t-(C?U[C-1].t:0))/100*c},X[I]=G.v,v.to(x,X,z),z+=X.duration;v.duration()<c&&v.to({},{duration:c-v.duration()})}}c||a.duration(c=v.duration())}else a.timeline=0;return f===!0&&!Wh&&(ki=fi(a),gt.killTweensOf(x),ki=0),Yn(T,fi(a),s),r.reversed&&a.reverse(),r.paused&&a.paused(!0),(h||!c&&!_&&a._start===Rt(T._time)&&sn(h)&&Nb(fi(a))&&T.data!=="nested")&&(a._tTime=-1e-8,a.render(Math.max(0,-u)||0)),m&&D_(fi(a),m),a}var t=e.prototype;return t.render=function(r,s,o){var a=this._time,l=this._tDur,c=this._dur,u=r<0,h=r>l-qt&&!u?l:r<qt?0:r,d,f,_,g,m,p,T,x,v;if(!c)Ub(this,r,s,o);else if(h!==this._tTime||!r||o||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(d=h,x=this.timeline,this._repeat){if(g=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(g*100+r,s,o);if(d=Rt(h%g),h===l?(_=this._repeat,d=c):(m=Rt(h/g),_=~~m,_&&_===m?(d=c,_--):d>c&&(d=c)),p=this._yoyo&&_&1,p&&(v=this._yEase,d=c-d),m=Ns(this._tTime,g),d===a&&!o&&this._initted&&_===m)return this._tTime=h,this;_!==m&&(x&&this._yEase&&Y_(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&d!==g&&this._initted&&(this._lock=o=1,this.render(Rt(g*_),!0).invalidate()._lock=0))}if(!this._initted){if(L_(this,u?r:d,o,s,h))return this._tTime=0,this;if(a!==this._time&&!(o&&this.vars.repeatRefresh&&_!==m))return this;if(c!==this._dur)return this.render(r,s,o)}if(this._tTime=h,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=T=(v||this._ease)(d/c),this._from&&(this.ratio=T=1-T),d&&!a&&!s&&!_&&(vn(this,"onStart"),this._tTime!==h))return this;for(f=this._pt;f;)f.r(T,f.d),f=f._next;x&&x.render(r<0?r:x._dur*x._ease(d/this._dur),s,o)||this._startAt&&(this._zTime=r),this._onUpdate&&!s&&(u&&Ju(this,r,s,o),vn(this,"onUpdate")),this._repeat&&_!==m&&this.vars.onRepeat&&!s&&this.parent&&vn(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Ju(this,r,!0,!0),(r||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&Zi(this,1),!s&&!(u&&!a)&&(h||a||p)&&(vn(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(r){return(!r||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(r),i.prototype.invalidate.call(this,r)},t.resetTo=function(r,s,o,a,l){Po||gn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||Qh(this,c),u=this._ease(c/this._dur),tw(this,r,s,o,a,u,c,l)?this.resetTo(r,s,o,a,1):(Ll(this,0),this.parent||I_(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(r,s){if(s===void 0&&(s="all"),!r&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?lo(this):this.scrollTrigger&&this.scrollTrigger.kill(!!zt),this;if(this.timeline){var o=this.timeline.totalDuration();return this.timeline.killTweensOf(r,s,ki&&ki.vars.overwrite!==!0)._first||lo(this),this.parent&&o!==this.timeline.totalDuration()&&Os(this,this._dur*this.timeline._tDur/o,0,1),this}var a=this._targets,l=r?In(r):a,c=this._ptLookup,u=this._pt,h,d,f,_,g,m,p;if((!s||s==="all")&&Db(a,l))return s==="all"&&(this._pt=0),lo(this);for(h=this._op=this._op||[],s!=="all"&&(kt(s)&&(g={},on(s,function(T){return g[T]=1}),s=g),s=nw(a,s)),p=a.length;p--;)if(~l.indexOf(a[p])){d=c[p],s==="all"?(h[p]=s,_=d,f={}):(f=h[p]=h[p]||{},_=s);for(g in _)m=d&&d[g],m&&((!("kill"in m.d)||m.d.kill(g)===!0)&&Pl(this,m,"_pt"),delete d[g]),f!=="all"&&(f[g]=1)}return this._initted&&!this._pt&&u&&lo(this),this},e.to=function(r,s){return new e(r,s,arguments[2])},e.from=function(r,s){return _o(1,arguments)},e.delayedCall=function(r,s,o,a){return new e(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:r,onComplete:s,onReverseComplete:s,onCompleteParams:o,onReverseCompleteParams:o,callbackScope:a})},e.fromTo=function(r,s,o){return _o(2,arguments)},e.set=function(r,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new e(r,s)},e.killTweensOf=function(r,s,o){return gt.killTweensOf(r,s,o)},e}(Do);En(At.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});on("staggerTo,staggerFrom,staggerFromTo",function(i){At[i]=function(){var e=new Zt,t=eh.call(arguments,0);return t.splice(i==="staggerFromTo"?5:4,0,0),e[i].apply(e,t)}});var ed=function(e,t,n){return e[t]=n},Q_=function(e,t,n){return e[t](n)},rw=function(e,t,n,r){return e[t](r.fp,n)},sw=function(e,t,n){return e.setAttribute(t,n)},td=function(e,t){return Mt(e[t])?Q_:Xh(e[t])&&e.setAttribute?sw:ed},eg=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},ow=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},tg=function(e,t){var n=t._pt,r="";if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},nd=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},aw=function(e,t,n,r){for(var s=this._pt,o;s;)o=s._next,s.p===r&&s.modifier(e,t,n),s=o},lw=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?Pl(this,t,"_pt"):t.dep||(n=1),t=r;return!n},cw=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},ng=function(e){for(var t=e._pt,n,r,s,o;t;){for(n=t._next,r=s;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:o)?t._prev._next=t:s=t,(t._next=r)?r._prev=t:o=t,t=n}e._pt=s},an=function(){function i(t,n,r,s,o,a,l,c,u){this.t=n,this.s=s,this.c=o,this.p=r,this.r=a||eg,this.d=l||this,this.set=c||ed,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=i.prototype;return e.modifier=function(n,r,s){this.mSet=this.mSet||this.set,this.set=cw,this.m=n,this.mt=s,this.tween=r},i}();on(jh+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(i){return Kh[i]=1});Sn.TweenMax=Sn.TweenLite=At;Sn.TimelineLite=Sn.TimelineMax=Zt;gt=new Zt({sortChildren:!1,defaults:Ds,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});xn.stringFilter=X_;var Lr=[],Ya={},uw=[],dp=0,hw=0,Fc=function(e){return(Ya[e]||uw).map(function(t){return t()})},rh=function(){var e=Date.now(),t=[];e-dp>2&&(Fc("matchMediaInit"),Lr.forEach(function(n){var r=n.queries,s=n.conditions,o,a,l,c;for(a in r)o=Xn.matchMedia(r[a]).matches,o&&(l=1),o!==s[a]&&(s[a]=o,c=1);c&&(n.revert(),l&&t.push(n))}),Fc("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(r){return n.add(null,r)})}),dp=e,Fc("matchMedia"))},ig=function(){function i(t,n){this.selector=n&&th(n),this.data=[],this._r=[],this.isReverted=!1,this.id=hw++,t&&this.add(t)}var e=i.prototype;return e.add=function(n,r,s){Mt(n)&&(s=r,r=n,n=Mt);var o=this,a=function(){var c=mt,u=o.selector,h;return c&&c!==o&&c.data.push(o),s&&(o.selector=th(s)),mt=o,h=r.apply(o,arguments),Mt(h)&&o._r.push(h),mt=c,o.selector=u,o.isReverted=!1,h};return o.last=a,n===Mt?a(o,function(l){return o.add(null,l)}):n?o[n]=a:a},e.ignore=function(n){var r=mt;mt=null,n(this),mt=r},e.getTweens=function(){var n=[];return this.data.forEach(function(r){return r instanceof i?n.push.apply(n,r.getTweens()):r instanceof At&&!(r.parent&&r.parent.data==="nested")&&n.push(r)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,r){var s=this;if(n?function(){for(var a=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return a.splice(a.indexOf(u),1)}));for(a.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Zt?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof At)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(a){return a.kill&&a.kill()}),this.clear(),r)for(var o=Lr.length;o--;)Lr[o].id===this.id&&Lr.splice(o,1)},e.revert=function(n){this.kill(n||{})},i}(),dw=function(){function i(t){this.contexts=[],this.scope=t,mt&&mt.data.push(this)}var e=i.prototype;return e.add=function(n,r,s){ti(n)||(n={matches:n});var o=new ig(0,s||this.scope),a=o.conditions={},l,c,u;mt&&!o.selector&&(o.selector=mt.selector),this.contexts.push(o),r=o.add("onMatch",r),o.queries=n;for(c in n)c==="all"?u=1:(l=Xn.matchMedia(n[c]),l&&(Lr.indexOf(o)<0&&Lr.push(o),(a[c]=l.matches)&&(u=1),l.addListener?l.addListener(rh):l.addEventListener("change",rh)));return u&&r(o,function(h){return o.add(null,h)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(r){return r.kill(n,!0)})},i}(),rl={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(r){return H_(r)})},timeline:function(e){return new Zt(e)},getTweensOf:function(e,t){return gt.getTweensOf(e,t)},getProperty:function(e,t,n,r){kt(e)&&(e=In(e)[0]);var s=Ir(e||{}).get,o=n?R_:A_;return n==="native"&&(n=""),e&&(t?o((_n[t]&&_n[t].get||s)(e,t,n,r)):function(a,l,c){return o((_n[a]&&_n[a].get||s)(e,a,l,c))})},quickSetter:function(e,t,n){if(e=In(e),e.length>1){var r=e.map(function(u){return hn.quickSetter(u,t,n)}),s=r.length;return function(u){for(var h=s;h--;)r[h](u)}}e=e[0]||{};var o=_n[t],a=Ir(e),l=a.harness&&(a.harness.aliases||{})[t]||t,c=o?function(u){var h=new o;fs._pt=0,h.init(e,n?u+n:u,fs,0,[e]),h.render(1,h),fs._pt&&nd(1,fs)}:a.set(e,l);return o?c:function(u){return c(e,l,n?u+n:u,a,1)}},quickTo:function(e,t,n){var r,s=hn.to(e,En((r={},r[t]="+=0.1",r.paused=!0,r.stagger=0,r),n||{})),o=function(l,c,u){return s.resetTo(t,l,c,u)};return o.tween=s,o},isTweening:function(e){return gt.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Dr(e.ease,Ds.ease)),ap(Ds,e||{})},config:function(e){return ap(xn,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,s=e.defaults,o=e.extendTimeline;(r||"").split(",").forEach(function(a){return a&&!_n[a]&&!Sn[a]&&Ao(t+" effect requires "+a+" plugin.")}),Lc[t]=function(a,l,c){return n(In(a),En(l||{},s),c)},o&&(Zt.prototype[t]=function(a,l,c){return this.add(Lc[t](a,ti(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){$e[e]=Dr(t)},parseEase:function(e,t){return arguments.length?Dr(e,t):$e},getById:function(e){return gt.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Zt(e),r,s;for(n.smoothChildTiming=sn(e.smoothChildTiming),gt.remove(n),n._dp=0,n._time=n._tTime=gt._time,r=gt._first;r;)s=r._next,(t||!(!r._dur&&r instanceof At&&r.vars.onComplete===r._targets[0]))&&Yn(n,r,r._start-r._delay),r=s;return Yn(gt,n,0),n},context:function(e,t){return e?new ig(e,t):mt},matchMedia:function(e){return new dw(e)},matchMediaRefresh:function(){return Lr.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||rh()},addEventListener:function(e,t){var n=Ya[e]||(Ya[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Ya[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:Wb,wrapYoyo:Xb,distribute:U_,random:k_,snap:F_,normalize:Gb,getUnit:Xt,clamp:Bb,splitColor:G_,toArray:In,selector:th,mapRange:z_,pipe:Vb,unitize:Hb,interpolate:qb,shuffle:O_},install:M_,effects:Lc,ticker:gn,updateRoot:Zt.updateRoot,plugins:_n,globalTimeline:gt,core:{PropTween:an,globals:T_,Tween:At,Timeline:Zt,Animation:Do,getCache:Ir,_removeLinkedListItem:Pl,reverting:function(){return zt},context:function(e){return e&&mt&&(mt.data.push(e),e._ctx=mt),mt},suppressOverwrites:function(e){return Wh=e}}};on("to,from,fromTo,delayedCall,set,killTweensOf",function(i){return rl[i]=At[i]});gn.add(Zt.updateRoot);fs=rl.to({},{duration:0});var fw=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},pw=function(e,t){var n=e._targets,r,s,o;for(r in t)for(s=n.length;s--;)o=e._ptLookup[s][r],o&&(o=o.d)&&(o._pt&&(o=fw(o,r)),o&&o.modifier&&o.modifier(t[r],e,n[s],r))},kc=function(e,t){return{name:e,rawVars:1,init:function(r,s,o){o._onInit=function(a){var l,c;if(kt(s)&&(l={},on(s,function(u){return l[u]=1}),s=l),t){l={};for(c in s)l[c]=t(s[c]);s=l}pw(a,s)}}}},hn=rl.registerPlugin({name:"attr",init:function(e,t,n,r,s){var o,a,l;this.tween=n;for(o in t)l=e.getAttribute(o)||"",a=this.add(e,"setAttribute",(l||0)+"",t[o],r,s,0,0,o),a.op=o,a.b=l,this._props.push(o)},render:function(e,t){for(var n=t._pt;n;)zt?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},kc("roundProps",nh),kc("modifiers"),kc("snap",F_))||rl;At.version=Zt.version=hn.version="3.12.7";E_=1;qh()&&Us();$e.Power0;$e.Power1;$e.Power2;$e.Power3;$e.Power4;$e.Linear;$e.Quad;$e.Cubic;$e.Quart;$e.Quint;$e.Strong;$e.Elastic;$e.Back;$e.SteppedEase;$e.Bounce;$e.Sine;$e.Expo;$e.Circ;/*!
 * CSSPlugin 3.12.7
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var fp,Bi,Ss,id,wr,pp,rd,mw=function(){return typeof window<"u"},Ti={},xr=180/Math.PI,Es=Math.PI/180,ls=Math.atan2,mp=1e8,sd=/([A-Z])/g,_w=/(left|right|width|margin|padding|x)/i,gw=/[\s,\(]\S/,Kn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},sh=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},vw=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},xw=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},yw=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},rg=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},sg=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Sw=function(e,t,n){return e.style[t]=n},Ew=function(e,t,n){return e.style.setProperty(t,n)},Mw=function(e,t,n){return e._gsap[t]=n},Tw=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},bw=function(e,t,n,r,s){var o=e._gsap;o.scaleX=o.scaleY=n,o.renderTransform(s,o)},ww=function(e,t,n,r,s){var o=e._gsap;o[t]=n,o.renderTransform(s,o)},xt="transform",ln=xt+"Origin",Cw=function i(e,t){var n=this,r=this.target,s=r.style,o=r._gsap;if(e in Ti&&s){if(this.tfm=this.tfm||{},e!=="transform")e=Kn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=pi(r,a)}):this.tfm[e]=o.x?o[e]:pi(r,e),e===ln&&(this.tfm.zOrigin=o.zOrigin);else return Kn.transform.split(",").forEach(function(a){return i.call(n,a,t)});if(this.props.indexOf(xt)>=0)return;o.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(ln,t,"")),e=xt}(s||t)&&this.props.push(e,t,s[e])},og=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Aw=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,s,o;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(sd,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)r[o]=this.tfm[o];r.svg&&(r.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=rd(),(!s||!s.isStart)&&!n[xt]&&(og(n),r.zOrigin&&n[ln]&&(n[ln]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},ag=function(e,t){var n={target:e,props:[],revert:Aw,save:Cw};return e._gsap||hn.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(r){return n.save(r)}),n},lg,oh=function(e,t){var n=Bi.createElementNS?Bi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Bi.createElement(e);return n&&n.style?n:Bi.createElement(e)},Jn=function i(e,t,n){var r=getComputedStyle(e);return r[t]||r.getPropertyValue(t.replace(sd,"-$1").toLowerCase())||r.getPropertyValue(t)||!n&&i(e,Fs(t)||t,1)||""},_p="O,Moz,ms,Ms,Webkit".split(","),Fs=function(e,t,n){var r=t||wr,s=r.style,o=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(_p[o]+e in s););return o<0?null:(o===3?"ms":o>=0?_p[o]:"")+e},ah=function(){mw()&&window.document&&(fp=window,Bi=fp.document,Ss=Bi.documentElement,wr=oh("div")||{style:{}},oh("div"),xt=Fs(xt),ln=xt+"Origin",wr.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",lg=!!Fs("perspective"),rd=hn.core.reverting,id=1)},gp=function(e){var t=e.ownerSVGElement,n=oh("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),r=e.cloneNode(!0),s;r.style.display="block",n.appendChild(r),Ss.appendChild(n);try{s=r.getBBox()}catch{}return n.removeChild(r),Ss.removeChild(n),s},vp=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},cg=function(e){var t,n;try{t=e.getBBox()}catch{t=gp(e),n=1}return t&&(t.width||t.height)||n||(t=gp(e)),t&&!t.width&&!t.x&&!t.y?{x:+vp(e,["x","cx","x1"])||0,y:+vp(e,["y","cy","y1"])||0,width:0,height:0}:t},ug=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&cg(e))},Fr=function(e,t){if(t){var n=e.style,r;t in Ti&&t!==ln&&(t=xt),n.removeProperty?(r=t.substr(0,2),(r==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(r==="--"?t:t.replace(sd,"-$1").toLowerCase())):n.removeAttribute(t)}},zi=function(e,t,n,r,s,o){var a=new an(e._pt,t,n,0,1,o?sg:rg);return e._pt=a,a.b=r,a.e=s,e._props.push(n),a},xp={deg:1,rad:1,turn:1},Rw={grid:1,flex:1},Ji=function i(e,t,n,r){var s=parseFloat(n)||0,o=(n+"").trim().substr((s+"").length)||"px",a=wr.style,l=_w.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,d=r==="px",f=r==="%",_,g,m,p;if(r===o||!s||xp[r]||xp[o])return s;if(o!=="px"&&!d&&(s=i(e,t,n,"px")),p=e.getCTM&&ug(e),(f||o==="%")&&(Ti[t]||~t.indexOf("adius")))return _=p?e.getBBox()[l?"width":"height"]:e[u],bt(f?s/_*h:s/100*_);if(a[l?"width":"height"]=h+(d?o:r),g=r!=="rem"&&~t.indexOf("adius")||r==="em"&&e.appendChild&&!c?e:e.parentNode,p&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===Bi||!g.appendChild)&&(g=Bi.body),m=g._gsap,m&&f&&m.width&&l&&m.time===gn.time&&!m.uncache)return bt(s/m.width*h);if(f&&(t==="height"||t==="width")){var T=e.style[t];e.style[t]=h+r,_=e[u],T?e.style[t]=T:Fr(e,t)}else(f||o==="%")&&!Rw[Jn(g,"display")]&&(a.position=Jn(e,"position")),g===e&&(a.position="static"),g.appendChild(wr),_=wr[u],g.removeChild(wr),a.position="absolute";return l&&f&&(m=Ir(g),m.time=gn.time,m.width=g[u]),bt(d?_*s/h:_&&s?h/_*s:0)},pi=function(e,t,n,r){var s;return id||ah(),t in Kn&&t!=="transform"&&(t=Kn[t],~t.indexOf(",")&&(t=t.split(",")[0])),Ti[t]&&t!=="transform"?(s=No(e,r),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:ol(Jn(e,ln))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||r||~(s+"").indexOf("calc("))&&(s=sl[t]&&sl[t](e,t,n)||Jn(e,t)||w_(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Ji(e,t,s,n)+n:s},Iw=function(e,t,n,r){if(!n||n==="none"){var s=Fs(t,e,1),o=s&&Jn(e,s,1);o&&o!==n?(t=s,n=o):t==="borderColor"&&(n=Jn(e,"borderTopColor"))}var a=new an(this._pt,e.style,t,0,1,tg),l=0,c=0,u,h,d,f,_,g,m,p,T,x,v,C;if(a.b=n,a.e=r,n+="",r+="",r==="auto"&&(g=e.style[t],e.style[t]=r,r=Jn(e,t)||r,g?e.style[t]=g:Fr(e,t)),u=[n,r],X_(u),n=u[0],r=u[1],d=n.match(ds)||[],C=r.match(ds)||[],C.length){for(;h=ds.exec(r);)m=h[0],T=r.substring(l,h.index),_?_=(_+1)%5:(T.substr(-5)==="rgba("||T.substr(-5)==="hsla(")&&(_=1),m!==(g=d[c++]||"")&&(f=parseFloat(g)||0,v=g.substr((f+"").length),m.charAt(1)==="="&&(m=ys(f,m)+v),p=parseFloat(m),x=m.substr((p+"").length),l=ds.lastIndex-x.length,x||(x=x||xn.units[t]||v,l===r.length&&(r+=x,a.e+=x)),v!==x&&(f=Ji(e,t,g,x)||0),a._pt={_next:a._pt,p:T||c===1?T:",",s:f,c:p-f,m:_&&_<4||t==="zIndex"?Math.round:0});a.c=l<r.length?r.substring(l,r.length):""}else a.r=t==="display"&&r==="none"?sg:rg;return y_.test(r)&&(a.e=0),this._pt=a,a},yp={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Pw=function(e){var t=e.split(" "),n=t[0],r=t[1]||"50%";return(n==="top"||n==="bottom"||r==="left"||r==="right")&&(e=n,n=r,r=e),t[0]=yp[n]||n,t[1]=yp[r]||r,t.join(" ")},Dw=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,s=t.u,o=n._gsap,a,l,c;if(s==="all"||s===!0)r.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)a=s[c],Ti[a]&&(l=1,a=a==="transformOrigin"?ln:xt),Fr(n,a);l&&(Fr(n,xt),o&&(o.svg&&n.removeAttribute("transform"),r.scale=r.rotate=r.translate="none",No(n,1),o.uncache=1,og(r)))}},sl={clearProps:function(e,t,n,r,s){if(s.data!=="isFromStart"){var o=e._pt=new an(e._pt,t,n,0,0,Dw);return o.u=r,o.pr=-10,o.tween=s,e._props.push(n),1}}},Lo=[1,0,0,1,0,0],hg={},dg=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Sp=function(e){var t=Jn(e,xt);return dg(t)?Lo:t.substr(7).match(x_).map(bt)},od=function(e,t){var n=e._gsap||Ir(e),r=e.style,s=Sp(e),o,a,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Lo:s):(s===Lo&&!e.offsetParent&&e!==Ss&&!n.svg&&(l=r.display,r.display="block",o=e.parentNode,(!o||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,a=e.nextElementSibling,Ss.appendChild(e)),s=Sp(e),l?r.display=l:Fr(e,"display"),c&&(a?o.insertBefore(e,a):o?o.appendChild(e):Ss.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},lh=function(e,t,n,r,s,o){var a=e._gsap,l=s||od(e,!0),c=a.xOrigin||0,u=a.yOrigin||0,h=a.xOffset||0,d=a.yOffset||0,f=l[0],_=l[1],g=l[2],m=l[3],p=l[4],T=l[5],x=t.split(" "),v=parseFloat(x[0])||0,C=parseFloat(x[1])||0,A,b,I,y;n?l!==Lo&&(b=f*m-_*g)&&(I=v*(m/b)+C*(-g/b)+(g*T-m*p)/b,y=v*(-_/b)+C*(f/b)-(f*T-_*p)/b,v=I,C=y):(A=cg(e),v=A.x+(~x[0].indexOf("%")?v/100*A.width:v),C=A.y+(~(x[1]||x[0]).indexOf("%")?C/100*A.height:C)),r||r!==!1&&a.smooth?(p=v-c,T=C-u,a.xOffset=h+(p*f+T*g)-p,a.yOffset=d+(p*_+T*m)-T):a.xOffset=a.yOffset=0,a.xOrigin=v,a.yOrigin=C,a.smooth=!!r,a.origin=t,a.originIsAbsolute=!!n,e.style[ln]="0px 0px",o&&(zi(o,a,"xOrigin",c,v),zi(o,a,"yOrigin",u,C),zi(o,a,"xOffset",h,a.xOffset),zi(o,a,"yOffset",d,a.yOffset)),e.setAttribute("data-svg-origin",v+" "+C)},No=function(e,t){var n=e._gsap||new K_(e);if("x"in n&&!t&&!n.uncache)return n;var r=e.style,s=n.scaleX<0,o="px",a="deg",l=getComputedStyle(e),c=Jn(e,ln)||"0",u,h,d,f,_,g,m,p,T,x,v,C,A,b,I,y,E,P,z,U,G,X,V,Y,H,oe,ce,ge,Pe,je,q,ne;return u=h=d=g=m=p=T=x=v=0,f=_=1,n.svg=!!(e.getCTM&&ug(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(r[xt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[xt]!=="none"?l[xt]:"")),r.scale=r.rotate=r.translate="none"),b=od(e,n.svg),n.svg&&(n.uncache?(H=e.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",Y=""):Y=!t&&e.getAttribute("data-svg-origin"),lh(e,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,b)),C=n.xOrigin||0,A=n.yOrigin||0,b!==Lo&&(P=b[0],z=b[1],U=b[2],G=b[3],u=X=b[4],h=V=b[5],b.length===6?(f=Math.sqrt(P*P+z*z),_=Math.sqrt(G*G+U*U),g=P||z?ls(z,P)*xr:0,T=U||G?ls(U,G)*xr+g:0,T&&(_*=Math.abs(Math.cos(T*Es))),n.svg&&(u-=C-(C*P+A*U),h-=A-(C*z+A*G))):(ne=b[6],je=b[7],ce=b[8],ge=b[9],Pe=b[10],q=b[11],u=b[12],h=b[13],d=b[14],I=ls(ne,Pe),m=I*xr,I&&(y=Math.cos(-I),E=Math.sin(-I),Y=X*y+ce*E,H=V*y+ge*E,oe=ne*y+Pe*E,ce=X*-E+ce*y,ge=V*-E+ge*y,Pe=ne*-E+Pe*y,q=je*-E+q*y,X=Y,V=H,ne=oe),I=ls(-U,Pe),p=I*xr,I&&(y=Math.cos(-I),E=Math.sin(-I),Y=P*y-ce*E,H=z*y-ge*E,oe=U*y-Pe*E,q=G*E+q*y,P=Y,z=H,U=oe),I=ls(z,P),g=I*xr,I&&(y=Math.cos(I),E=Math.sin(I),Y=P*y+z*E,H=X*y+V*E,z=z*y-P*E,V=V*y-X*E,P=Y,X=H),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,p=180-p),f=bt(Math.sqrt(P*P+z*z+U*U)),_=bt(Math.sqrt(V*V+ne*ne)),I=ls(X,V),T=Math.abs(I)>2e-4?I*xr:0,v=q?1/(q<0?-q:q):0),n.svg&&(Y=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!dg(Jn(e,xt)),Y&&e.setAttribute("transform",Y))),Math.abs(T)>90&&Math.abs(T)<270&&(s?(f*=-1,T+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,T+=T<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+o,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+o,n.z=d+o,n.scaleX=bt(f),n.scaleY=bt(_),n.rotation=bt(g)+a,n.rotationX=bt(m)+a,n.rotationY=bt(p)+a,n.skewX=T+a,n.skewY=x+a,n.transformPerspective=v+o,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(r[ln]=ol(c)),n.xOffset=n.yOffset=0,n.force3D=xn.force3D,n.renderTransform=n.svg?Nw:lg?fg:Lw,n.uncache=0,n},ol=function(e){return(e=e.split(" "))[0]+" "+e[1]},Bc=function(e,t,n){var r=Xt(t);return bt(parseFloat(t)+parseFloat(Ji(e,"x",n+"px",r)))+r},Lw=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,fg(e,t)},pr="0deg",to="0px",mr=") ",fg=function(e,t){var n=t||this,r=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,d=n.skewX,f=n.skewY,_=n.scaleX,g=n.scaleY,m=n.transformPerspective,p=n.force3D,T=n.target,x=n.zOrigin,v="",C=p==="auto"&&e&&e!==1||p===!0;if(x&&(h!==pr||u!==pr)){var A=parseFloat(u)*Es,b=Math.sin(A),I=Math.cos(A),y;A=parseFloat(h)*Es,y=Math.cos(A),o=Bc(T,o,b*y*-x),a=Bc(T,a,-Math.sin(A)*-x),l=Bc(T,l,I*y*-x+x)}m!==to&&(v+="perspective("+m+mr),(r||s)&&(v+="translate("+r+"%, "+s+"%) "),(C||o!==to||a!==to||l!==to)&&(v+=l!==to||C?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+mr),c!==pr&&(v+="rotate("+c+mr),u!==pr&&(v+="rotateY("+u+mr),h!==pr&&(v+="rotateX("+h+mr),(d!==pr||f!==pr)&&(v+="skew("+d+", "+f+mr),(_!==1||g!==1)&&(v+="scale("+_+", "+g+mr),T.style[xt]=v||"translate(0, 0)"},Nw=function(e,t){var n=t||this,r=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,d=n.scaleY,f=n.target,_=n.xOrigin,g=n.yOrigin,m=n.xOffset,p=n.yOffset,T=n.forceCSS,x=parseFloat(o),v=parseFloat(a),C,A,b,I,y;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Es,c*=Es,C=Math.cos(l)*h,A=Math.sin(l)*h,b=Math.sin(l-c)*-d,I=Math.cos(l-c)*d,c&&(u*=Es,y=Math.tan(c-u),y=Math.sqrt(1+y*y),b*=y,I*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),C*=y,A*=y)),C=bt(C),A=bt(A),b=bt(b),I=bt(I)):(C=h,I=d,A=b=0),(x&&!~(o+"").indexOf("px")||v&&!~(a+"").indexOf("px"))&&(x=Ji(f,"x",o,"px"),v=Ji(f,"y",a,"px")),(_||g||m||p)&&(x=bt(x+_-(_*C+g*b)+m),v=bt(v+g-(_*A+g*I)+p)),(r||s)&&(y=f.getBBox(),x=bt(x+r/100*y.width),v=bt(v+s/100*y.height)),y="matrix("+C+","+A+","+b+","+I+","+x+","+v+")",f.setAttribute("transform",y),T&&(f.style[xt]=y)},Ow=function(e,t,n,r,s){var o=360,a=kt(s),l=parseFloat(s)*(a&&~s.indexOf("rad")?xr:1),c=l-r,u=r+c+"deg",h,d;return a&&(h=s.split("_")[1],h==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-360)),h==="cw"&&c<0?c=(c+o*mp)%o-~~(c/o)*o:h==="ccw"&&c>0&&(c=(c-o*mp)%o-~~(c/o)*o)),e._pt=d=new an(e._pt,t,n,r,c,vw),d.e=u,d.u="deg",e._props.push(n),d},Ep=function(e,t){for(var n in t)e[n]=t[n];return e},Uw=function(e,t,n){var r=Ep({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,l,c,u,h,d,f,_;r.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),o[xt]=t,a=No(n,1),Fr(n,xt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[xt],o[xt]=t,a=No(n,1),o[xt]=c);for(l in Ti)c=r[l],u=a[l],c!==u&&s.indexOf(l)<0&&(f=Xt(c),_=Xt(u),h=f!==_?Ji(n,l,c,_):parseFloat(c),d=parseFloat(u),e._pt=new an(e._pt,a,l,h,d-h,sh),e._pt.u=_||0,e._props.push(l));Ep(a,r)};on("padding,margin,Width,Radius",function(i,e){var t="Top",n="Right",r="Bottom",s="Left",o=(e<3?[t,n,r,s]:[t+s,t+n,r+n,r+s]).map(function(a){return e<2?i+a:"border"+a+i});sl[e>1?"border"+i:i]=function(a,l,c,u,h){var d,f;if(arguments.length<4)return d=o.map(function(_){return pi(a,_,c)}),f=d.join(" "),f.split(d[0]).length===5?d[0]:f;d=(u+"").split(" "),f={},o.forEach(function(_,g){return f[_]=d[g]=d[g]||d[(g-1)/2|0]}),a.init(l,f,h)}});var pg={name:"css",register:ah,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,s){var o=this._props,a=e.style,l=n.vars.startAt,c,u,h,d,f,_,g,m,p,T,x,v,C,A,b,I;id||ah(),this.styles=this.styles||ag(e),I=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(_n[g]&&j_(g,t,n,r,e,s)))){if(f=typeof u,_=sl[g],f==="function"&&(u=u.call(n,r,e,s),f=typeof u),f==="string"&&~u.indexOf("random(")&&(u=Io(u)),_)_(this,e,g,u,n)&&(b=1);else if(g.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",Wi.lastIndex=0,Wi.test(c)||(m=Xt(c),p=Xt(u)),p?m!==p&&(c=Ji(e,g,c,p)+p):m&&(u+=m),this.add(a,"setProperty",c,u,r,s,0,0,g),o.push(g),I.push(g,0,a[g]);else if(f!=="undefined"){if(l&&g in l?(c=typeof l[g]=="function"?l[g].call(n,r,e,s):l[g],kt(c)&&~c.indexOf("random(")&&(c=Io(c)),Xt(c+"")||c==="auto"||(c+=xn.units[g]||Xt(pi(e,g))||""),(c+"").charAt(1)==="="&&(c=pi(e,g))):c=pi(e,g),d=parseFloat(c),T=f==="string"&&u.charAt(1)==="="&&u.substr(0,2),T&&(u=u.substr(2)),h=parseFloat(u),g in Kn&&(g==="autoAlpha"&&(d===1&&pi(e,"visibility")==="hidden"&&h&&(d=0),I.push("visibility",0,a.visibility),zi(this,a,"visibility",d?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=Kn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in Ti,x){if(this.styles.save(g),v||(C=e._gsap,C.renderTransform&&!t.parseTransform||No(e,t.parseTransform),A=t.smoothOrigin!==!1&&C.smooth,v=this._pt=new an(this._pt,a,xt,0,1,C.renderTransform,C,0,-1),v.dep=1),g==="scale")this._pt=new an(this._pt,C,"scaleY",C.scaleY,(T?ys(C.scaleY,T+h):h)-C.scaleY||0,sh),this._pt.u=0,o.push("scaleY",g),g+="X";else if(g==="transformOrigin"){I.push(ln,0,a[ln]),u=Pw(u),C.svg?lh(e,u,0,A,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==C.zOrigin&&zi(this,C,"zOrigin",C.zOrigin,p),zi(this,a,g,ol(c),ol(u)));continue}else if(g==="svgOrigin"){lh(e,u,1,A,0,this);continue}else if(g in hg){Ow(this,C,g,d,T?ys(d,T+u):u);continue}else if(g==="smoothOrigin"){zi(this,C,"smooth",C.smooth,u);continue}else if(g==="force3D"){C[g]=u;continue}else if(g==="transform"){Uw(this,u,e);continue}}else g in a||(g=Fs(g)||g);if(x||(h||h===0)&&(d||d===0)&&!gw.test(u)&&g in a)m=(c+"").substr((d+"").length),h||(h=0),p=Xt(u)||(g in xn.units?xn.units[g]:m),m!==p&&(d=Ji(e,g,c,p)),this._pt=new an(this._pt,x?C:a,g,d,(T?ys(d,T+h):h)-d,!x&&(p==="px"||g==="zIndex")&&t.autoRound!==!1?yw:sh),this._pt.u=p||0,m!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=xw);else if(g in a)Iw.call(this,e,g,c,T?T+u:u);else if(g in e)this.add(e,g,c||e[g],T?T+u:u,r,s);else if(g!=="parseTransform"){$h(g,u);continue}x||(g in a?I.push(g,0,a[g]):typeof e[g]=="function"?I.push(g,2,e[g]()):I.push(g,1,c||e[g])),o.push(g)}}b&&ng(this)},render:function(e,t){if(t.tween._time||!rd())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:pi,aliases:Kn,getSetter:function(e,t,n){var r=Kn[t];return r&&r.indexOf(",")<0&&(t=r),t in Ti&&t!==ln&&(e._gsap.x||pi(e,"x"))?n&&pp===n?t==="scale"?Tw:Mw:(pp=n||{})&&(t==="scale"?bw:ww):e.style&&!Xh(e.style[t])?Sw:~t.indexOf("-")?Ew:td(e,t)},core:{_removeProperty:Fr,_getMatrix:od}};hn.utils.checkPrefix=Fs;hn.core.getStyleSaver=ag;(function(i,e,t,n){var r=on(i+","+e+","+t,function(s){Ti[s]=1});on(e,function(s){xn.units[s]="deg",hg[s]=1}),Kn[r[13]]=i+","+e,on(n,function(s){var o=s.split(":");Kn[o[1]]=r[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");on("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(i){xn.units[i]="px"});hn.registerPlugin(pg);var uo=hn.registerPlugin(pg)||hn;uo.core.Tween;const Fw=()=>{};var Mp={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const re=function(i,e){if(!i)throw Xs(e)},Xs=function(i){return new Error("Firebase Database ("+mg.SDK_VERSION+") INTERNAL ASSERT FAILED: "+i)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zw(i){return vg(void 0,i)}function vg(i,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:i===void 0&&(i={});break;case Array:i=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Vw(t)||(i[t]=vg(i[t],e[t]));return i}function Vw(i){return i!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gw=()=>Hw().__FIREBASE_DEFAULTS__,Ww=()=>{if(typeof process>"u"||typeof Mp>"u")return;const i=Mp.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},Xw=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&ch(i[1]);return e&&JSON.parse(e)},xg=()=>{try{return Fw()||Gw()||Ww()||Xw()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},qw=i=>{var e,t;return(t=(e=xg())===null||e===void 0?void 0:e.emulatorHosts)===null||t===void 0?void 0:t[i]},Yw=i=>{const e=qw(i);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},yg=()=>{var i;return(i=xg())===null||i===void 0?void 0:i.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kw(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Sg(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Kw())}function jw(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function Zw(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Jw(){return mg.NODE_ADMIN===!0}function Eg(){try{return typeof indexedDB=="object"}catch{return!1}}function Mg(){return new Promise((i,e)=>{try{let t=!0;const n="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(n);r.onsuccess=()=>{r.result.close(),t||self.indexedDB.deleteDatabase(n),i(!0)},r.onupgradeneeded=()=>{t=!1},r.onerror=()=>{var s;e(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(t){e(t)}})}function Qw(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eC="FirebaseError";class Xr extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=eC,Object.setPrototypeOf(this,Xr.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ol.prototype.create)}}class Ol{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,s=this.errors[e],o=s?tC(s,n):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Xr(r,a,n)}}function tC(i,e){return i.replace(nC,(t,n)=>{const r=e[n];return r!=null?String(r):`<${n}?>`})}const nC=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(i){return JSON.parse(i)}function It(i){return JSON.stringify(i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tg=function(i){let e={},t={},n={},r="";try{const s=i.split(".");e=Oo(ch(s[0])||""),t=Oo(ch(s[1])||""),r=s[2],n=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:n,signature:r}},iC=function(i){const e=Tg(i),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},rC=function(i){const e=Tg(i).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lC=1e3,cC=2,uC=4*60*60*1e3,hC=.5;function wp(i,e=lC,t=cC){const n=e*Math.pow(t,i),r=Math.round(hC*n*(Math.random()-.5)*2);return Math.min(uC,n+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ht;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(ht||(ht={}));const _C={debug:ht.DEBUG,verbose:ht.VERBOSE,info:ht.INFO,warn:ht.WARN,error:ht.ERROR,silent:ht.SILENT},gC=ht.INFO,vC={[ht.DEBUG]:"log",[ht.VERBOSE]:"log",[ht.INFO]:"info",[ht.WARN]:"warn",[ht.ERROR]:"error"},xC=(i,e,...t)=>{if(e<i.logLevel)return;const n=new Date().toISOString(),r=vC[e];if(r)console[r](`[${n}]  ${i.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class cd{constructor(e){this.name=e,this._logLevel=gC,this._logHandler=xC,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ht))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?_C[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ht.DEBUG,...e),this._logHandler(this,ht.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ht.VERBOSE,...e),this._logHandler(this,ht.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ht.INFO,...e),this._logHandler(this,ht.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ht.WARN,...e),this._logHandler(this,ht.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ht.ERROR,...e),this._logHandler(this,ht.ERROR,...e)}}const yC=(i,e)=>e.some(t=>i instanceof t);let Cp,Ap;function SC(){return Cp||(Cp=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function EC(){return Ap||(Ap=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const bg=new WeakMap,uh=new WeakMap,wg=new WeakMap,zc=new WeakMap,ud=new WeakMap;function MC(i){const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("success",s),i.removeEventListener("error",o)},s=()=>{t(Xi(i.result)),r()},o=()=>{n(i.error),r()};i.addEventListener("success",s),i.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&bg.set(t,i)}).catch(()=>{}),ud.set(e,i),e}function TC(i){if(uh.has(i))return;const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("complete",s),i.removeEventListener("error",o),i.removeEventListener("abort",o)},s=()=>{t(),r()},o=()=>{n(i.error||new DOMException("AbortError","AbortError")),r()};i.addEventListener("complete",s),i.addEventListener("error",o),i.addEventListener("abort",o)});uh.set(i,e)}let hh={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return uh.get(i);if(e==="objectStoreNames")return i.objectStoreNames||wg.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Xi(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function bC(i){hh=i(hh)}function wC(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=i.call(Vc(this),e,...t);return wg.set(n,e.sort?e.sort():[e]),Xi(n)}:EC().includes(i)?function(...e){return i.apply(Vc(this),e),Xi(bg.get(this))}:function(...e){return Xi(i.apply(Vc(this),e))}}function CC(i){return typeof i=="function"?wC(i):(i instanceof IDBTransaction&&TC(i),yC(i,SC())?new Proxy(i,hh):i)}function Xi(i){if(i instanceof IDBRequest)return MC(i);if(zc.has(i))return zc.get(i);const e=CC(i);return e!==i&&(zc.set(i,e),ud.set(e,i)),e}const Vc=i=>ud.get(i);function Cg(i,e,{blocked:t,upgrade:n,blocking:r,terminated:s}={}){const o=indexedDB.open(i,e),a=Xi(o);return n&&o.addEventListener("upgradeneeded",l=>{n(Xi(o.result),l.oldVersion,l.newVersion,Xi(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{s&&l.addEventListener("close",()=>s()),r&&l.addEventListener("versionchange",c=>r(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const AC=["get","getKey","getAll","getAllKeys","count"],RC=["put","add","delete","clear"],Hc=new Map;function Rp(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(Hc.get(e))return Hc.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,r=RC.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(r||AC.includes(t)))return;const s=async function(o,...a){const l=this.transaction(o,r?"readwrite":"readonly");let c=l.store;return n&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),r&&l.done]))[0]};return Hc.set(e,s),s}bC(i=>({...i,get:(e,t,n)=>Rp(e,t)||i.get(e,t,n),has:(e,t)=>!!Rp(e,t)||i.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IC{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(PC(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function PC(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const dh="@firebase/app",Ip="0.11.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uA=rA;function Ag(i,e={}){let t=i;typeof e!="object"&&(e={name:e});const n=Object.assign({name:fh,automaticDataCollectionEnabled:!1},e),r=n.name;if(typeof r!="string"||!r)throw qi.create("bad-app-name",{appName:String(r)});if(t||(t=yg()),!t)throw qi.create("no-options");const s=cl.get(r);if(s){if(Uo(t,s.options)&&Uo(n,s.config))return s;throw qi.create("duplicate-app",{appName:r})}const o=new mC(r);for(const l of ph.values())o.addComponent(l);const a=new cA(t,n,o);return cl.set(r,a),a}function hd(i=fh){const e=cl.get(i);if(!e&&i===fh&&yg())return Ag();if(!e)throw qi.create("no-app",{appName:i});return e}function Qn(i,e,t){var n;let r=(n=sA[i])!==null&&n!==void 0?n:i;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),wi.warn(a.join(" "));return}Qi(new bi(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hA="firebase-heartbeat-database",dA=1,Fo="firebase-heartbeat-store";let Gc=null;function Rg(){return Gc||(Gc=Cg(hA,dA,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(Fo)}catch(t){console.warn(t)}}}}).catch(i=>{throw qi.create("idb-open",{originalErrorMessage:i.message})})),Gc}async function fA(i){try{const t=(await Rg()).transaction(Fo),n=await t.objectStore(Fo).get(Ig(i));return await t.done,n}catch(e){if(e instanceof Xr)wi.warn(e.message);else{const t=qi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});wi.warn(t.message)}}}async function Dp(i,e){try{const n=(await Rg()).transaction(Fo,"readwrite");await n.objectStore(Fo).put(e,Ig(i)),await n.done}catch(t){if(t instanceof Xr)wi.warn(t.message);else{const n=qi.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});wi.warn(n.message)}}}function Ig(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pA=1024,mA=30;class _A{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new vA(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var e,t;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Lp();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:r}),this._heartbeatsCache.heartbeats.length>mA){const o=xA(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){wi.warn(n)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Lp(),{heartbeatsToSend:n,unsentEntries:r}=gA(this._heartbeatsCache.heartbeats),s=al(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return wi.warn(t),""}}}function Lp(){return new Date().toISOString().substring(0,10)}function gA(i,e=pA){const t=[];let n=i.slice();for(const r of i){const s=t.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),Np(t)>e){s.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),Np(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class vA{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Eg()?Mg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await fA(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Dp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Dp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Np(i){return al(JSON.stringify({version:2,heartbeats:i})).length}function xA(i){if(i.length===0)return-1;let e=0,t=i[0].date;for(let n=1;n<i.length;n++)i[n].date<t&&(t=i[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yA(i){Qi(new bi("platform-logger",e=>new IC(e),"PRIVATE")),Qi(new bi("heartbeat",e=>new _A(e),"PRIVATE")),Qn(dh,Ip,i),Qn(dh,Ip,"esm2017"),Qn("fire-js","")}yA("");var SA="firebase",EA="11.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qn(SA,EA,"app");var Op={};const Up="@firebase/database",Fp="1.0.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dg=function(i){try{if(typeof window<"u"&&typeof window[i]<"u"){const e=window[i];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new TA(e)}}catch{}return new bA},Cr=Dg("localStorage"),wA=Dg("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ms=new cd("@firebase/database"),CA=function(){let i=1;return function(){return i++}}(),Lg=function(i){const e=aC(i),t=new oC;t.update(e);const n=t.digest();return ad.encodeByteArray(n)},na=function(...i){let e="";for(let t=0;t<i.length;t++){const n=i[t];Array.isArray(n)||n&&typeof n=="object"&&typeof n.length=="number"?e+=na.apply(null,n):typeof n=="object"?e+=It(n):e+=n,e+=" "}return e};let vo=null,kp=!0;const AA=function(i,e){re(!0,"Can't turn on custom loggers persistently."),Ms.logLevel=ht.VERBOSE,vo=Ms.log.bind(Ms)},Wt=function(...i){if(kp===!0&&(kp=!1,vo===null&&wA.get("logging_enabled")===!0&&AA()),vo){const e=na.apply(null,i);vo(e)}},ia=function(i){return function(...e){Wt(i,...e)}},mh=function(...i){const e="FIREBASE INTERNAL ERROR: "+na(...i);Ms.error(e)},Ci=function(...i){const e=`FIREBASE FATAL ERROR: ${na(...i)}`;throw Ms.error(e),new Error(e)},cn=function(...i){const e="FIREBASE WARNING: "+na(...i);Ms.warn(e)},RA=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&cn("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Ng=function(i){return typeof i=="number"&&(i!==i||i===Number.POSITIVE_INFINITY||i===Number.NEGATIVE_INFINITY)},IA=function(i){if(document.readyState==="complete")i();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,i())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Bs="[MIN_NAME]",kr="[MAX_NAME]",qs=function(i,e){if(i===e)return 0;if(i===Bs||e===kr)return-1;if(e===Bs||i===kr)return 1;{const t=Bp(i),n=Bp(e);return t!==null?n!==null?t-n===0?i.length-e.length:t-n:-1:n!==null?1:i<e?-1:1}},PA=function(i,e){return i===e?0:i<e?-1:1},no=function(i,e){if(e&&i in e)return e[i];throw new Error("Missing required key ("+i+") in object: "+It(e))},dd=function(i){if(typeof i!="object"||i===null)return It(i);const e=[];for(const n in i)e.push(n);e.sort();let t="{";for(let n=0;n<e.length;n++)n!==0&&(t+=","),t+=It(e[n]),t+=":",t+=dd(i[e[n]]);return t+="}",t},Og=function(i,e){const t=i.length;if(t<=e)return[i];const n=[];for(let r=0;r<t;r+=e)r+e>t?n.push(i.substring(r,t)):n.push(i.substring(r,r+e));return n};function dn(i,e){for(const t in i)i.hasOwnProperty(t)&&e(t,i[t])}const Ug=function(i){re(!Ng(i),"Invalid JSON number");const e=11,t=52,n=(1<<e-1)-1;let r,s,o,a,l;i===0?(s=0,o=0,r=1/i===-1/0?1:0):(r=i<0,i=Math.abs(i),i>=Math.pow(2,1-n)?(a=Math.min(Math.floor(Math.log(i)/Math.LN2),n),s=a+n,o=Math.round(i*Math.pow(2,t-a)-Math.pow(2,t))):(s=0,o=Math.round(i/Math.pow(2,1-n-t))));const c=[];for(l=t;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(s%2?1:0),s=Math.floor(s/2);c.push(r?1:0),c.reverse();const u=c.join("");let h="";for(l=0;l<64;l+=8){let d=parseInt(u.substr(l,8),2).toString(16);d.length===1&&(d="0"+d),h=h+d}return h.toLowerCase()},DA=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},LA=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function NA(i,e){let t="Unknown Error";i==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":i==="permission_denied"?t="Client doesn't have permission to access the desired data.":i==="unavailable"&&(t="The service is unavailable");const n=new Error(i+" at "+e._path.toString()+": "+t);return n.code=i.toUpperCase(),n}const OA=new RegExp("^-?(0*)\\d{1,10}$"),UA=-2147483648,FA=2147483647,Bp=function(i){if(OA.test(i)){const e=Number(i);if(e>=UA&&e<=FA)return e}return null},Ys=function(i){try{i()}catch(e){setTimeout(()=>{const t=e.stack||"";throw cn("Exception was thrown by user callback.",t),e},Math.floor(0))}},kA=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},xo=function(i,e){const t=setTimeout(i,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="5",Fg="v",kg="s",Bg="r",zg="f",Vg=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Hg="ls",Gg="p",_h="ac",Wg="websocket",Xg="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wc={},Xc={};function pd(i){const e=i.toString();return Wc[e]||(Wc[e]=new HA),Wc[e]}function GA(i,e){const t=i.toString();return Xc[t]||(Xc[t]=e()),Xc[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WA{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const n=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let r=0;r<n.length;++r)n[r]&&Ys(()=>{this.onMessage_(n[r])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nR=16384,iR=45e3;let ul=null;typeof MozWebSocket<"u"?ul=MozWebSocket:typeof WebSocket<"u"&&(ul=WebSocket);class kn{constructor(e,t,n,r,s,o,a){this.connId=e,this.applicationId=n,this.appCheckToken=r,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=ia(this.connId),this.stats_=pd(t),this.connURL=kn.connectionURL_(t,o,a,r,n),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,n,r,s){const o={};return o[Fg]=fd,typeof location<"u"&&location.hostname&&Vg.test(location.hostname)&&(o[Bg]=zg),t&&(o[kg]=t),n&&(o[Hg]=n),r&&(o[_h]=r),s&&(o[Gg]=s),Yg(e,Wg,o)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Cr.set("previous_websocket_failure",!0);try{let n;Jw(),this.mySock=new ul(this.connURL,[],n)}catch(n){this.log_("Error instantiating WebSocket.");const r=n.message||n.data;r&&this.log_(r),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=n=>{this.handleIncomingFrame(n)},this.mySock.onerror=n=>{this.log_("WebSocket error.  Closing connection.");const r=n.message||n.data;r&&this.log_(r),this.onClosed_()}}start(){}static forceDisallow(){kn.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,n=navigator.userAgent.match(t);n&&n.length>1&&parseFloat(n[1])<4.4&&(e=!0)}return!e&&ul!==null&&!kn.forceDisallow_}static previouslyFailed(){return Cr.isInMemoryStorage||Cr.get("previous_websocket_failure")===!0}markConnectionHealthy(){Cr.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const n=Oo(t);this.onMessage(n)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(re(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const n=this.extractFrameCount_(t);n!==null&&this.appendFrame_(n)}}send(e){this.resetKeepAlive();const t=It(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=Og(t,nR);n.length>1&&this.sendString_(String(n.length));for(let r=0;r<n.length;r++)this.sendString_(n[r])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(iR))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}kn.responsesRequiredToBeHealthy=2;kn.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{static get ALL_TRANSPORTS(){return[ps,kn]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=kn&&kn.isAvailable();let n=t&&!kn.previouslyFailed();if(e.webSocketOnly&&(t||cn("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),n=!0),n)this.transports_=[kn];else{const r=this.transports_=[];for(const s of ko.ALL_TRANSPORTS)s&&s.isAvailable()&&r.push(s);ko.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}ko.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _d extends ev{static getInstance(){return new _d}constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const n=!document[e];n!==this.visible_&&(this.visible_=n,this.trigger("visible",n))},!1)}getInitialEvent(e){return re(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new Ge(Bs,e),r=new Ge(Bs,t);return this.compare(n,r)!==0}minPost(){return Ge.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ua;class ov extends Fl{static get __EMPTY_NODE(){return Ua}static set __EMPTY_NODE(e){Ua=e}compare(e,t){return qs(e.name,t.name)}isDefinedOn(e){throw Xs("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Ge.MIN}maxPost(){return new Ge(kr,Ua)}makePost(e,t){return re(typeof e=="string","KeyIndex indexValue must always be a string."),new Ge(e,Ua)}toString(){return".key"}}const Ts=new ov;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fa{constructor(e,t,n,r,s=null){this.isReverse_=r,this.resultGenerator_=s,this.nodeStack_=[];let o=1;for(;!e.isEmpty();)if(e=e,o=t?n(e.key,t):1,r&&(o*=-1),o<0)this.isReverse_?e=e.left:e=e.right;else if(o===0){this.nodeStack_.push(e);break}else this.nodeStack_.push(e),this.isReverse_?e=e.right:e=e.left}getNext(){if(this.nodeStack_.length===0)return null;let e=this.nodeStack_.pop(),t;if(this.resultGenerator_?t=this.resultGenerator_(e.key,e.value):t={key:e.key,value:e.value},this.isReverse_)for(e=e.left;!e.isEmpty();)this.nodeStack_.push(e),e=e.right;else for(e=e.right;!e.isEmpty();)this.nodeStack_.push(e),e=e.left;return t}hasNext(){return this.nodeStack_.length>0}peek(){if(this.nodeStack_.length===0)return null;const e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}}class Ut{constructor(e,t,n,r,s){this.key=e,this.value=t,this.color=n??Ut.RED,this.left=r??tn.EMPTY_NODE,this.right=s??tn.EMPTY_NODE}copy(e,t,n,r,s){return new Ut(e??this.key,t??this.value,n??this.color,r??this.left,s??this.right)}count(){return this.left.count()+1+this.right.count()}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min_(){return this.left.isEmpty()?this:this.left.min_()}minKey(){return this.min_().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,n){let r=this;const s=n(e,r.key);return s<0?r=r.copy(null,null,null,r.left.insert(e,t,n),null):s===0?r=r.copy(null,t,null,null,null):r=r.copy(null,null,null,null,r.right.insert(e,t,n)),r.fixUp_()}removeMin_(){if(this.left.isEmpty())return tn.EMPTY_NODE;let e=this;return!e.left.isRed_()&&!e.left.left.isRed_()&&(e=e.moveRedLeft_()),e=e.copy(null,null,null,e.left.removeMin_(),null),e.fixUp_()}remove(e,t){let n,r;if(n=this,t(e,n.key)<0)!n.left.isEmpty()&&!n.left.isRed_()&&!n.left.left.isRed_()&&(n=n.moveRedLeft_()),n=n.copy(null,null,null,n.left.remove(e,t),null);else{if(n.left.isRed_()&&(n=n.rotateRight_()),!n.right.isEmpty()&&!n.right.isRed_()&&!n.right.left.isRed_()&&(n=n.moveRedRight_()),t(e,n.key)===0){if(n.right.isEmpty())return tn.EMPTY_NODE;r=n.right.min_(),n=n.copy(r.key,r.value,null,null,n.right.removeMin_())}n=n.copy(null,null,null,null,n.right.remove(e,t))}return n.fixUp_()}isRed_(){return this.color}fixUp_(){let e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}moveRedLeft_(){let e=this.colorFlip_();return e.right.left.isRed_()&&(e=e.copy(null,null,null,null,e.right.rotateRight_()),e=e.rotateLeft_(),e=e.colorFlip_()),e}moveRedRight_(){let e=this.colorFlip_();return e.left.left.isRed_()&&(e=e.rotateRight_(),e=e.colorFlip_()),e}rotateLeft_(){const e=this.copy(null,null,Ut.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight_(){const e=this.copy(null,null,Ut.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip_(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth_(){const e=this.check_();return Math.pow(2,e)<=this.count()+1}check_(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");const e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}}Ut.RED=!0;Ut.BLACK=!1;class yR{copy(e,t,n,r,s){return this}insert(e,t,n){return new Ut(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}}class tn{constructor(e,t=tn.EMPTY_NODE){this.comparator_=e,this.root_=t}insert(e,t){return new tn(this.comparator_,this.root_.insert(e,t,this.comparator_).copy(null,null,Ut.BLACK,null,null))}remove(e){return new tn(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,Ut.BLACK,null,null))}get(e){let t,n=this.root_;for(;!n.isEmpty();){if(t=this.comparator_(e,n.key),t===0)return n.value;t<0?n=n.left:t>0&&(n=n.right)}return null}getPredecessorKey(e){let t,n=this.root_,r=null;for(;!n.isEmpty();)if(t=this.comparator_(e,n.key),t===0){if(n.left.isEmpty())return r?r.key:null;for(n=n.left;!n.right.isEmpty();)n=n.right;return n.key}else t<0?n=n.left:t>0&&(r=n,n=n.right);throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}isEmpty(){return this.root_.isEmpty()}count(){return this.root_.count()}minKey(){return this.root_.minKey()}maxKey(){return this.root_.maxKey()}inorderTraversal(e){return this.root_.inorderTraversal(e)}reverseTraversal(e){return this.root_.reverseTraversal(e)}getIterator(e){return new Fa(this.root_,null,this.comparator_,!1,e)}getIteratorFrom(e,t){return new Fa(this.root_,e,this.comparator_,!1,t)}getReverseIteratorFrom(e,t){return new Fa(this.root_,e,this.comparator_,!0,t)}getReverseIterator(e){return new Fa(this.root_,null,this.comparator_,!0,e)}}tn.EMPTY_NODE=new yR;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SR(i,e){return qs(i.name,e.name)}function gd(i,e){return qs(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gh;function ER(i){gh=i}const av=function(i){return typeof i=="number"?"number:"+Ug(i):"string:"+i},lv=function(i){if(i.isLeafNode()){const e=i.val();re(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ai(e,".sv"),"Priority must be a string or number.")}else re(i===gh||i.isEmpty(),"priority of unexpected type.");re(i===gh||i.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cv,uv;function MR(i){cv=i}function TR(i){uv=i}class bR extends Fl{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),s=n.compareTo(r);return s===0?qs(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Ge.MIN}maxPost(){return new Ge(kr,new Ot("[PRIORITY-POST]",uv))}makePost(e,t){const n=cv(e);return new Ge(t,new Ot("[PRIORITY-POST]",n))}toString(){return".priority"}}const Tt=new bR;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yc;const cs={};class vi{static get Default(){return re(cs&&Tt,"ChildrenNode.ts has not been loaded"),Yc=Yc||new vi({".priority":cs},{".priority":Tt}),Yc}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=ks(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof tn?t:null}hasIndex(e){return Ai(this.indexSet_,e.toString())}addIndex(e,t){re(e!==Ts,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const s=t.getIterator(Ge.Wrap);let o=s.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=s.getNext();let a;r?a=dl(n,e.getCompare()):a=cs;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new vi(u,c)}addToIndexes(e,t){const n=ll(this.indexes_,(r,s)=>{const o=ks(this.indexSet_,s);if(re(o,"Missing index implementation for "+s),r===cs)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(Ge.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),dl(a,o.getCompare())}else return cs;else{const a=t.get(e.name);let l=r;return a&&(l=l.remove(new Ge(e.name,a))),l.insert(e,e.node)}});return new vi(n,this.indexSet_)}removeFromIndexes(e,t){const n=ll(this.indexes_,r=>{if(r===cs)return r;{const s=t.get(e.name);return s?r.remove(new Ge(e.name,s)):r}});return new vi(n,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RR=!0;function Ft(i,e=null){if(i===null)return De.EMPTY_NODE;if(typeof i=="object"&&".priority"in i&&(e=i[".priority"]),re(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof i=="object"&&".value"in i&&i[".value"]!==null&&(i=i[".value"]),typeof i!="object"||".sv"in i){const t=i;return new Ot(t,Ft(e))}if(!(i instanceof Array)&&RR){const t=[];let n=!1;if(dn(i,(o,a)=>{if(o.substring(0,1)!=="."){const l=Ft(a);l.isEmpty()||(n=n||!l.getPriority().isEmpty(),t.push(new Ge(o,l)))}}),t.length===0)return De.EMPTY_NODE;const s=dl(t,SR,o=>o.name,gd);if(n){const o=dl(t,Tt.getCompare());return new De(s,Ft(e),new vi({".priority":o},{".priority":Tt}))}else return new De(s,Ft(e),vi.Default)}else{let t=De.EMPTY_NODE;return dn(i,(n,r)=>{if(Ai(i,n)&&n.substring(0,1)!=="."){const s=Ft(r);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(n,s))}}),t.updatePriority(Ft(e))}}MR(Ft);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IR extends Fl{constructor(e){super(),this.indexPath_=e,re(!We(e)&&qe(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),s=n.compareTo(r);return s===0?qs(e.name,t.name):s}makePost(e,t){const n=Ft(e),r=De.EMPTY_NODE.updateChild(this.indexPath_,n);return new Ge(t,r)}maxPost(){const e=De.EMPTY_NODE.updateChild(this.indexPath_,ra);return new Ge(kr,e)}toString(){return nv(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PR extends Fl{compare(e,t){const n=e.node.compareTo(t.node);return n===0?qs(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Ge.MIN}maxPost(){return Ge.MAX}makePost(e,t){const n=Ft(e);return new Ge(t,n)}toString(){return".value"}}const DR=new PR;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hv(i){return{type:"value",snapshotNode:i}}function zs(i,e){return{type:"child_added",snapshotNode:e,childName:i}}function Bo(i,e){return{type:"child_removed",snapshotNode:e,childName:i}}function zo(i,e,t){return{type:"child_changed",snapshotNode:e,childName:i,oldSnap:t}}function LR(i,e){return{type:"child_moved",snapshotNode:e,childName:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vd{constructor(e){this.index_=e}updateChild(e,t,n,r,s,o){re(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(r).equals(n.getChild(r))&&a.isEmpty()===n.isEmpty()||(o!=null&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(Bo(t,a)):re(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(zs(t,n)):o.trackChildChange(zo(t,n,a))),e.isLeafNode()&&n.isEmpty())?e:e.updateImmediateChild(t,n).withIndex(this.index_)}updateFullNode(e,t,n){return n!=null&&(e.isLeafNode()||e.forEachChild(Tt,(r,s)=>{t.hasChild(r)||n.trackChildChange(Bo(r,s))}),t.isLeafNode()||t.forEachChild(Tt,(r,s)=>{if(e.hasChild(r)){const o=e.getImmediateChild(r);o.equals(s)||n.trackChildChange(zo(r,s,o))}else n.trackChildChange(zs(r,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?De.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fl extends Qg{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(re(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=ia("p:rest:"),this.listens_={}}listen(e,t,n,r){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const o=fl.getListenId_(e,n),a={};this.listens_[o]=a;const l=Jp(e._queryParams);this.restRequest_(s+".json",l,(c,u)=>{let h=u;if(c===404&&(h=null,c=null),c===null&&this.onDataUpdate_(s,h,!1,n),ks(this.listens_,o)===a){let d;c?c===401?d="permission_denied":d="rest_error:"+c:d="ok",r(d,null)}})}unlisten(e,t){const n=fl.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Jp(e._queryParams),n=e._path.toString(),r=new Nl;return this.restRequest_(n+".json",t,(s,o)=>{let a=o;s===404&&(a=null,s=null),s===null?(this.onDataUpdate_(n,a,!1,null),r.resolve(a)):r.reject(new Error(a))}),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([r,s])=>{r&&r.accessToken&&(t.auth=r.accessToken),s&&s.token&&(t.ac=s.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+sC(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(n&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Oo(a.responseText)}catch{cn("Failed to parse JSON response for "+o+": "+a.responseText)}n(null,l)}else a.status!==401&&a.status!==404&&cn("Got unsuccessful REST response for "+o+" Status: "+a.status),n(a.status);n=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kR{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&dn(this.last_,(n,r)=>{t[n]=t[n]-r}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const em=10*1e3,BR=30*1e3,zR=5*60*1e3;class VR{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new kR(e);const n=em+(BR-em)*Math.random();xo(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;dn(e,(r,s)=>{s>0&&Ai(this.statsToReport_,r)&&(t[r]=s,n=!0)}),n&&this.server_.reportStats(t),xo(this.reportStats_.bind(this),Math.floor(Math.random()*2*zR))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Hn;(function(i){i[i.OVERWRITE=0]="OVERWRITE",i[i.MERGE=1]="MERGE",i[i.ACK_USER_WRITE=2]="ACK_USER_WRITE",i[i.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Hn||(Hn={}));function fv(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function yd(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Sd(i){return{fromUser:!1,fromServer:!0,queryId:i,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ml{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Hn.ACK_USER_WRITE,this.source=fv()}operationForChild(e){if(We(this.path)){if(this.affectedTree.value!=null)return re(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ct(e));return new ml(tt(),t,this.revert)}}else return re(qe(this.path)===e,"operationForChild called for unrelated child."),new ml(dt(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ho{constructor(e,t){this.source=e,this.path=t,this.type=Hn.LISTEN_COMPLETE}operationForChild(e){return We(this.path)?new Ho(this.source,tt()):new Ho(this.source,dt(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Hn.MERGE}operationForChild(e){if(We(this.path)){const t=this.children.subtree(new ct(e));return t.isEmpty()?null:t.value?new Br(this.source,tt(),t.value):new Go(this.source,tt(),t)}else return re(qe(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Go(this.source,dt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HR{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function GR(i,e,t,n){const r=[],s=[];return e.forEach(o=>{o.type==="child_changed"&&i.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&s.push(LR(o.childName,o.snapshotNode))}),so(i,r,"child_removed",e,n,t),so(i,r,"child_added",e,n,t),so(i,r,"child_moved",s,n,t),so(i,r,"child_changed",e,n,t),so(i,r,"value",e,n,t),r}function so(i,e,t,n,r,s){const o=n.filter(a=>a.type===t);o.sort((a,l)=>XR(i,a,l)),o.forEach(a=>{const l=WR(i,a,s);r.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,i.query_))})})}function WR(i,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,i.index_)),e}function XR(i,e,t){if(e.childName==null||t.childName==null)throw Xs("Should only compare child_ events.");const n=new Ge(e.childName,e.snapshotNode),r=new Ge(t.childName,t.snapshotNode);return i.index_.compare(n,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kl(i,e){return{eventCache:i,serverCache:e}}function yo(i,e,t,n){return kl(new tr(e,t,n),i.serverCache)}function pv(i,e,t,n){return kl(i.eventCache,new tr(e,t,n))}function _l(i){return i.eventCache.isFullyInitialized()?i.eventCache.getNode():null}function zr(i){return i.serverCache.isFullyInitialized()?i.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bl(i,e){return xv(e,i)}function YR(i,e,t,n,r){re(n>i.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),i.allWrites.push({path:e,snap:t,writeId:n,visible:r}),r&&(i.visibleWrites=So(i.visibleWrites,e,t)),i.lastWriteId=n}function $R(i,e){for(let t=0;t<i.allWrites.length;t++){const n=i.allWrites[t];if(n.writeId===e)return n}return null}function KR(i,e){const t=i.allWrites.findIndex(a=>a.writeId===e);re(t>=0,"removeWrite called with nonexistent writeId.");const n=i.allWrites[t];i.allWrites.splice(t,1);let r=n.visible,s=!1,o=i.allWrites.length-1;for(;r&&o>=0;){const a=i.allWrites[o];a.visible&&(o>=t&&jR(a,n.path)?r=!1:Vn(n.path,a.path)&&(s=!0)),o--}if(r){if(s)return ZR(i),!0;if(n.snap)i.visibleWrites=nm(i.visibleWrites,n.path);else{const a=n.children;dn(a,l=>{i.visibleWrites=nm(i.visibleWrites,Pt(n.path,l))})}return!0}else return!1}function jR(i,e){if(i.snap)return Vn(i.path,e);for(const t in i.children)if(i.children.hasOwnProperty(t)&&Vn(Pt(i.path,t),e))return!0;return!1}function ZR(i){i.visibleWrites=_v(i.allWrites,JR,tt()),i.allWrites.length>0?i.lastWriteId=i.allWrites[i.allWrites.length-1].writeId:i.lastWriteId=-1}function JR(i){return i.visible}function _v(i,e,t){let n=Wn.empty();for(let r=0;r<i.length;++r){const s=i[r];if(e(s)){const o=s.path;let a;if(s.snap)Vn(t,o)?(a=Jt(t,o),n=So(n,a,s.snap)):Vn(o,t)&&(a=Jt(o,t),n=So(n,tt(),s.snap.getChild(a)));else if(s.children){if(Vn(t,o))a=Jt(t,o),n=tm(n,a,s.children);else if(Vn(o,t))if(a=Jt(o,t),We(a))n=tm(n,tt(),s.children);else{const l=ks(s.children,qe(a));if(l){const c=l.getChild(dt(a));n=So(n,tt(),c)}}}else throw Xs("WriteRecord should have .snap or .children")}}return n}function gv(i,e,t,n,r){if(!n&&!r){const s=qr(i.visibleWrites,e);if(s!=null)return s;{const o=Yi(i.visibleWrites,e);if(yh(o))return t;if(t==null&&!xh(o,tt()))return null;{const a=t||De.EMPTY_NODE;return Vs(o,a)}}}else{const s=Yi(i.visibleWrites,e);if(!r&&yh(s))return t;if(!r&&t==null&&!xh(s,tt()))return null;{const o=function(c){return(c.visible||r)&&(!n||!~n.indexOf(c.writeId))&&(Vn(c.path,e)||Vn(e,c.path))},a=_v(i.allWrites,o,e),l=t||De.EMPTY_NODE;return Vs(a,l)}}}function QR(i,e,t){let n=De.EMPTY_NODE;const r=qr(i.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Tt,(s,o)=>{n=n.updateImmediateChild(s,o)}),n;if(t){const s=Yi(i.visibleWrites,e);return t.forEachChild(Tt,(o,a)=>{const l=Vs(Yi(s,new ct(o)),a);n=n.updateImmediateChild(o,l)}),im(s).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}else{const s=Yi(i.visibleWrites,e);return im(s).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}}function e1(i,e,t,n,r){re(n||r,"Either existingEventSnap or existingServerSnap must exist");const s=Pt(e,t);if(xh(i.visibleWrites,s))return null;{const o=Yi(i.visibleWrites,s);return yh(o)?r.getChild(t):Vs(o,r.getChild(t))}}function t1(i,e,t,n){const r=Pt(e,t),s=qr(i.visibleWrites,r);if(s!=null)return s;if(n.isCompleteForChild(t)){const o=Yi(i.visibleWrites,r);return Vs(o,n.getNode().getImmediateChild(t))}else return null}function n1(i,e){return qr(i.visibleWrites,e)}function i1(i,e,t,n,r,s,o){let a;const l=Yi(i.visibleWrites,e),c=qr(l,tt());if(c!=null)a=c;else if(t!=null)a=Vs(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=s?a.getReverseIteratorFrom(n,o):a.getIteratorFrom(n,o);let f=d.getNext();for(;f&&u.length<r;)h(f,n)!==0&&u.push(f),f=d.getNext();return u}else return[]}function r1(){return{visibleWrites:Wn.empty(),allWrites:[],lastWriteId:-1}}function gl(i,e,t,n){return gv(i.writeTree,i.treePath,e,t,n)}function Ed(i,e){return QR(i.writeTree,i.treePath,e)}function rm(i,e,t,n){return e1(i.writeTree,i.treePath,e,t,n)}function vl(i,e){return n1(i.writeTree,Pt(i.treePath,e))}function s1(i,e,t,n,r,s){return i1(i.writeTree,i.treePath,e,t,n,r,s)}function Md(i,e,t){return t1(i.writeTree,i.treePath,e,t)}function vv(i,e){return xv(Pt(i.treePath,e),i.writeTree)}function xv(i,e){return{treePath:i,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o1{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;re(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),re(n!==".priority","Only non-priority child changes can be tracked.");const r=this.changeMap.get(n);if(r){const s=r.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(n,zo(n,e.snapshotNode,r.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(n);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(n,Bo(n,r.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(n,zs(n,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(n,zo(n,e.snapshotNode,r.oldSnap));else throw Xs("Illegal combination of changes: "+e+" occurred after "+r)}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l1(i){return{filter:i}}function c1(i,e){re(e.eventCache.getNode().isIndexed(i.filter.getIndex()),"Event snap not indexed"),re(e.serverCache.getNode().isIndexed(i.filter.getIndex()),"Server snap not indexed")}function u1(i,e,t,n,r){const s=new o1;let o,a;if(t.type===Hn.OVERWRITE){const c=t;c.source.fromUser?o=Sh(i,e,c.path,c.snap,n,r,s):(re(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!We(c.path),o=xl(i,e,c.path,c.snap,n,r,a,s))}else if(t.type===Hn.MERGE){const c=t;c.source.fromUser?o=d1(i,e,c.path,c.children,n,r,s):(re(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Eh(i,e,c.path,c.children,n,r,a,s))}else if(t.type===Hn.ACK_USER_WRITE){const c=t;c.revert?o=m1(i,e,c.path,n,r,s):o=f1(i,e,c.path,c.affectedTree,n,r,s)}else if(t.type===Hn.LISTEN_COMPLETE)o=p1(i,e,t.path,n,s);else throw Xs("Unknown operation type: "+t.type);const l=s.getChanges();return h1(e,o,l),{viewCache:o,changes:l}}function h1(i,e,t){const n=e.eventCache;if(n.isFullyInitialized()){const r=n.getNode().isLeafNode()||n.getNode().isEmpty(),s=_l(i);(t.length>0||!i.eventCache.isFullyInitialized()||r&&!n.getNode().equals(s)||!n.getNode().getPriority().equals(s.getPriority()))&&t.push(hv(_l(e)))}}function Sv(i,e,t,n,r,s){const o=e.eventCache;if(vl(n,t)!=null)return e;{let a,l;if(We(t))if(re(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=zr(e),u=c instanceof De?c:De.EMPTY_NODE,h=Ed(n,u);a=i.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const c=gl(n,zr(e));a=i.filter.updateFullNode(e.eventCache.getNode(),c,s)}else{const c=qe(t);if(c===".priority"){re(er(t)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const h=rm(n,t,u,l);h!=null?a=i.filter.updatePriority(u,h):a=o.getNode()}else{const u=dt(t);let h;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const d=rm(n,t,o.getNode(),l);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=Md(n,c,e.serverCache);h!=null?a=i.filter.updateChild(o.getNode(),c,h,u,r,s):a=o.getNode()}}return yo(e,a,o.isFullyInitialized()||We(t),i.filter.filtersNodes())}}function xl(i,e,t,n,r,s,o,a){const l=e.serverCache;let c;const u=o?i.filter:i.filter.getIndexedFilter();if(We(t))c=u.updateFullNode(l.getNode(),n,null);else if(u.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(t,n);c=u.updateFullNode(l.getNode(),f,null)}else{const f=qe(t);if(!l.isCompleteForPath(t)&&er(t)>1)return e;const _=dt(t),m=l.getNode().getImmediateChild(f).updateChild(_,n);f===".priority"?c=u.updatePriority(l.getNode(),m):c=u.updateChild(l.getNode(),f,m,_,yv,null)}const h=pv(e,c,l.isFullyInitialized()||We(t),u.filtersNodes()),d=new Td(r,h,s);return Sv(i,h,t,r,d,a)}function Sh(i,e,t,n,r,s,o){const a=e.eventCache;let l,c;const u=new Td(r,e,s);if(We(t))c=i.filter.updateFullNode(e.eventCache.getNode(),n,o),l=yo(e,c,!0,i.filter.filtersNodes());else{const h=qe(t);if(h===".priority")c=i.filter.updatePriority(e.eventCache.getNode(),n),l=yo(e,c,a.isFullyInitialized(),a.isFiltered());else{const d=dt(t),f=a.getNode().getImmediateChild(h);let _;if(We(d))_=n;else{const g=u.getCompleteChild(h);g!=null?tv(d)===".priority"&&g.getChild(iv(d)).isEmpty()?_=g:_=g.updateChild(d,n):_=De.EMPTY_NODE}if(f.equals(_))l=e;else{const g=i.filter.updateChild(a.getNode(),h,_,d,u,o);l=yo(e,g,a.isFullyInitialized(),i.filter.filtersNodes())}}}return l}function sm(i,e){return i.eventCache.isCompleteForChild(e)}function d1(i,e,t,n,r,s,o){let a=e;return n.foreach((l,c)=>{const u=Pt(t,l);sm(e,qe(u))&&(a=Sh(i,a,u,c,r,s,o))}),n.foreach((l,c)=>{const u=Pt(t,l);sm(e,qe(u))||(a=Sh(i,a,u,c,r,s,o))}),a}function om(i,e,t){return t.foreach((n,r)=>{e=e.updateChild(n,r)}),e}function Eh(i,e,t,n,r,s,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;We(t)?c=n:c=new ft(null).setTree(t,n);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const f=e.serverCache.getNode().getImmediateChild(h),_=om(i,f,d);l=xl(i,l,new ct(h),_,r,s,o,a)}}),c.children.inorderTraversal((h,d)=>{const f=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!f){const _=e.serverCache.getNode().getImmediateChild(h),g=om(i,_,d);l=xl(i,l,new ct(h),g,r,s,o,a)}}),l}function f1(i,e,t,n,r,s,o){if(vl(r,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(n.value!=null){if(We(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return xl(i,e,t,l.getNode().getChild(t),r,s,a,o);if(We(t)){let c=new ft(null);return l.getNode().forEachChild(Ts,(u,h)=>{c=c.set(new ct(u),h)}),Eh(i,e,t,c,r,s,a,o)}else return e}else{let c=new ft(null);return n.foreach((u,h)=>{const d=Pt(t,u);l.isCompleteForPath(d)&&(c=c.set(u,l.getNode().getChild(d)))}),Eh(i,e,t,c,r,s,a,o)}}function p1(i,e,t,n,r){const s=e.serverCache,o=pv(e,s.getNode(),s.isFullyInitialized()||We(t),s.isFiltered());return Sv(i,o,t,n,yv,r)}function m1(i,e,t,n,r,s){let o;if(vl(n,t)!=null)return e;{const a=new Td(n,e,r),l=e.eventCache.getNode();let c;if(We(t)||qe(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=gl(n,zr(e));else{const h=e.serverCache.getNode();re(h instanceof De,"serverChildren would be complete if leaf node"),u=Ed(n,h)}u=u,c=i.filter.updateFullNode(l,u,s)}else{const u=qe(t);let h=Md(n,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=l.getImmediateChild(u)),h!=null?c=i.filter.updateChild(l,u,h,dt(t),a,s):e.eventCache.getNode().hasChild(u)?c=i.filter.updateChild(l,u,De.EMPTY_NODE,dt(t),a,s):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=gl(n,zr(e)),o.isLeafNode()&&(c=i.filter.updateFullNode(c,o,s)))}return o=e.serverCache.isFullyInitialized()||vl(n,tt())!=null,yo(e,c,o,i.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _1{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,r=new vd(n.getIndex()),s=OR(n);this.processor_=l1(s);const o=t.serverCache,a=t.eventCache,l=r.updateFullNode(De.EMPTY_NODE,o.getNode(),null),c=s.updateFullNode(De.EMPTY_NODE,a.getNode(),null),u=new tr(l,o.isFullyInitialized(),r.filtersNodes()),h=new tr(c,a.isFullyInitialized(),s.filtersNodes());this.viewCache_=kl(h,u),this.eventGenerator_=new HR(this.query_)}get query(){return this.query_}}function g1(i){return i.viewCache_.serverCache.getNode()}function v1(i){return _l(i.viewCache_)}function x1(i,e){const t=zr(i.viewCache_);return t&&(i.query._queryParams.loadsAllData()||!We(e)&&!t.getImmediateChild(qe(e)).isEmpty())?t.getChild(e):null}function am(i){return i.eventRegistrations_.length===0}function y1(i,e){i.eventRegistrations_.push(e)}function lm(i,e,t){const n=[];if(t){re(e==null,"A cancel should cancel all event registrations.");const r=i.query._path;i.eventRegistrations_.forEach(s=>{const o=s.createCancelEvent(t,r);o&&n.push(o)})}if(e){let r=[];for(let s=0;s<i.eventRegistrations_.length;++s){const o=i.eventRegistrations_[s];if(!o.matches(e))r.push(o);else if(e.hasAnyCallback()){r=r.concat(i.eventRegistrations_.slice(s+1));break}}i.eventRegistrations_=r}else i.eventRegistrations_=[];return n}function cm(i,e,t,n){e.type===Hn.MERGE&&e.source.queryId!==null&&(re(zr(i.viewCache_),"We should always have a full cache before handling merges"),re(_l(i.viewCache_),"Missing event cache, even though we have a server cache"));const r=i.viewCache_,s=u1(i.processor_,r,e,t,n);return c1(i.processor_,s.viewCache),re(s.viewCache.serverCache.isFullyInitialized()||!r.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),i.viewCache_=s.viewCache,Ev(i,s.changes,s.viewCache.eventCache.getNode(),null)}function S1(i,e){const t=i.viewCache_.eventCache,n=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(Tt,(s,o)=>{n.push(zs(s,o))}),t.isFullyInitialized()&&n.push(hv(t.getNode())),Ev(i,n,t.getNode(),e)}function Ev(i,e,t,n){const r=n?[n]:i.eventRegistrations_;return GR(i.eventGenerator_,e,t,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yl;class Mv{constructor(){this.views=new Map}}function E1(i){re(!yl,"__referenceConstructor has already been defined"),yl=i}function M1(){return re(yl,"Reference.ts has not been loaded"),yl}function T1(i){return i.views.size===0}function bd(i,e,t,n){const r=e.source.queryId;if(r!==null){const s=i.views.get(r);return re(s!=null,"SyncTree gave us an op for an invalid query."),cm(s,e,t,n)}else{let s=[];for(const o of i.views.values())s=s.concat(cm(o,e,t,n));return s}}function Tv(i,e,t,n,r){const s=e._queryIdentifier,o=i.views.get(s);if(!o){let a=gl(t,r?n:null),l=!1;a?l=!0:n instanceof De?(a=Ed(t,n),l=!1):(a=De.EMPTY_NODE,l=!1);const c=kl(new tr(a,l,!1),new tr(n,r,!1));return new _1(e,c)}return o}function b1(i,e,t,n,r,s){const o=Tv(i,e,n,r,s);return i.views.has(e._queryIdentifier)||i.views.set(e._queryIdentifier,o),y1(o,t),S1(o,t)}function w1(i,e,t,n){const r=e._queryIdentifier,s=[];let o=[];const a=nr(i);if(r==="default")for(const[l,c]of i.views.entries())o=o.concat(lm(c,t,n)),am(c)&&(i.views.delete(l),c.query._queryParams.loadsAllData()||s.push(c.query));else{const l=i.views.get(r);l&&(o=o.concat(lm(l,t,n)),am(l)&&(i.views.delete(r),l.query._queryParams.loadsAllData()||s.push(l.query)))}return a&&!nr(i)&&s.push(new(M1())(e._repo,e._path)),{removed:s,events:o}}function bv(i){const e=[];for(const t of i.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function $i(i,e){let t=null;for(const n of i.views.values())t=t||x1(n,e);return t}function wv(i,e){if(e._queryParams.loadsAllData())return zl(i);{const n=e._queryIdentifier;return i.views.get(n)}}function Cv(i,e){return wv(i,e)!=null}function nr(i){return zl(i)!=null}function zl(i){for(const e of i.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Sl;function C1(i){re(!Sl,"__referenceConstructor has already been defined"),Sl=i}function A1(){return re(Sl,"Reference.ts has not been loaded"),Sl}let R1=1;class um{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ft(null),this.pendingWriteTree_=r1(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Av(i,e,t,n,r){return YR(i.pendingWriteTree_,e,t,n,r),r?oa(i,new Br(fv(),e,t)):[]}function Ar(i,e,t=!1){const n=$R(i.pendingWriteTree_,e);if(KR(i.pendingWriteTree_,e)){let s=new ft(null);return n.snap!=null?s=s.set(tt(),!0):dn(n.children,o=>{s=s.set(new ct(o),!0)}),oa(i,new ml(n.path,s,t))}else return[]}function sa(i,e,t){return oa(i,new Br(yd(),e,t))}function I1(i,e,t){const n=ft.fromObject(t);return oa(i,new Go(yd(),e,n))}function P1(i,e){return oa(i,new Ho(yd(),e))}function D1(i,e,t){const n=Cd(i,t);if(n){const r=Ad(n),s=r.path,o=r.queryId,a=Jt(s,e),l=new Ho(Sd(o),a);return Rd(i,s,l)}else return[]}function Rv(i,e,t,n,r=!1){const s=e._path,o=i.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Cv(o,e))){const l=w1(o,e,t,n);T1(o)&&(i.syncPointTree_=i.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=i.syncPointTree_.findOnPath(s,(d,f)=>nr(f));if(u&&!h){const d=i.syncPointTree_.subtree(s);if(!d.isEmpty()){const f=U1(d);for(let _=0;_<f.length;++_){const g=f[_],m=g.query,p=Lv(i,g);i.listenProvider_.startListening(Eo(m),Wo(i,m),p.hashFn,p.onComplete)}}}!h&&c.length>0&&!n&&(u?i.listenProvider_.stopListening(Eo(e),null):c.forEach(d=>{const f=i.queryToTagMap.get(Vl(d));i.listenProvider_.stopListening(Eo(d),f)}))}F1(i,c)}return a}function Iv(i,e,t,n){const r=Cd(i,n);if(r!=null){const s=Ad(r),o=s.path,a=s.queryId,l=Jt(o,e),c=new Br(Sd(a),l,t);return Rd(i,o,c)}else return[]}function L1(i,e,t,n){const r=Cd(i,n);if(r){const s=Ad(r),o=s.path,a=s.queryId,l=Jt(o,e),c=ft.fromObject(t),u=new Go(Sd(a),l,c);return Rd(i,o,u)}else return[]}function N1(i,e,t,n=!1){const r=e._path;let s=null,o=!1;i.syncPointTree_.foreachOnPath(r,(d,f)=>{const _=Jt(d,r);s=s||$i(f,_),o=o||nr(f)});let a=i.syncPointTree_.get(r);a?(o=o||nr(a),s=s||$i(a,tt())):(a=new Mv,i.syncPointTree_=i.syncPointTree_.set(r,a));let l;s!=null?l=!0:(l=!1,s=De.EMPTY_NODE,i.syncPointTree_.subtree(r).foreachChild((f,_)=>{const g=$i(_,tt());g&&(s=s.updateImmediateChild(f,g))}));const c=Cv(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Vl(e);re(!i.queryToTagMap.has(d),"View does not exist, but we have a tag");const f=k1();i.queryToTagMap.set(d,f),i.tagToQueryMap.set(f,d)}const u=Bl(i.pendingWriteTree_,r);let h=b1(a,e,t,u,s,l);if(!c&&!o&&!n){const d=wv(a,e);h=h.concat(B1(i,e,d))}return h}function wd(i,e,t){const r=i.pendingWriteTree_,s=i.syncPointTree_.findOnPath(e,(o,a)=>{const l=Jt(o,e),c=$i(a,l);if(c)return c});return gv(r,e,s,t,!0)}function O1(i,e){const t=e._path;let n=null;i.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=Jt(c,t);n=n||$i(u,h)});let r=i.syncPointTree_.get(t);r?n=n||$i(r,tt()):(r=new Mv,i.syncPointTree_=i.syncPointTree_.set(t,r));const s=n!=null,o=s?new tr(n,!0,!1):null,a=Bl(i.pendingWriteTree_,e._path),l=Tv(r,e,a,s?o.getNode():De.EMPTY_NODE,s);return v1(l)}function oa(i,e){return Pv(e,i.syncPointTree_,null,Bl(i.pendingWriteTree_,tt()))}function Pv(i,e,t,n){if(We(i.path))return Dv(i,e,t,n);{const r=e.get(tt());t==null&&r!=null&&(t=$i(r,tt()));let s=[];const o=qe(i.path),a=i.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,u=vv(n,o);s=s.concat(Pv(a,l,c,u))}return r&&(s=s.concat(bd(r,i,n,t))),s}}function Dv(i,e,t,n){const r=e.get(tt());t==null&&r!=null&&(t=$i(r,tt()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=vv(n,o),u=i.operationForChild(o);u&&(s=s.concat(Dv(u,a,l,c)))}),r&&(s=s.concat(bd(r,i,n,t))),s}function Lv(i,e){const t=e.query,n=Wo(i,t);return{hashFn:()=>(g1(e)||De.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return n?D1(i,t._path,n):P1(i,t._path);{const s=NA(r,t);return Rv(i,t,null,s)}}}}function Wo(i,e){const t=Vl(e);return i.queryToTagMap.get(t)}function Vl(i){return i._path.toString()+"$"+i._queryIdentifier}function Cd(i,e){return i.tagToQueryMap.get(e)}function Ad(i){const e=i.indexOf("$");return re(e!==-1&&e<i.length-1,"Bad queryKey."),{queryId:i.substr(e+1),path:new ct(i.substr(0,e))}}function Rd(i,e,t){const n=i.syncPointTree_.get(e);re(n,"Missing sync point for query tag that we're tracking");const r=Bl(i.pendingWriteTree_,e);return bd(n,t,r,null)}function U1(i){return i.fold((e,t,n)=>{if(t&&nr(t))return[zl(t)];{let r=[];return t&&(r=bv(t)),dn(n,(s,o)=>{r=r.concat(o)}),r}})}function Eo(i){return i._queryParams.loadsAllData()&&!i._queryParams.isDefault()?new(A1())(i._repo,i._path):i}function F1(i,e){for(let t=0;t<e.length;++t){const n=e[t];if(!n._queryParams.loadsAllData()){const r=Vl(n),s=i.queryToTagMap.get(r);i.queryToTagMap.delete(r),i.tagToQueryMap.delete(s)}}}function k1(){return R1++}function B1(i,e,t){const n=e._path,r=Wo(i,e),s=Lv(i,t),o=i.listenProvider_.startListening(Eo(e),r,s.hashFn,s.onComplete),a=i.syncPointTree_.subtree(n);if(r)re(!nr(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!We(c)&&u&&nr(u))return[zl(u).query];{let d=[];return u&&(d=d.concat(bv(u).map(f=>f.query))),dn(h,(f,_)=>{d=d.concat(_)}),d}});for(let c=0;c<l.length;++c){const u=l[c];i.listenProvider_.stopListening(Eo(u),Wo(i,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Id{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Id(t)}node(){return this.node_}}class Pd{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Pt(this.path_,e);return new Pd(this.syncTree_,t)}node(){return wd(this.syncTree_,this.path_)}}const z1=function(i){return i=i||{},i.timestamp=i.timestamp||new Date().getTime(),i},hm=function(i,e,t){if(!i||typeof i!="object")return i;if(re(".sv"in i,"Unexpected leaf node or priority contents"),typeof i[".sv"]=="string")return V1(i[".sv"],e,t);if(typeof i[".sv"]=="object")return H1(i[".sv"],e);re(!1,"Unexpected server value: "+JSON.stringify(i,null,2))},V1=function(i,e,t){switch(i){case"timestamp":return t.timestamp;default:re(!1,"Unexpected server value: "+i)}},H1=function(i,e,t){i.hasOwnProperty("increment")||re(!1,"Unexpected server value: "+JSON.stringify(i,null,2));const n=i.increment;typeof n!="number"&&re(!1,"Unexpected increment value: "+n);const r=e.node();if(re(r!==null&&typeof r<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return n;const o=r.getValue();return typeof o!="number"?n:o+n},G1=function(i,e,t,n){return Dd(e,new Pd(t,i),n)},Nv=function(i,e,t){return Dd(i,new Id(e),t)};function Dd(i,e,t){const n=i.getPriority().val(),r=hm(n,e.getImmediateChild(".priority"),t);let s;if(i.isLeafNode()){const o=i,a=hm(o.getValue(),e,t);return a!==o.getValue()||r!==o.getPriority().val()?new Ot(a,Ft(r)):i}else{const o=i;return s=o,r!==o.getPriority().val()&&(s=s.updatePriority(new Ot(r))),o.forEachChild(Tt,(a,l)=>{const c=Dd(l,e.getImmediateChild(a),t);c!==l&&(s=s.updateImmediateChild(a,c))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y1=/[\[\].#$\/\u0000-\u001F\u007F]/,$1=/[\[\].#$\u0000-\u001F\u007F]/,Kc=10*1024*1024,kv=function(i){return typeof i=="string"&&i.length!==0&&!Y1.test(i)},Bv=function(i){return typeof i=="string"&&i.length!==0&&!$1.test(i)},K1=function(i){return i&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),Bv(i)},j1=function(i,e,t,n){Od(ld(i,"value"),e,t)},Od=function(i,e,t){const n=t instanceof ct?new fR(t,i):t;if(e===void 0)throw new Error(i+"contains undefined "+Sr(n));if(typeof e=="function")throw new Error(i+"contains a function "+Sr(n)+" with contents = "+e.toString());if(Ng(e))throw new Error(i+"contains "+e.toString()+" "+Sr(n));if(typeof e=="string"&&e.length>Kc/3&&Ul(e)>Kc)throw new Error(i+"contains a string greater than "+Kc+" utf8 bytes "+Sr(n)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let r=!1,s=!1;if(dn(e,(o,a)=>{if(o===".value")r=!0;else if(o!==".priority"&&o!==".sv"&&(s=!0,!kv(o)))throw new Error(i+" contains an invalid key ("+o+") "+Sr(n)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);pR(n,o),Od(i,a,n),mR(n)}),r&&s)throw new Error(i+' contains ".value" child '+Sr(n)+" in addition to actual children.")}},zv=function(i,e,t,n){if(!Bv(t))throw new Error(ld(i,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Z1=function(i,e,t,n){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),zv(i,e,t)},J1=function(i,e){if(qe(e)===".info")throw new Error(i+" failed = Can't modify data under /.info/")},Q1=function(i,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!kv(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!K1(t))throw new Error(ld(i,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iI="repo_interrupt",rI=25;class sI{constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new eI,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=pl(),this.transactionQueueTree_=new Ld,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function oI(i,e,t){if(i.stats_=pd(i.repoInfo_),i.forceRestClient_||kA())i.server_=new fl(i.repoInfo_,(n,r,s,o)=>{dm(i,n,r,s,o)},i.authTokenProvider_,i.appCheckProvider_),setTimeout(()=>fm(i,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{It(t)}catch(n){throw new Error("Invalid authOverride provided: "+n)}}i.persistentConnection_=new Si(i.repoInfo_,e,(n,r,s,o)=>{dm(i,n,r,s,o)},n=>{fm(i,n)},n=>{lI(i,n)},i.authTokenProvider_,i.appCheckProvider_,t),i.server_=i.persistentConnection_}i.authTokenProvider_.addTokenChangeListener(n=>{i.server_.refreshAuthToken(n)}),i.appCheckProvider_.addTokenChangeListener(n=>{i.server_.refreshAppCheckToken(n.token)}),i.statsReporter_=GA(i.repoInfo_,()=>new VR(i.stats_,i.server_)),i.infoData_=new UR,i.infoSyncTree_=new um({startListening:(n,r,s,o)=>{let a=[];const l=i.infoData_.getNode(n._path);return l.isEmpty()||(a=sa(i.infoSyncTree_,n._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Fd(i,"connected",!1),i.serverSyncTree_=new um({startListening:(n,r,s,o)=>(i.server_.listen(n,s,r,(a,l)=>{const c=o(a,l);ni(i.eventQueue_,n._path,c)}),[]),stopListening:(n,r)=>{i.server_.unlisten(n,r)}})}function aI(i){const t=i.infoData_.getNode(new ct(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Ud(i){return z1({timestamp:aI(i)})}function dm(i,e,t,n,r){i.dataUpdateCount++;const s=new ct(e);t=i.interceptServerDataCallback_?i.interceptServerDataCallback_(e,t):t;let o=[];if(r)if(n){const l=ll(t,c=>Ft(c));o=L1(i.serverSyncTree_,s,l,r)}else{const l=Ft(t);o=Iv(i.serverSyncTree_,s,l,r)}else if(n){const l=ll(t,c=>Ft(c));o=I1(i.serverSyncTree_,s,l)}else{const l=Ft(t);o=sa(i.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=Wl(i,s)),ni(i.eventQueue_,a,o)}function fm(i,e){Fd(i,"connected",e),e===!1&&hI(i)}function lI(i,e){dn(e,(t,n)=>{Fd(i,t,n)})}function Fd(i,e,t){const n=new ct("/.info/"+e),r=Ft(t);i.infoData_.updateSnapshot(n,r);const s=sa(i.infoSyncTree_,n,r);ni(i.eventQueue_,n,s)}function Hv(i){return i.nextWriteId_++}function cI(i,e,t){const n=O1(i.serverSyncTree_,e);return n!=null?Promise.resolve(n):i.server_.get(e).then(r=>{const s=Ft(r).withIndex(e._queryParams.getIndex());N1(i.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=sa(i.serverSyncTree_,e._path,s);else{const a=Wo(i.serverSyncTree_,e);o=Iv(i.serverSyncTree_,e._path,s,a)}return ni(i.eventQueue_,e._path,o),Rv(i.serverSyncTree_,e,t,null,!0),s},r=>(Gl(i,"get for query "+It(e)+" failed: "+r),Promise.reject(new Error(r))))}function uI(i,e,t,n,r){Gl(i,"set",{path:e.toString(),value:t,priority:n});const s=Ud(i),o=Ft(t,n),a=wd(i.serverSyncTree_,e),l=Nv(o,a,s),c=Hv(i),u=Av(i.serverSyncTree_,e,l,c,!0);Vv(i.eventQueue_,u),i.server_.put(e.toString(),o.val(!0),(d,f)=>{const _=d==="ok";_||cn("set at "+e+" failed: "+d);const g=Ar(i.serverSyncTree_,c,!_);ni(i.eventQueue_,e,g),fI(i,r,d,f)});const h=Yv(i,e);Wl(i,h),ni(i.eventQueue_,h,[])}function hI(i){Gl(i,"onDisconnectEvents");const e=Ud(i),t=pl();vh(i.onDisconnect_,tt(),(r,s)=>{const o=G1(r,s,i.serverSyncTree_,e);dv(t,r,o)});let n=[];vh(t,tt(),(r,s)=>{n=n.concat(sa(i.serverSyncTree_,r,s));const o=Yv(i,r);Wl(i,o)}),i.onDisconnect_=pl(),ni(i.eventQueue_,tt(),n)}function dI(i){i.persistentConnection_&&i.persistentConnection_.interrupt(iI)}function Gl(i,...e){let t="";i.persistentConnection_&&(t=i.persistentConnection_.id+":"),Wt(t,...e)}function fI(i,e,t,n){e&&Ys(()=>{if(t==="ok")e(null);else{const r=(t||"error").toUpperCase();let s=r;n&&(s+=": "+n);const o=new Error(s);o.code=r,e(o)}})}function Gv(i,e,t){return wd(i.serverSyncTree_,e,t)||De.EMPTY_NODE}function kd(i,e=i.transactionQueueTree_){if(e||Xl(i,e),$s(e)){const t=Xv(i,e);re(t.length>0,"Sending zero length transaction queue"),t.every(r=>r.status===0)&&pI(i,aa(e),t)}else Uv(e)&&Hl(e,t=>{kd(i,t)})}function pI(i,e,t){const n=t.map(c=>c.currentWriteId),r=Gv(i,e,n);let s=r;const o=r.hash();for(let c=0;c<t.length;c++){const u=t[c];re(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Jt(e,u.path);s=s.updateChild(h,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;i.server_.put(l.toString(),a,c=>{Gl(i,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<t.length;d++)t[d].status=2,u=u.concat(Ar(i.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&h.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();Xl(i,Nd(i.transactionQueueTree_,e)),kd(i,i.transactionQueueTree_),ni(i.eventQueue_,e,u);for(let d=0;d<h.length;d++)Ys(h[d])}else{if(c==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{cn("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=c}Wl(i,e)}},o)}function Wl(i,e){const t=Wv(i,e),n=aa(t),r=Xv(i,t);return mI(i,r,n),n}function mI(i,e,t){if(e.length===0)return;const n=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Jt(t,l.path);let u=!1,h;if(re(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,h=l.abortReason,r=r.concat(Ar(i.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=rI)u=!0,h="maxretry",r=r.concat(Ar(i.serverSyncTree_,l.currentWriteId,!0));else{const d=Gv(i,l.path,o);l.currentInputSnapshot=d;const f=e[a].update(d.val());if(f!==void 0){Od("transaction failed: Data returned ",f,l.path);let _=Ft(f);typeof f=="object"&&f!=null&&Ai(f,".priority")||(_=_.updatePriority(d.getPriority()));const m=l.currentWriteId,p=Ud(i),T=Nv(_,d,p);l.currentOutputSnapshotRaw=_,l.currentOutputSnapshotResolved=T,l.currentWriteId=Hv(i),o.splice(o.indexOf(m),1),r=r.concat(Av(i.serverSyncTree_,l.path,T,l.currentWriteId,l.applyLocally)),r=r.concat(Ar(i.serverSyncTree_,m,!0))}else u=!0,h="nodata",r=r.concat(Ar(i.serverSyncTree_,l.currentWriteId,!0))}ni(i.eventQueue_,t,r),r=[],u&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?n.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):n.push(()=>e[a].onComplete(new Error(h),!1,null))))}Xl(i,i.transactionQueueTree_);for(let a=0;a<n.length;a++)Ys(n[a]);kd(i,i.transactionQueueTree_)}function Wv(i,e){let t,n=i.transactionQueueTree_;for(t=qe(e);t!==null&&$s(n)===void 0;)n=Nd(n,t),e=dt(e),t=qe(e);return n}function Xv(i,e){const t=[];return qv(i,e,t),t.sort((n,r)=>n.order-r.order),t}function qv(i,e,t){const n=$s(e);if(n)for(let r=0;r<n.length;r++)t.push(n[r]);Hl(e,r=>{qv(i,r,t)})}function Xl(i,e){const t=$s(e);if(t){let n=0;for(let r=0;r<t.length;r++)t[r].status!==2&&(t[n]=t[r],n++);t.length=n,Ov(e,t.length>0?t:void 0)}Hl(e,n=>{Xl(i,n)})}function Yv(i,e){const t=aa(Wv(i,e)),n=Nd(i.transactionQueueTree_,e);return X1(n,r=>{jc(i,r)}),jc(i,n),Fv(n,r=>{jc(i,r)}),t}function jc(i,e){const t=$s(e);if(t){const n=[];let r=[],s=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(re(s===o-1,"All SENT items should be at beginning of queue."),s=o,t[o].status=3,t[o].abortReason="set"):(re(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),r=r.concat(Ar(i.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&n.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Ov(e,void 0):t.length=s+1,ni(i.eventQueue_,aa(e),r);for(let o=0;o<n.length;o++)Ys(n[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bd{constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}get key(){return We(this._path)?null:tv(this._path)}get ref(){return new Ri(this._repo,this._path)}get _queryIdentifier(){const e=Qp(this._queryParams),t=dd(e);return t==="{}"?"default":t}get _queryObject(){return Qp(this._queryParams)}isEqual(e){if(e=sr(e),!(e instanceof Bd))return!1;const t=this._repo===e._repo,n=rv(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+dR(this._path)}}class Ri extends Bd{constructor(e,t){super(e,t,new xd,!1)}get parent(){const e=iv(this._path);return e===null?null:new Ri(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Xo{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ct(e),n=Th(this.ref,e);return new Xo(this._node.getChild(t),n,Tt)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(n,r)=>e(new Xo(r,Th(this.ref,n),Tt)))}hasChild(e){const t=new ct(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function qo(i,e){return i=sr(i),i._checkNotDeleted("ref"),e!==void 0?Th(i._root,e):i._root}function Th(i,e){return i=sr(i),qe(i._path)===null?Z1("child","path",e):zv("child","path",e),new Ri(i._repo,Pt(i._path,e))}function bh(i,e){i=sr(i),J1("set",i._path),j1("set",e,i._path);const t=new Nl;return uI(i._repo,i._path,e,null,t.wrapCallback(()=>{})),t.promise}function $v(i){i=sr(i);const e=new SI(()=>{}),t=new zd(e);return cI(i._repo,i,t).then(n=>new Xo(n,new Ri(i._repo,i._path),i._queryParams.getIndex()))}class zd{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const n=t._queryParams.getIndex();return new xI("value",this,new Xo(e.snapshotNode,new Ri(t._repo,t._path),n))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new yI(this,e,t):null}matches(e){return e instanceof zd?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}E1(Ri);C1(Ri);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(i){MA(uA),Qi(new bi("database",(e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return bI(n,r,s,t)},"PUBLIC").setMultipleInstances(!0)),Qn(Up,Fp,i),Qn(Up,Fp,"esm2017")}Si.prototype.simpleListen=function(i,e){this.sendRequest("q",{p:i},e)};Si.prototype.echo=function(i,e){this.sendRequest("echo",{d:i},e)};PI();const Kv="@firebase/installations",Vd="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jv=1e4,Zv=`w:${Vd}`,Jv="FIS_v2",DI="https://firebaseinstallations.googleapis.com/v1",LI=60*60*1e3,NI="installations",OI="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $I="firebase-installations-database",KI=1,Hr="firebase-installations-store";let Zc=null;function Hd(){return Zc||(Zc=Cg($I,KI,{upgrade:(i,e)=>{switch(e){case 0:i.createObjectStore(Hr)}}})),Zc}async function El(i,e){const t=ql(i),r=(await Hd()).transaction(Hr,"readwrite"),s=r.objectStore(Hr),o=await s.get(t);return await s.put(e,t),await r.done,(!o||o.fid!==e.fid)&&a0(i,e.fid),e}async function c0(i){const e=ql(i),n=(await Hd()).transaction(Hr,"readwrite");await n.objectStore(Hr).delete(e),await n.done}async function Yl(i,e){const t=ql(i),r=(await Hd()).transaction(Hr,"readwrite"),s=r.objectStore(Hr),o=await s.get(t),a=e(o);return a===void 0?await s.delete(t):await s.put(a,t),await r.done,a&&(!o||o.fid!==a.fid)&&a0(i,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gd(i){let e;const t=await Yl(i.appConfig,n=>{const r=jI(n),s=ZI(i,r);return e=s.registrationPromise,s.installationEntry});return t.fid===Ch?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function jI(i){const e=i||{fid:GI(),registrationStatus:0};return u0(e)}function ZI(i,e){if(e.registrationStatus===0){if(!navigator.onLine){const r=Promise.reject(Vr.create("app-offline"));return{installationEntry:e,registrationPromise:r}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},n=JI(i,t);return{installationEntry:t,registrationPromise:n}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:QI(i)}:{installationEntry:e}}async function JI(i,e){try{const t=await zI(i,e);return El(i.appConfig,t)}catch(t){throw Qv(t)&&t.customData.serverCode===409?await c0(i.appConfig):await El(i.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function QI(i){let e=await mm(i.appConfig);for(;e.registrationStatus===1;)await s0(100),e=await mm(i.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:n}=await Gd(i);return n||t}return e}function mm(i){return Yl(i,e=>{if(!e)throw Vr.create("installation-not-found");return u0(e)})}function u0(i){return eP(i)?{fid:i.fid,registrationStatus:0}:i}function eP(i){return i.registrationStatus===1&&i.registrationTime+jv<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cP(i){const e=i,{installationEntry:t,registrationPromise:n}=await Gd(e);return n?n.catch(console.error):Wd(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uP(i,e=!1){const t=i;return await hP(t),(await Wd(t,e)).token}async function hP(i){const{registrationPromise:e}=await Gd(i);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dP(i){if(!i||!i.options)throw Jc("App Configuration");if(!i.name)throw Jc("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!i.options[t])throw Jc(t);return{appName:i.name,projectId:i.options.projectId,apiKey:i.options.apiKey,appId:i.options.appId}}function Jc(i){return Vr.create("missing-app-config-values",{valueName:i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d0="installations",fP="installations-internal",pP=i=>{const e=i.getProvider("app").getImmediate(),t=dP(e),n=ta(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},mP=i=>{const e=i.getProvider("app").getImmediate(),t=ta(e,d0).getImmediate();return{getId:()=>cP(t),getToken:r=>uP(t,r)}};function _P(){Qi(new bi(d0,pP,"PUBLIC")),Qi(new bi(fP,mP,"PRIVATE"))}_P();Qn(Kv,Vd);Qn(Kv,Vd,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ml="analytics",gP="firebase_id",vP="origin",xP=60*1e3,yP="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Xd="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const un=new cd("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EP(i){if(!i.startsWith(Xd)){const e=yn.create("invalid-gtag-resource",{gtagURL:i});return un.warn(e.message),""}return i}function f0(i){return Promise.all(i.map(e=>e.catch(t=>t)))}function MP(i,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(i,e)),t}function TP(i,e){const t=MP("firebase-js-sdk-policy",{createScriptURL:EP}),n=document.createElement("script"),r=`${Xd}?l=${i}&id=${e}`;n.src=t?t==null?void 0:t.createScriptURL(r):r,n.async=!0,document.head.appendChild(n)}function bP(i){let e=[];return Array.isArray(window[i])?e=window[i]:window[i]=e,e}async function wP(i,e,t,n,r,s){const o=n[r];try{if(o)await e[o];else{const l=(await f0(t)).find(c=>c.measurementId===r);l&&await e[l.appId]}}catch(a){un.error(a)}i("config",r,s)}async function CP(i,e,t,n,r){try{let s=[];if(r&&r.send_to){let o=r.send_to;Array.isArray(o)||(o=[o]);const a=await f0(t);for(const l of o){const c=a.find(h=>h.measurementId===l),u=c&&e[c.appId];if(u)s.push(u);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),i("event",n,r||{})}catch(s){un.error(s)}}function AP(i,e,t,n){async function r(s,...o){try{if(s==="event"){const[a,l]=o;await CP(i,e,t,a,l)}else if(s==="config"){const[a,l]=o;await wP(i,e,t,n,a,l)}else if(s==="consent"){const[a,l]=o;i("consent",a,l)}else if(s==="get"){const[a,l,c]=o;i("get",a,l,c)}else if(s==="set"){const[a]=o;i("set",a)}else i(s,...o)}catch(a){un.error(a)}}return r}function RP(i,e,t,n,r){let s=function(...o){window[n].push(arguments)};return window[r]&&typeof window[r]=="function"&&(s=window[r]),window[r]=AP(s,i,e,t),{gtagCore:s,wrappedGtag:window[r]}}function IP(i){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(Xd)&&t.src.includes(i))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PP=30,DP=1e3;class LP{constructor(e={},t=DP){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const p0=new LP;function NP(i){return new Headers({Accept:"application/json","x-goog-api-key":i})}async function OP(i){var e;const{appId:t,apiKey:n}=i,r={method:"GET",headers:NP(n)},s=yP.replace("{app-id}",t),o=await fetch(s,r);if(o.status!==200&&o.status!==304){let a="";try{const l=await o.json();!((e=l.error)===null||e===void 0)&&e.message&&(a=l.error.message)}catch{}throw yn.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function UP(i,e=p0,t){const{appId:n,apiKey:r,measurementId:s}=i.options;if(!n)throw yn.create("no-app-id");if(!r){if(s)return{measurementId:s,appId:n};throw yn.create("no-api-key")}const o=e.getThrottleMetadata(n)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new BP;return setTimeout(async()=>{a.abort()},xP),m0({appId:n,apiKey:r,measurementId:s},o,a,e)}async function m0(i,{throttleEndTimeMillis:e,backoffCount:t},n,r=p0){var s;const{appId:o,measurementId:a}=i;try{await FP(n,e)}catch(l){if(a)return un.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw l}try{const l=await OP(i);return r.deleteThrottleMetadata(o),l}catch(l){const c=l;if(!kP(c)){if(r.deleteThrottleMetadata(o),a)return un.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:a};throw l}const u=Number((s=c==null?void 0:c.customData)===null||s===void 0?void 0:s.httpStatus)===503?wp(t,r.intervalMillis,PP):wp(t,r.intervalMillis),h={throttleEndTimeMillis:Date.now()+u,backoffCount:t+1};return r.setThrottleMetadata(o,h),un.debug(`Calling attemptFetch again in ${u} millis`),m0(i,h,n,r)}}function FP(i,e){return new Promise((t,n)=>{const r=Math.max(e-Date.now(),0),s=setTimeout(t,r);i.addEventListener(()=>{clearTimeout(s),n(yn.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function kP(i){if(!(i instanceof Xr)||!i.customData)return!1;const e=Number(i.customData.httpStatus);return e===429||e===500||e===503||e===504}class BP{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function zP(i,e,t,n,r){if(r&&r.global){i("event",t,n);return}else{const s=await e,o=Object.assign(Object.assign({},n),{send_to:s});i("event",t,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function VP(){if(Eg())try{await Mg()}catch(i){return un.warn(yn.create("indexeddb-unavailable",{errorInfo:i==null?void 0:i.toString()}).message),!1}else return un.warn(yn.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function HP(i,e,t,n,r,s,o){var a;const l=UP(i);l.then(f=>{t[f.measurementId]=f.appId,i.options.measurementId&&f.measurementId!==i.options.measurementId&&un.warn(`The measurement ID in the local Firebase config (${i.options.measurementId}) does not match the measurement ID fetched from the server (${f.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(f=>un.error(f)),e.push(l);const c=VP().then(f=>{if(f)return n.getId()}),[u,h]=await Promise.all([l,c]);IP(s)||TP(s,u.measurementId),r("js",new Date);const d=(a=o==null?void 0:o.config)!==null&&a!==void 0?a:{};return d[vP]="firebase",d.update=!0,h!=null&&(d[gP]=h),r("config",u.measurementId,d),u.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GP{constructor(e){this.app=e}_delete(){return delete Mo[this.app.options.appId],Promise.resolve()}}let Mo={},gm=[];const vm={};let Qc="dataLayer",WP="gtag",xm,_0,ym=!1;function XP(){const i=[];if(jw()&&i.push("This is a browser extension environment."),Qw()||i.push("Cookies are not available."),i.length>0){const e=i.map((n,r)=>`(${r+1}) ${n}`).join(" "),t=yn.create("invalid-analytics-context",{errorInfo:e});un.warn(t.message)}}function qP(i,e,t){XP();const n=i.options.appId;if(!n)throw yn.create("no-app-id");if(!i.options.apiKey)if(i.options.measurementId)un.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${i.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw yn.create("no-api-key");if(Mo[n]!=null)throw yn.create("already-exists",{id:n});if(!ym){bP(Qc);const{wrappedGtag:s,gtagCore:o}=RP(Mo,gm,vm,Qc,WP);_0=s,xm=o,ym=!0}return Mo[n]=HP(i,gm,vm,e,xm,Qc,t),new GP(i)}function YP(i=hd()){i=sr(i);const e=ta(i,Ml);return e.isInitialized()?e.getImmediate():$P(i)}function $P(i,e={}){const t=ta(i,Ml);if(t.isInitialized()){const r=t.getImmediate();if(Uo(e,t.getOptions()))return r;throw yn.create("already-initialized")}return t.initialize({options:e})}function KP(i,e,t,n){i=sr(i),zP(_0,Mo[i.app.options.appId],e,t,n).catch(r=>un.error(r))}const Sm="@firebase/analytics",Em="0.10.12";function jP(){Qi(new bi(Ml,(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return qP(n,r,t)},"PUBLIC")),Qi(new bi("analytics-internal",i,"PRIVATE")),Qn(Sm,Em),Qn(Sm,Em,"esm2017");function i(e){try{const t=e.getProvider(Ml).getImmediate();return{logEvent:(n,r,s)=>KP(t,n,r,s)}}catch(t){throw yn.create("interop-component-reg-failed",{reason:t})}}}jP();const ZP={apiKey:"AIzaSyCZc5d2NnbnbJQ6-NLCHC-p6GpAgxt9yoA",authDomain:"ipl-demo-1f34f.firebaseapp.com",databaseURL:"https://ipl-demo-1f34f-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"ipl-demo-1f34f",storageBucket:"ipl-demo-1f34f.firebasestorage.app",messagingSenderId:"1039982880775",appId:"1:1039982880775:web:65b69d364442fd1663e2a2",measurementId:"G-KKGNMTP40Z"};let Tl;try{Tl=hd()}catch{Tl=Ag(ZP)}const Yo=RI(Tl);YP(Tl);async function JP(i){var t;console.log(`Fetching scorecard for match ID: ${i}`);const e={method:"GET",headers:{"x-rapidapi-key":"1c37589a58mshc93066d03b8f756p10323bjsne1bd7a81f68f","x-rapidapi-host":"cricbuzz-cricket.p.rapidapi.com"}};try{const r=await(await fetch(`https://cricbuzz-cricket.p.rapidapi.com/mcenter/v1/${i}/scard`,e)).json();if(console.log(`Received scorecard data for match ${i}:`,r),r.isMatchComplete){console.log(`Match ${i} is complete. Status: ${r.status}`);const l=qo(Yo,`IPL Data/Live Scores/${i}`);return await bh(l,{matchId:i,matchStatus:r.status,isComplete:!0,lastUpdated:Date.now()}),{isComplete:!0,status:r.status,matchId:i}}const s=(t=r.scorecard)==null?void 0:t[r.scorecard.length-1];if(console.log("Current innings data:",s),!s)return console.log(`No current innings data available for match ${i}`),null;const o={matchId:i,matchStatus:r.status,currentInnings:{battingTeam:s.batTeamSName||"",score:parseInt(s.score)||0,wickets:parseInt(s.wickets)||0,overs:parseFloat(s.overs)||0,runRate:parseFloat(s.runRate)||0},lastUpdated:Date.now()};console.log("Formatted score info for Firebase:",o);const a=qo(Yo,`IPL Data/Live Scores/${i}`);return await bh(a,o),console.log(`Successfully stored score info in Firebase for match ${i}`),{isComplete:!1,scoreInfo:o}}catch(n){throw console.error(`Error fetching score for match ${i}:`,n),n}}async function QP(i){console.log("Fetching next match after:",i);try{const e=qo(Yo,"IPL Data/Match Schedule"),t=await $v(e);if(!t.exists())return console.log("No match schedule found in Firebase"),null;const n=t.val();console.log("All matches:",n);const r=Array.isArray(n)?n:Object.values(n),s=r.findIndex(l=>l.matchId===i);if(console.log("Current match index:",s),s===-1)return console.log("Current match not found in schedule"),null;const o=r[s+1];if(console.log("Found next match:",o),!o)return console.log("No next match found"),null;const a={matchId:o.matchId,matchNumber:o.matchNumber,teams:{team1:o.teams.team1,team2:o.teams.team2},venue:{ground:o.venue.ground,city:o.venue.city},timing:{startTime:o.timing.startTime}};return console.log("Formatted next match:",a),a}catch(e){return console.error("Error getting next match:",e),null}}console.log("Three.js Version:",wl);const la=new Vx,$l=new An(50,window.innerWidth/window.innerHeight,.1,1e3);$l.position.set(0,0,1);$l.lookAt(0,0,0);const Ii=new gb({antialias:!0,alpha:!0});Ii.setSize(window.innerWidth,window.innerHeight);Ii.setPixelRatio(Math.min(window.devicePixelRatio,2));Ii.xr.enabled=!0;Ii.shadowMap.enabled=!0;Ii.shadowMap.type=Rm;document.body.appendChild(Ii.domElement);const ri=vb.createButton(Ii);ri.style.backgroundColor="#1a73e8";ri.style.padding="16px 24px";ri.style.border="none";ri.style.borderRadius="24px";ri.style.color="white";ri.style.fontSize="16px";ri.style.fontWeight="500";ri.style.transition="all 0.3s ease";ri.style.bottom="24px";document.body.appendChild(ri);const ot=new oo;ot.rotation.y=Math.PI;la.add(ot);const eD=new Gr(.6,.3,.02),tD=new Vh({color:16777215,metalness:.3,roughness:.1,transparent:!0,opacity:.95,side:Un,envMapIntensity:1.5,clearcoat:.5,clearcoatRoughness:.1}),Kl=new Rn(eD,tD);Kl.castShadow=!0;Kl.receiveShadow=!0;ot.add(Kl);const nD=new Gr(.62,.32,.01),bl=new Vh({color:1733608,transparent:!0,opacity:.15,side:Un,emissive:1733608,emissiveIntensity:.5}),g0=new Rn(nD,bl);g0.position.z=-.01;ot.add(g0);ot.position.set(0,0,-.5);const iD=new Py(16777215,.6);la.add(iD);const qd=new u_(16777215,1.2);qd.position.set(2,5,2);qd.castShadow=!0;la.add(qd);const Yd=new u_(1733608,.4);Yd.position.set(0,0,-3);la.add(Yd);function Bn(i,e,t,n,r){const s=new Eb(i,{font:e,size:t,height:.001,curveSegments:12,bevelEnabled:!1,bevelThickness:0,bevelSize:0,bevelSegments:0});s.computeBoundingBox(),s.center();const o=new Vh({color:n,metalness:.2,roughness:.4}),a=new Rn(s,o);a.position.set(0,r,-.011),a.rotation.set(0,Math.PI,0),a.scale.z=1e-4,a.castShadow=!0,ot.add(a)}let ho=!1;const Mm=new Ly,eu=new he;let $o=!1,Ka={x:0,y:0},mi={x:0,y:0},Ko=!0,Tm=0,bm=0;function rD(i){if(Tm=i.clientX/window.innerWidth*2-1,bm=-(i.clientY/window.innerHeight)*2+1,eu.x=Tm,eu.y=bm,$o){const t={x:i.clientX-Ka.x,y:i.clientY-Ka.y};mi.x=t.y*.005,mi.y=t.x*.005}Ka={x:i.clientX,y:i.clientY},Mm.setFromCamera(eu,$l);const e=Mm.intersectObject(Kl);e.length>0&&!ho?(ho=!0,Ko=!1,uo.to(ot.scale,{x:1.05,y:1.05,z:1.05,duration:.4,ease:"power2.out"}),uo.to(bl,{opacity:.25,emissiveIntensity:.8,duration:.4}),document.body.style.cursor="grab"):e.length===0&&ho&&(ho=!1,Ko=!0,uo.to(ot.scale,{x:1,y:1,z:1,duration:.4,ease:"power2.out"}),uo.to(bl,{opacity:.15,emissiveIntensity:.5,duration:.4}),document.body.style.cursor="default")}function sD(i){$o=!0,Ko=!1,document.body.style.cursor="grabbing",Ka={x:i.clientX,y:i.clientY}}function v0(){$o=!1,Ko=!0,document.body.style.cursor=ho?"grab":"default",mi={x:0,y:0}}function oD(){Ii.setAnimationLoop(aD)}function aD(){const i=Date.now()*1e-4%1;Yd.color.setHSL(i,.5,.5);const e=Math.sin(Date.now()*.002)*.1+.9;if(bl.emissiveIntensity=.5*e,Ko){const t=ot.rotation.y+.005;ot.rotation.y+=(t-ot.rotation.y)*.98}$o&&(ot.rotation.x+=mi.x,ot.rotation.y+=mi.y,ot.rotation.x=Math.max(-Math.PI/4,Math.min(Math.PI/4,ot.rotation.x))),$o||(mi.x*=.95,mi.y*=.95,ot.rotation.x+=mi.x,ot.rotation.y+=mi.y),ot.position.y=Math.sin(Date.now()*.001)*.01,Ii.render(la,$l)}async function lD(){try{const i=qo(Yo,"IPL Data/test");await bh(i,{timestamp:Date.now(),message:"Test connection"}),console.log("Database connection successful");const e=qo(Yo,"IPL Data/Match Schedule"),t=await $v(e);if(t.exists()){const n=t.val();console.log("All matches:",n);const r=Array.isArray(n)?n:Object.values(n),s=r.findIndex(o=>o.matchId===114960);if(console.log("Current match index:",s),s!==-1){const o=r[s+1];if(console.log("Next match after 114960:",o),o)console.log("Displaying next match:",o),tu(o);else{console.log("No next match found after 114960");const a=r[s];tu(a)}}else{console.log("Match ID 114960 not found in schedule");const o=r[0];tu(o)}}else console.log("No match schedule found in Firebase")}catch(i){console.error("Initialization error:",i)}}async function cD(i,e){console.log(`Match ${i} completed. Status: ${e}`),window.currentUpdateInterval&&(clearInterval(window.currentUpdateInterval),window.currentUpdateInterval=null);const t=await QP(i);if(console.log("Next match data:",t),t){for(console.log("Switching to next match:",t);ot.children.length>2;)ot.remove(ot.children[2]);ms=t.matchId,new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(r){Bn(t.matchNumber,r,.03,1733608,.1),Bn(`${t.teams.team1} vs ${t.teams.team2}`,r,.04,0,.05),Bn(`${t.venue.ground}, ${t.venue.city}`,r,.02,6710886,-.08);const o=new Date(parseInt(t.timing.startTime)).toLocaleString("en-US",{timeZone:"Asia/Kolkata",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!0});Bn(`${o} IST`,r,.02,6710886,-.12),x0(t.timing.startTime)})}else console.log("No more matches scheduled"),new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(r){for(;ot.children.length>2;)ot.remove(ot.children[2]);Bn("No more matches scheduled",r,.04,0,0)})}function x0(i){let e,t=!1,n=!1;const r=()=>{const s=Date.now(),a=parseInt(i)-s;if(a>0){const l=Math.floor(a/864e5),c=Math.floor(a%(1e3*60*60*24)/(1e3*60*60)),u=Math.floor(a%(1e3*60*60)/(1e3*60)),h=Math.floor(a%(1e3*60)/1e3),d=`Starts in: ${l}d ${c}h ${u}m ${h}s`;wm(d),!n&&a<=6e5&&(console.log("Less than 10 minutes to match, starting API calls"),n=!0,ms&&Cm(ms))}else t||(t=!0,wm("Match Started!"),ms&&Cm(ms))};return e=setInterval(r,1e3),r(),()=>{e&&clearInterval(e)}}function wm(i){new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(t){const n=ot.children.find(s=>s.userData&&s.userData.isCountdown);n&&ot.remove(n);const r=Bn(i,t,.025,1733608,-.13);r&&(r.userData.isCountdown=!0)})}function Cm(i){console.log(`Setting up periodic score updates for match ${i}`),window.currentUpdateInterval&&clearInterval(window.currentUpdateInterval);async function e(){try{console.log(`Fetching score for match ${i}`);const t=await JP(i);return console.log("Score fetch result:",t),t!=null&&t.isComplete?(console.log(`Match ${i} is complete, handling completion...`),cD(t.matchId,t.status),!0):!1}catch(t){return t.message.includes("429")?(console.log("Rate limit reached, waiting before next request..."),await new Promise(n=>setTimeout(n,12e4))):console.error("Error in score fetch:",t),!1}}e().then(t=>{if(t)return;const n=setInterval(async()=>{await e()&&(clearInterval(n),window.currentUpdateInterval=null)},6e4);window.currentUpdateInterval=n})}async function tu(i){new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(t){for(;ot.children.length>2;)ot.remove(ot.children[2]);if(i)try{ms=i.matchId,Bn(i.matchNumber,t,.03,1733608,.12),Bn(`${i.teams.team1} vs ${i.teams.team2}`,t,.04,0,.06),Bn(`${i.venue.ground}, ${i.venue.city}`,t,.02,6710886,0);const r=new Date(parseInt(i.timing.startTime)).toLocaleString("en-US",{timeZone:"Asia/Kolkata",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!0});Bn(`${r} IST`,t,.02,6710886,-.06),x0(i.timing.startTime)}catch(n){console.error("Error updating match display:",n),Bn("Error Loading Data",t,.04,1733608,0)}})}window.addEventListener("pointermove",rD);window.addEventListener("pointerdown",sD);window.addEventListener("pointerup",v0);window.addEventListener("pointerleave",v0);lD();oD();let ms=null;window.addEventListener("beforeunload",()=>{window.currentUpdateInterval&&clearInterval(window.currentUpdateInterval)});
