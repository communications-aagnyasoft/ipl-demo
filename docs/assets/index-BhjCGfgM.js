...
`+bT(i.getShaderSource(e),o)}else return r}function AT(i,e){const t=wT(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function CT(i,e){let t;switch(e){case $0:t="Linear";break;case K0:t="Reinhard";break;case j0:t="Cineon";break;case Z0:t="ACESFilmic";break;case Q0:t="AgX";break;case ex:t="Neutral";break;case J0:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const La=new O;function RT(){et.getLuminanceCoefficients(La);const i=La.x.toFixed(4),e=La.y.toFixed(4),t=La.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function IT(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(lo).join(`
`)}function PT(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function DT(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function lo(i){return i!==""}function Qf(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ep(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const LT=/^[ \t]*#include +<([\w\d./]+)>/gm;function qu(i){return i.replace(LT,OT)}const NT=new Map;function OT(i,e){let t=Ve[e];if(t===void 0){const n=NT.get(e);if(n!==void 0)t=Ve[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return qu(t)}const UT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function tp(i){return i.replace(UT,FT)}function FT(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function np(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function kT(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Cm?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Rm?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===hi&&(e="SHADOWMAP_TYPE_VSM"),e}function BT(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bs:case ws:e="ENVMAP_TYPE_CUBE";break;case Al:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zT(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ws:e="ENVMAP_MODE_REFRACTION";break}return e}function VT(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Im:e="ENVMAP_BLENDING_MULTIPLY";break;case q0:e="ENVMAP_BLENDING_MIX";break;case Y0:e="ENVMAP_BLENDING_ADD";break}return e}function HT(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function GT(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=kT(t),c=BT(t),u=zT(t),h=VT(t),d=HT(t),f=IT(t),_=PT(s),g=r.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eA="FirebaseError";class Wr extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=eA,Object.setPrototypeOf(this,Wr.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ol.prototype.create)}}class Ol{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,s=this.errors[e],o=s?tA(s,n):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Wr(r,a,n)}}function tA(i,e){return i.replace(nA,(t,n)=>{const r=e[n];return r!=null?String(r):`<${n}?>`})}const nA=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tg=function(i){let e={},t={},n={},r="";try{const s=i.split(".");e=Uo(lh(s[0])||""),t=Uo(lh(s[1])||""),r=s[2],n=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:n,signature:r}},iA=function(i){const e=Tg(i),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},rA=function(i){const e=Tg(i).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sA(i){const e=[];for(const[t,n]of Object.entries(i))Array.isArray(n)?n.forEach(r=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(r))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(n));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lA=1e3,cA=2,uA=4*60*60*1e3,hA=.5;function wp(i,e=lA,t=cA){const n=e*Math.pow(t,i),r=Math.round(hA*n*(Math.random()-.5)*2);return Math.min(uA,n+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ht;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(ht||(ht={}));const _A={debug:ht.DEBUG,verbose:ht.VERBOSE,info:ht.INFO,warn:ht.WARN,error:ht.ERROR,silent:ht.SILENT},gA=ht.INFO,vA={[ht.DEBUG]:"log",[ht.VERBOSE]:"log",[ht.INFO]:"info",[ht.WARN]:"warn",[ht.ERROR]:"error"},xA=(i,e,...t)=>{if(e<i.logLevel)return;const n=new Date().toISOString(),r=vA[e];if(r)console[r](`[${n}]  ${i.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ld{constructor(e){this.name=e,this._logLevel=gA,this._logHandler=xA,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ht))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?_A[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ht.DEBUG,...e),this._logHandler(this,ht.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ht.VERBOSE,...e),this._logHandler(this,ht.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ht.INFO,...e),this._logHandler(this,ht.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ht.WARN,...e),this._logHandler(this,ht.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ht.ERROR,...e),this._logHandler(this,ht.ERROR,...e)}}const yA=(i,e)=>e.some(t=>i instanceof t);let Ap,Cp;function SA(){return Ap||(Ap=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function EA(){return Cp||(Cp=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const bg=new WeakMap,ch=new WeakMap,wg=new WeakMap,zc=new WeakMap,cd=new WeakMap;function MA(i){const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("success",s),i.removeEventListener("error",o)},s=()=>{t(Wi(i.result)),r()},o=()=>{n(i.error),r()};i.addEventListener("success",s),i.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&bg.set(t,i)}).catch(()=>{}),cd.set(e,i),e}function TA(i){if(ch.has(i))return;const e=new Promise((t,n)=>{const r=()=>{i.removeEventListener("complete",s),i.removeEventListener("error",o),i.removeEventListener("abort",o)},s=()=>{t(),r()},o=()=>{n(i.error||new DOMException("AbortError","AbortError")),r()};i.addEventListener("complete",s),i.addEventListener("error",o),i.addEventListener("abort",o)});ch.set(i,e)}let uh={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return ch.get(i);if(e==="objectStoreNames")return i.objectStoreNames||wg.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Wi(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function bA(i){uh=i(uh)}function wA(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=i.call(Vc(this),e,...t);return wg.set(n,e.sort?e.sort():[e]),Wi(n)}:EA().includes(i)?function(...e){return i.apply(Vc(this),e),Wi(bg.get(this))}:function(...e){return Wi(i.apply(Vc(this),e))}}function AA(i){return typeof i=="function"?wA(i):(i instanceof IDBTransaction&&TA(i),yA(i,SA())?new Proxy(i,uh):i)}function Wi(i){if(i instanceof IDBRequest)return MA(i);if(zc.has(i))return zc.get(i);const e=AA(i);return e!==i&&(zc.set(i,e),cd.set(e,i)),e}const Vc=i=>cd.get(i);function Ag(i,e,{blocked:t,upgrade:n,blocking:r,terminated:s}={}){const o=indexedDB.open(i,e),a=Wi(o);return n&&o.addEventListener("upgradeneeded",l=>{n(Wi(o.result),l.oldVersion,l.newVersion,Wi(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{s&&l.addEventListener("close",()=>s()),r&&l.addEventListener("versionchange",c=>r(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const CA=["get","getKey","getAll","getAllKeys","count"],RA=["put","add","delete","clear"],Hc=new Map;function Rp(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(Hc.get(e))return Hc.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,r=RA.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(r||CA.includes(t)))return;const s=async function(o,...a){const l=this.transaction(o,r?"readwrite":"readonly");let c=l.store;return n&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),r&&l.done]))[0]};return Hc.set(e,s),s}bA(i=>({...i,get:(e,t,n)=>Rp(e,t)||i.get(e,t,n),has:(e,t)=>!!Rp(e,t)||i.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IA{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(PA(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function PA(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const hh="@firebase/app",Ip="0.11.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bi=new ld("@firebase/app"),DA="@firebase/app-compat",LA="@firebase/analytics-compat",NA="@firebase/analytics",OA="@firebase/app-check-compat",UA="@firebase/app-check",FA="@firebase/auth",kA="@firebase/auth-compat",BA="@firebase/database",zA="@firebase/data-connect",VA="@firebase/database-compat",HA="@firebase/functions",GA="@firebase/functions-compat",WA="@firebase/installations",XA="@firebase/installations-compat",qA="@firebase/messaging",YA="@firebase/messaging-compat",$A="@firebase/performance",KA="@firebase/performance-compat",jA="@firebase/remote-config",ZA="@firebase/remote-config-compat",JA="@firebase/storage",QA="@firebase/storage-compat",eC="@firebase/firestore",tC="@firebase/vertexai",nC="@firebase/firestore-compat",iC="firebase",rC="11.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dh="[DEFAULT]",sC={[hh]:"fire-core",[DA]:"fire-core-compat",[NA]:"fire-analytics",[LA]:"fire-analytics-compat",[UA]:"fire-app-check",[OA]:"fire-app-check-compat",[FA]:"fire-auth",[kA]:"fire-auth-compat",[BA]:"fire-rtdb",[zA]:"fire-data-connect",[VA]:"fire-rtdb-compat",[HA]:"fire-fn",[GA]:"fire-fn-compat",[WA]:"fire-iid",[XA]:"fire-iid-compat",[qA]:"fire-fcm",[YA]:"fire-fcm-compat",[$A]:"fire-perf",[KA]:"fire-perf-compat",[jA]:"fire-rc",[ZA]:"fire-rc-compat",[JA]:"fire-gcs",[QA]:"fire-gcs-compat",[eC]:"fire-fst",[nC]:"fire-fst-compat",[tC]:"fire-vertex","fire-js":"fire-js",[iC]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl=new Map,oC=new Map,fh=new Map;function Pp(i,e){try{i.container.addComponent(e)}catch(t){bi.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,t)}}function Ji(i){const e=i.name;if(fh.has(e))return bi.debug(`There were multiple attempts to register component ${e}.`),!1;fh.set(e,i);for(const t of cl.values())Pp(t,i);for(const t of oC.values())Pp(t,i);return!0}function ea(i,e){const t=i.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),i.container.getProvider(e)}function aC(i){return i==null?!1:i.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uC=rC;function Cg(i,e={}){let t=i;typeof e!="object"&&(e={name:e});const n=Object.assign({name:dh,automaticDataCollectionEnabled:!1},e),r=n.name;if(typeof r!="string"||!r)throw Xi.create("bad-app-name",{appName:String(r)});if(t||(t=yg()),!t)throw Xi.create("no-options");const s=cl.get(r);if(s){if(Fo(t,s.options)&&Fo(n,s.config))return s;throw Xi.create("duplicate-app",{appName:r})}const o=new mA(r);for(const l of fh.values())o.addComponent(l);const a=new cC(t,n,o);return cl.set(r,a),a}function ud(i=dh){const e=cl.get(i);if(!e&&i===dh&&yg())return Cg();if(!e)throw Xi.create("no-app",{appName:i});return e}function Qn(i,e,t){var n;let r=(n=sC[i])!==null&&n!==void 0?n:i;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),bi.warn(a.join(" "));return}Ji(new Ti(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hC="firebase-heartbeat-database",dC=1,ko="firebase-heartbeat-store";let Gc=null;function Rg(){return Gc||(Gc=Ag(hC,dC,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(ko)}catch(t){console.warn(t)}}}}).catch(i=>{throw Xi.create("idb-open",{originalErrorMessage:i.message})})),Gc}async function fC(i){try{const t=(await Rg()).transaction(ko),n=await t.objectStore(ko).get(Ig(i));return await t.done,n}catch(e){if(e instanceof Wr)bi.warn(e.message);else{const t=Xi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});bi.warn(t.message)}}}async function Dp(i,e){try{const n=(await Rg()).transaction(ko,"readwrite");await n.objectStore(ko).put(e,Ig(i)),await n.done}catch(t){if(t instanceof Wr)bi.warn(t.message);else{const n=Xi.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});bi.warn(n.message)}}}function Ig(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pC=1024,mC=30;class _C{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new vC(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var e,t;try{const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Lp();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:r}),this._heartbeatsCache.heartbeats.length>mC){const o=xC(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){bi.warn(n)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Lp(),{heartbeatsToSend:n,unsentEntries:r}=gC(this._heartbeatsCache.heartbeats),s=al(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return bi.warn(t),""}}}function Lp(){return new Date().toISOString().substring(0,10)}function gC(i,e=pC){const t=[];let n=i.slice();for(const r of i){const s=t.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),Np(t)>e){s.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),Np(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class vC{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Eg()?Mg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await fC(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Dp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Dp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Np(i){return al(JSON.stringify({version:2,heartbeats:i})).length}function xC(i){if(i.length===0)return-1;let e=0,t=i[0].date;for(let n=1;n<i.length;n++)i[n].date<t&&(t=i[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yC(i){Ji(new Ti("platform-logger",e=>new IA(e),"PRIVATE")),Ji(new Ti("heartbeat",e=>new _C(e),"PRIVATE")),Qn(hh,Ip,i),Qn(hh,Ip,"esm2017"),Qn("fire-js","")}yC("");var SC="firebase",EC="11.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qn(SC,EC,"app");var Op={};const Up="@firebase/database",Fp="1.0.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bC{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Ai(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dg=function(i){try{if(typeof window<"u"&&typeof window[i]<"u"){const e=window[i];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new TC(e)}}catch{}return new bC},wr=Dg("localStorage"),wC=Dg("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=new ld("@firebase/database"),AC=function(){let i=1;return function(){return i++}}(),Lg=function(i){const e=aA(i),t=new oA;t.update(e);const n=t.digest();return od.encodeByteArray(n)},ta=function(...i){let e="";for(let t=0;t<i.length;t++){const n=i[t];Array.isArray(n)||n&&typeof n=="object"&&typeof n.length=="number"?e+=ta.apply(null,n):typeof n=="object"?e+=It(n):e+=n,e+=" "}return e};let xo=null,kp=!0;const CC=function(i,e){re(!0,"Can't turn on custom loggers persistently."),Es.logLevel=ht.VERBOSE,xo=Es.log.bind(Es)},Wt=function(...i){if(kp===!0&&(kp=!1,xo===null&&wC.get("logging_enabled")===!0&&CC()),xo){const e=ta.apply(null,i);xo(e)}},na=function(i){return function(...e){Wt(i,...e)}},ph=function(...i){const e="FIREBASE INTERNAL ERROR: "+ta(...i);Es.error(e)},wi=function(...i){const e=`FIREBASE FATAL ERROR: ${ta(...i)}`;throw Es.error(e),new Error(e)},un=function(...i){const e="FIREBASE WARNING: "+ta(...i);Es.warn(e)},RC=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&un("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Ng=function(i){return typeof i=="number"&&(i!==i||i===Number.POSITIVE_INFINITY||i===Number.NEGATIVE_INFINITY)},IC=function(i){if(document.readyState==="complete")i();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,i())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},ks="[MIN_NAME]",Fr="[MAX_NAME]",Ys=function(i,e){if(i===e)return 0;if(i===ks||e===Fr)return-1;if(e===ks||i===Fr)return 1;{const t=Bp(i),n=Bp(e);return t!==null?n!==null?t-n===0?i.length-e.length:t-n:-1:n!==null?1:i<e?-1:1}},PC=function(i,e){return i===e?0:i<e?-1:1},io=function(i,e){if(e&&i in e)return e[i];throw new Error("Missing required key ("+i+") in object: "+It(e))},hd=function(i){if(typeof i!="object"||i===null)return It(i);const e=[];for(const n in i)e.push(n);e.sort();let t="{";for(let n=0;n<e.length;n++)n!==0&&(t+=","),t+=It(e[n]),t+=":",t+=hd(i[e[n]]);return t+="}",t},Og=function(i,e){const t=i.length;if(t<=e)return[i];const n=[];for(let r=0;r<t;r+=e)r+e>t?n.push(i.substring(r,t)):n.push(i.substring(r,r+e));return n};function fn(i,e){for(const t in i)i.hasOwnProperty(t)&&e(t,i[t])}const Ug=function(i){re(!Ng(i),"Invalid JSON number");const e=11,t=52,n=(1<<e-1)-1;let r,s,o,a,l;i===0?(s=0,o=0,r=1/i===-1/0?1:0):(r=i<0,i=Math.abs(i),i>=Math.pow(2,1-n)?(a=Math.min(Math.floor(Math.log(i)/Math.LN2),n),s=a+n,o=Math.round(i*Math.pow(2,t-a)-Math.pow(2,t))):(s=0,o=Math.round(i/Math.pow(2,1-n-t))));const c=[];for(l=t;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(s%2?1:0),s=Math.floor(s/2);c.push(r?1:0),c.reverse();const u=c.join("");let h="";for(l=0;l<64;l+=8){let d=parseInt(u.substr(l,8),2).toString(16);d.length===1&&(d="0"+d),h=h+d}return h.toLowerCase()},DC=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},LC=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function NC(i,e){let t="Unknown Error";i==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":i==="permission_denied"?t="Client doesn't have permission to access the desired data.":i==="unavailable"&&(t="The service is unavailable");const n=new Error(i+" at "+e._path.toString()+": "+t);return n.code=i.toUpperCase(),n}const OC=new RegExp("^-?(0*)\\d{1,10}$"),UC=-2147483648,FC=2147483647,Bp=function(i){if(OC.test(i)){const e=Number(i);if(e>=UC&&e<=FC)return e}return null},$s=function(i){try{i()}catch(e){setTimeout(()=>{const t=e.stack||"";throw un("Exception was thrown by user callback.",t),e},Math.floor(0))}},kC=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},yo=function(i,e){const t=setTimeout(i,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BC{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,aC(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(n=>this.appCheck=n)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,n)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,n):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(n=>n.addTokenListener(e))}notifyForInvalidToken(){un(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HC{constructor(){this.counters_={}}incrementCounter(e,t=1){Ai(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return zw(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wc={},Xc={};function fd(i){const e=i.toString();return Wc[e]||(Wc[e]=new HC),Wc[e]}function GC(i,e){const t=i.toString();return Xc[t]||(Xc[t]=e()),Xc[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WC{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const n=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let r=0;r<n.length;++r)n[r]&&$s(()=>{this.onMessage_(n[r])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zp="start",XC="close",qC="pLPCommand",YC="pRTLPCB",$g="id",Kg="pw",jg="ser",$C="cb",KC="seg",jC="ts",ZC="d",JC="dframe",Zg=1870,Jg=30,QC=Zg-Jg,eR=25e3,tR=3e4;class fs{constructor(e,t,n,r,s,o,a){this.connId=e,this.repoInfo=t,this.applicationId=n,this.appCheckToken=r,this.authToken=s,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=na(e),this.stats_=fd(t),this.urlFn=l=>(this.appCheckToken&&(l[mh]=this.appCheckToken),Yg(t,Xg,l))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new WC(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(tR)),IC(()=>{if(this.isClosed_)return;this.scriptTagHolder=new pd((...s)=>{const[o,a,l,c,u]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===zp)this.id=a,this.password=l;else if(o===XC)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...s)=>{const[o,a]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const n={};n[zp]="t",n[jg]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(n[$C]=this.scriptTagHolder.uniqueCallbackIdentifier),n[Fg]=dd,this.transportSessionId&&(n[kg]=this.transportSessionId),this.lastSessionId&&(n[Hg]=this.lastSessionId),this.applicationId&&(n[Gg]=this.applicationId),this.appCheckToken&&(n[mh]=this.appCheckToken),typeof location<"u"&&location.hostname&&Vg.test(location.hostname)&&(n[Bg]=zg);const r=this.urlFn(n);this.log_("Connecting via long-poll to "+r),this.scriptTagHolder.addTag(r,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){fs.forceAllow_=!0}static forceDisallow(){fs.forceDisallow_=!0}static isAvailable(){return fs.forceAllow_?!0:!fs.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!DC()&&!LC()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=It(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=gg(t),r=Og(n,QC);for(let s=0;s<r.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const n={};n[JC]="t",n[$g]=e,n[Kg]=t,this.myDisconnFrame.src=this.urlFn(n),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=It(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class pd{constructor(e,t,n,r){this.onDisconnect=n,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=AC(),window[qC+this.uniqueCallbackIdentifier]=e,window[YC+this.uniqueCallbackIdentifier]=t,this.myIFrame=pd.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){Wt("frame writing exception"),a.stack&&Wt(a.stack),Wt(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Wt("No IE domain setting required")}catch{const n=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+n+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[$g]=this.myID,e[Kg]=this.myPW,e[jg]=this.currentSerial;let t=this.urlFn(e),n="",r=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Jg+n.length<=Zg;){const o=this.pendingSegs.shift();n=n+"&"+KC+r+"="+o.seg+"&"+jC+r+"="+o.ts+"&"+ZC+r+"="+o.d,r++}return t=t+n,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,n){this.pendingSegs.push({seg:e,ts:t,d:n}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const n=()=>{this.outstandingRequests.delete(t),this.newRequest_()},r=setTimeout(n,Math.floor(eR)),s=()=>{clearTimeout(r),n()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const n=this.myIFrame.doc.createElement("script");n.type="text/javascript",n.async=!0,n.src=e,n.onload=n.onreadystatechange=function(){const r=n.readyState;(!r||r==="loaded"||r==="complete")&&(n.onload=n.onreadystatechange=null,n.parentNode&&n.parentNode.removeChild(n),t())},n.onerror=()=>{Wt("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(n)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nR=16384,iR=45e3;let ul=null;typeof MozWebSocket<"u"?ul=MozWebSocket:typeof WebSocket<"u"&&(ul=WebSocket);class Bn{constructor(e,t,n,r,s,o,a){this.connId=e,this.applicationId=n,this.appCheckToken=r,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=na(this.connId),this.stats_=fd(t),this.connURL=Bn.connectionURL_(t,o,a,r,n),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,n,r,s){const o={};return o[Fg]=dd,typeof location<"u"&&location.hostname&&Vg.test(location.hostname)&&(o[Bg]=zg),t&&(o[kg]=t),n&&(o[Hg]=n),r&&(o[mh]=r),s&&(o[Gg]=s),Yg(e,Wg,o)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,wr.set("previous_websocket_failure",!0);try{let n;Jw(),this.mySock=new ul(this.connURL,[],n)}catch(n){this.log_("Error instantiating WebSocket.");const r=n.message||n.data;r&&this.log_(r),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=n=>{this.handleIncomingFrame(n)},this.mySock.onerror=n=>{this.log_("WebSocket error.  Closing connection.");const r=n.message||n.data;r&&this.log_(r),this.onClosed_()}}start(){}static forceDisallow(){Bn.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,n=navigator.userAgent.match(t);n&&n.length>1&&parseFloat(n[1])<4.4&&(e=!0)}return!e&&ul!==null&&!Bn.forceDisallow_}static previouslyFailed(){return wr.isInMemoryStorage||wr.get("previous_websocket_failure")===!0}markConnectionHealthy(){wr.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const n=Uo(t);this.onMessage(n)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(re(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const n=this.extractFrameCount_(t);n!==null&&this.appendFrame_(n)}}send(e){this.resetKeepAlive();const t=It(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=Og(t,nR);n.length>1&&this.sendString_(String(n.length));for(let r=0;r<n.length;r++)this.sendString_(n[r])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(iR))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}Bn.responsesRequiredToBeHealthy=2;Bn.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SR(i,e){return Ys(i.name,e.name)}function _d(i,e){return Ys(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _h;function ER(i){_h=i}const av=function(i){return typeof i=="number"?"number:"+Ug(i):"string:"+i},lv=function(i){if(i.isLeafNode()){const e=i.val();re(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ai(e,".sv"),"Priority must be a string or number.")}else re(i===_h||i.isEmpty(),"priority of unexpected type.");re(i===_h||i.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yc;const ls={};class gi{static get Default(){return re(ls&&Tt,"ChildrenNode.ts has not been loaded"),Yc=Yc||new gi({".priority":ls},{".priority":Tt}),Yc}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=Fs(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof nn?t:null}hasIndex(e){return Ai(this.indexSet_,e.toString())}addIndex(e,t){re(e!==Ms,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const s=t.getIterator(Ge.Wrap);let o=s.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=s.getNext();let a;r?a=dl(n,e.getCompare()):a=ls;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new gi(u,c)}addToIndexes(e,t){const n=ll(this.indexes_,(r,s)=>{const o=Fs(this.indexSet_,s);if(re(o,"Missing index implementation for "+s),r===ls)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(Ge.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),dl(a,o.getCompare())}else return ls;else{const a=t.get(e.name);let l=r;return a&&(l=l.remove(new Ge(e.name,a))),l.insert(e,e.node)}});return new gi(n,this.indexSet_)}removeFromIndexes(e,t){const n=ll(this.indexes_,r=>{if(r===ls)return r;{const s=t.get(e.name);return s?r.remove(new Ge(e.name,s)):r}});return new gi(n,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PR extends Fl{compare(e,t){const n=e.node.compareTo(t.node);return n===0?Ys(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Ge.MIN}maxPost(){return Ge.MAX}makePost(e,t){const n=Ft(e);return new Ge(t,n)}toString(){return".value"}}const DR=new PR;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hv(i){return{type:"value",snapshotNode:i}}function Bs(i,e){return{type:"child_added",snapshotNode:e,childName:i}}function zo(i,e){return{type:"child_removed",snapshotNode:e,childName:i}}function Vo(i,e,t){return{type:"child_changed",snapshotNode:e,childName:i,oldSnap:t}}function LR(i,e){return{type:"child_moved",snapshotNode:e,childName:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pl(){return{value:null,children:new Map}}function dv(i,e,t){if(We(e))i.value=t,i.children.clear();else if(i.value!==null)i.value=i.value.updateChild(e,t);else{const n=qe(e);i.children.has(n)||i.children.set(n,pl());const r=i.children.get(n);e=dt(e),dv(r,e,t)}}function gh(i,e,t){i.value!==null?t(e,i.value):FR(i,(n,r)=>{const s=new ct(e.toString()+"/"+n);gh(r,s,t)})}function FR(i,e){i.children.forEach((t,n)=>{e(n,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const em=10*1e3,BR=30*1e3,zR=5*60*1e3;class VR{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new kR(e);const n=em+(BR-em)*Math.random();yo(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;fn(e,(r,s)=>{s>0&&Ai(this.statsToReport_,r)&&(t[r]=s,n=!0)}),n&&this.server_.reportStats(t),yo(this.reportStats_.bind(this),Math.floor(Math.random()*2*zR))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Hn;(function(i){i[i.OVERWRITE=0]="OVERWRITE",i[i.MERGE=1]="MERGE",i[i.ACK_USER_WRITE=2]="ACK_USER_WRITE",i[i.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Hn||(Hn={}));function fv(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function xd(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function yd(i){return{fromUser:!1,fromServer:!0,queryId:i,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t){this.source=e,this.path=t,this.type=Hn.LISTEN_COMPLETE}operationForChild(e){return We(this.path)?new Go(this.source,tt()):new Go(this.source,dt(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Hn.OVERWRITE}operationForChild(e){return We(this.path)?new kr(this.source,tt(),this.snap.getImmediateChild(e)):new kr(this.source,dt(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HR{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function GR(i,e,t,n){const r=[],s=[];return e.forEach(o=>{o.type==="child_changed"&&i.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&s.push(LR(o.childName,o.snapshotNode))}),oo(i,r,"child_removed",e,n,t),oo(i,r,"child_added",e,n,t),oo(i,r,"child_moved",s,n,t),oo(i,r,"child_changed",e,n,t),oo(i,r,"value",e,n,t),r}function oo(i,e,t,n,r,s){const o=n.filter(a=>a.type===t);o.sort((a,l)=>XR(i,a,l)),o.forEach(a=>{const l=WR(i,a,s);r.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,i.query_))})})}function WR(i,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,i.index_)),e}function XR(i,e,t){if(e.childName==null||t.childName==null)throw qs("Should only compare child_ events.");const n=new Ge(e.childName,e.snapshotNode),r=new Ge(t.childName,t.snapshotNode);return i.index_.compare(n,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bl(i,e){return xv(e,i)}function YR(i,e,t,n,r){re(n>i.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),i.allWrites.push({path:e,snap:t,writeId:n,visible:r}),r&&(i.visibleWrites=Eo(i.visibleWrites,e,t)),i.lastWriteId=n}function $R(i,e){for(let t=0;t<i.allWrites.length;t++){const n=i.allWrites[t];if(n.writeId===e)return n}return null}function KR(i,e){const t=i.allWrites.findIndex(a=>a.writeId===e);re(t>=0,"removeWrite called with nonexistent writeId.");const n=i.allWrites[t];i.allWrites.splice(t,1);let r=n.visible,s=!1,o=i.allWrites.length-1;for(;r&&o>=0;){const a=i.allWrites[o];a.visible&&(o>=t&&jR(a,n.path)?r=!1:Vn(n.path,a.path)&&(s=!0)),o--}if(r){if(s)return ZR(i),!0;if(n.snap)i.visibleWrites=nm(i.visibleWrites,n.path);else{const a=n.children;fn(a,l=>{i.visibleWrites=nm(i.visibleWrites,Pt(n.path,l))})}return!0}else return!1}function jR(i,e){if(i.snap)return Vn(i.path,e);for(const t in i.children)if(i.children.hasOwnProperty(t)&&Vn(Pt(i.path,t),e))return!0;return!1}function ZR(i){i.visibleWrites=_v(i.allWrites,JR,tt()),i.allWrites.length>0?i.lastWriteId=i.allWrites[i.allWrites.length-1].writeId:i.lastWriteId=-1}function JR(i){return i.visible}function _v(i,e,t){let n=Wn.empty();for(let r=0;r<i.length;++r){const s=i[r];if(e(s)){const o=s.path;let a;if(s.snap)Vn(t,o)?(a=Jt(t,o),n=Eo(n,a,s.snap)):Vn(o,t)&&(a=Jt(o,t),n=Eo(n,tt(),s.snap.getChild(a)));else if(s.children){if(Vn(t,o))a=Jt(t,o),n=tm(n,a,s.children);else if(Vn(o,t))if(a=Jt(o,t),We(a))n=tm(n,tt(),s.children);else{const l=Fs(s.children,qe(a));if(l){const c=l.getChild(dt(a));n=Eo(n,tt(),c)}}}else throw qs("WriteRecord should have .snap or .children")}}return n}function gv(i,e,t,n,r){if(!n&&!r){const s=Xr(i.visibleWrites,e);if(s!=null)return s;{const o=qi(i.visibleWrites,e);if(xh(o))return t;if(t==null&&!vh(o,tt()))return null;{const a=t||De.EMPTY_NODE;return zs(o,a)}}}else{const s=qi(i.visibleWrites,e);if(!r&&xh(s))return t;if(!r&&t==null&&!vh(s,tt()))return null;{const o=function(c){return(c.visible||r)&&(!n||!~n.indexOf(c.writeId))&&(Vn(c.path,e)||Vn(e,c.path))},a=_v(i.allWrites,o,e),l=t||De.EMPTY_NODE;return zs(a,l)}}}function QR(i,e,t){let n=De.EMPTY_NODE;const r=Xr(i.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Tt,(s,o)=>{n=n.updateImmediateChild(s,o)}),n;if(t){const s=qi(i.visibleWrites,e);return t.forEachChild(Tt,(o,a)=>{const l=zs(qi(s,new ct(o)),a);n=n.updateImmediateChild(o,l)}),im(s).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}else{const s=qi(i.visibleWrites,e);return im(s).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}}function e1(i,e,t,n,r){re(n||r,"Either existingEventSnap or existingServerSnap must exist");const s=Pt(e,t);if(vh(i.visibleWrites,s))return null;{const o=qi(i.visibleWrites,s);return xh(o)?r.getChild(t):zs(o,r.getChild(t))}}function t1(i,e,t,n){const r=Pt(e,t),s=Xr(i.visibleWrites,r);if(s!=null)return s;if(n.isCompleteForChild(t)){const o=qi(i.visibleWrites,r);return zs(o,n.getNode().getImmediateChild(t))}else return null}function n1(i,e){return Xr(i.visibleWrites,e)}function i1(i,e,t,n,r,s,o){let a;const l=qi(i.visibleWrites,e),c=Xr(l,tt());if(c!=null)a=c;else if(t!=null)a=zs(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=s?a.getReverseIteratorFrom(n,o):a.getIteratorFrom(n,o);let f=d.getNext();for(;f&&u.length<r;)h(f,n)!==0&&u.push(f),f=d.getNext();return u}else return[]}function r1(){return{visibleWrites:Wn.empty(),allWrites:[],lastWriteId:-1}}function gl(i,e,t,n){return gv(i.writeTree,i.treePath,e,t,n)}function Sd(i,e){return QR(i.writeTree,i.treePath,e)}function rm(i,e,t,n){return e1(i.writeTree,i.treePath,e,t,n)}function vl(i,e){return n1(i.writeTree,Pt(i.treePath,e))}function s1(i,e,t,n,r,s){return i1(i.writeTree,i.treePath,e,t,n,r,s)}function Ed(i,e,t){return t1(i.writeTree,i.treePath,e,t)}function vv(i,e){return xv(Pt(i.treePath,e),i.writeTree)}function xv(i,e){return{treePath:i,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a1{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}}const yv=new a1;class Md{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const n=this.optCompleteServerCache_!=null?new er(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ed(this.writes_,e,n)}}getChildAfterChild(e,t,n){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Br(this.viewCache_),s=s1(this.writes_,r,t,1,n,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yl;class Mv{constructor(){this.views=new Map}}function E1(i){re(!yl,"__referenceConstructor has already been defined"),yl=i}function M1(){return re(yl,"Reference.ts has not been loaded"),yl}function T1(i){return i.views.size===0}function Td(i,e,t,n){const r=e.source.queryId;if(r!==null){const s=i.views.get(r);return re(s!=null,"SyncTree gave us an op for an invalid query."),cm(s,e,t,n)}else{let s=[];for(const o of i.views.values())s=s.concat(cm(o,e,t,n));return s}}function Tv(i,e,t,n,r){const s=e._queryIdentifier,o=i.views.get(s);if(!o){let a=gl(t,r?n:null),l=!1;a?l=!0:n instanceof De?(a=Sd(t,n),l=!1):(a=De.EMPTY_NODE,l=!1);const c=kl(new er(a,l,!1),new er(n,r,!1));return new _1(e,c)}return o}function b1(i,e,t,n,r,s){const o=Tv(i,e,n,r,s);return i.views.has(e._queryIdentifier)||i.views.set(e._queryIdentifier,o),y1(o,t),S1(o,t)}function w1(i,e,t,n){const r=e._queryIdentifier,s=[];let o=[];const a=tr(i);if(r==="default")for(const[l,c]of i.views.entries())o=o.concat(lm(c,t,n)),am(c)&&(i.views.delete(l),c.query._queryParams.loadsAllData()||s.push(c.query));else{const l=i.views.get(r);l&&(o=o.concat(lm(l,t,n)),am(l)&&(i.views.delete(r),l.query._queryParams.loadsAllData()||s.push(l.query)))}return a&&!tr(i)&&s.push(new(M1())(e._repo,e._path)),{removed:s,events:o}}function bv(i){const e=[];for(const t of i.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Yi(i,e){let t=null;for(const n of i.views.values())t=t||x1(n,e);return t}function wv(i,e){if(e._queryParams.loadsAllData())return zl(i);{const n=e._queryIdentifier;return i.views.get(n)}}function Av(i,e){return wv(i,e)!=null}function tr(i){return zl(i)!=null}function zl(i){for(const e of i.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Sl;function A1(i){re(!Sl,"__referenceConstructor has already been defined"),Sl=i}function C1(){return re(Sl,"Reference.ts has not been loaded"),Sl}let R1=1;class um{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ft(null),this.pendingWriteTree_=r1(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Cv(i,e,t,n,r){return YR(i.pendingWriteTree_,e,t,n,r),r?sa(i,new kr(fv(),e,t)):[]}function Ar(i,e,t=!1){const n=$R(i.pendingWriteTree_,e);if(KR(i.pendingWriteTree_,e)){let s=new ft(null);return n.snap!=null?s=s.set(tt(),!0):fn(n.children,o=>{s=s.set(new ct(o),!0)}),sa(i,new ml(n.path,s,t))}else return[]}function ra(i,e,t){return sa(i,new kr(xd(),e,t))}function I1(i,e,t){const n=ft.fromObject(t);return sa(i,new Wo(xd(),e,n))}function P1(i,e){return sa(i,new Go(xd(),e))}function D1(i,e,t){const n=wd(i,t);if(n){const r=Ad(n),s=r.path,o=r.queryId,a=Jt(s,e),l=new Go(yd(o),a);return Cd(i,s,l)}else return[]}function Rv(i,e,t,n,r=!1){const s=e._path,o=i.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Av(o,e))){const l=w1(o,e,t,n);T1(o)&&(i.syncPointTree_=i.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=i.syncPointTree_.findOnPath(s,(d,f)=>tr(f));if(u&&!h){const d=i.syncPointTree_.subtree(s);if(!d.isEmpty()){const f=U1(d);for(let _=0;_<f.length;++_){const g=f[_],m=g.query,p=Lv(i,g);i.listenProvider_.startListening(Mo(m),Xo(i,m),p.hashFn,p.onComplete)}}}!h&&c.length>0&&!n&&(u?i.listenProvider_.stopListening(Mo(e),null):c.forEach(d=>{const f=i.queryToTagMap.get(Vl(d));i.listenProvider_.stopListening(Mo(d),f)}))}F1(i,c)}return a}function Iv(i,e,t,n){const r=wd(i,n);if(r!=null){const s=Ad(r),o=s.path,a=s.queryId,l=Jt(o,e),c=new kr(yd(a),l,t);return Cd(i,o,c)}else return[]}function L1(i,e,t,n){const r=wd(i,n);if(r){const s=Ad(r),o=s.path,a=s.queryId,l=Jt(o,e),c=ft.fromObject(t),u=new Wo(yd(a),l,c);return Cd(i,o,u)}else return[]}function N1(i,e,t,n=!1){const r=e._path;let s=null,o=!1;i.syncPointTree_.foreachOnPath(r,(d,f)=>{const _=Jt(d,r);s=s||Yi(f,_),o=o||tr(f)});let a=i.syncPointTree_.get(r);a?(o=o||tr(a),s=s||Yi(a,tt())):(a=new Mv,i.syncPointTree_=i.syncPointTree_.set(r,a));let l;s!=null?l=!0:(l=!1,s=De.EMPTY_NODE,i.syncPointTree_.subtree(r).foreachChild((f,_)=>{const g=Yi(_,tt());g&&(s=s.updateImmediateChild(f,g))}));const c=Av(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Vl(e);re(!i.queryToTagMap.has(d),"View does not exist, but we have a tag");const f=k1();i.queryToTagMap.set(d,f),i.tagToQueryMap.set(f,d)}const u=Bl(i.pendingWriteTree_,r);let h=b1(a,e,t,u,s,l);if(!c&&!o&&!n){const d=wv(a,e);h=h.concat(B1(i,e,d))}return h}function bd(i,e,t){const r=i.pendingWriteTree_,s=i.syncPointTree_.findOnPath(e,(o,a)=>{const l=Jt(o,e),c=Yi(a,l);if(c)return c});return gv(r,e,s,t,!0)}function O1(i,e){const t=e._path;let n=null;i.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=Jt(c,t);n=n||Yi(u,h)});let r=i.syncPointTree_.get(t);r?n=n||Yi(r,tt()):(r=new Mv,i.syncPointTree_=i.syncPointTree_.set(t,r));const s=n!=null,o=s?new er(n,!0,!1):null,a=Bl(i.pendingWriteTree_,e._path),l=Tv(r,e,a,s?o.getNode():De.EMPTY_NODE,s);return v1(l)}function sa(i,e){return Pv(e,i.syncPointTree_,null,Bl(i.pendingWriteTree_,tt()))}function Pv(i,e,t,n){if(We(i.path))return Dv(i,e,t,n);{const r=e.get(tt());t==null&&r!=null&&(t=Yi(r,tt()));let s=[];const o=qe(i.path),a=i.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,u=vv(n,o);s=s.concat(Pv(a,l,c,u))}return r&&(s=s.concat(Td(r,i,n,t))),s}}function Dv(i,e,t,n){const r=e.get(tt());t==null&&r!=null&&(t=Yi(r,tt()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=vv(n,o),u=i.operationForChild(o);u&&(s=s.concat(Dv(u,a,l,c)))}),r&&(s=s.concat(Td(r,i,n,t))),s}function Lv(i,e){const t=e.query,n=Xo(i,t);return{hashFn:()=>(g1(e)||De.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return n?D1(i,t._path,n):P1(i,t._path);{const s=NC(r,t);return Rv(i,t,null,s)}}}}function Xo(i,e){const t=Vl(e);return i.queryToTagMap.get(t)}function Vl(i){return i._path.toString()+"$"+i._queryIdentifier}function wd(i,e){return i.tagToQueryMap.get(e)}function Ad(i){const e=i.indexOf("$");return re(e!==-1&&e<i.length-1,"Bad queryKey."),{queryId:i.substr(e+1),path:new ct(i.substr(0,e))}}function Cd(i,e,t){const n=i.syncPointTree_.get(e);re(n,"Missing sync point for query tag that we're tracking");const r=Bl(i.pendingWriteTree_,e);return Td(n,t,r,null)}function U1(i){return i.fold((e,t,n)=>{if(t&&tr(t))return[zl(t)];{let r=[];return t&&(r=bv(t)),fn(n,(s,o)=>{r=r.concat(o)}),r}})}function Mo(i){return i._queryParams.loadsAllData()&&!i._queryParams.isDefault()?new(C1())(i._repo,i._path):i}function F1(i,e){for(let t=0;t<e.length;++t){const n=e[t];if(!n._queryParams.loadsAllData()){const r=Vl(n),s=i.queryToTagMap.get(r);i.queryToTagMap.delete(r),i.tagToQueryMap.delete(s)}}}function k1(){return R1++}function B1(i,e,t){const n=e._path,r=Xo(i,e),s=Lv(i,t),o=i.listenProvider_.startListening(Mo(e),r,s.hashFn,s.onComplete),a=i.syncPointTree_.subtree(n);if(r)re(!tr(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!We(c)&&u&&tr(u))return[zl(u).query];{let d=[];return u&&(d=d.concat(bv(u).map(f=>f.query))),fn(h,(f,_)=>{d=d.concat(_)}),d}});for(let c=0;c<l.length;++c){const u=l[c];i.listenProvider_.stopListening(Mo(u),Xo(i,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kd{constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}get key(){return We(this._path)?null:tv(this._path)}get ref(){return new Ci(this._repo,this._path)}get _queryIdentifier(){const e=Qp(this._queryParams),t=hd(e);return t==="{}"?"default":t}get _queryObject(){return Qp(this._queryParams)}isEqual(e){if(e=rr(e),!(e instanceof kd))return!1;const t=this._repo===e._repo,n=rv(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+dR(this._path)}}class Ci extends kd{constructor(e,t){super(e,t,new vd,!1)}get parent(){const e=iv(this._path);return e===null?null:new Ci(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class qo{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ct(e),n=Mh(this.ref,e);return new qo(this._node.getChild(t),n,Tt)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(n,r)=>e(new qo(r,Mh(this.ref,n),Tt)))}hasChild(e){const t=new ct(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Vs(i,e){return i=rr(i),i._checkNotDeleted("ref"),e!==void 0?Mh(i._root,e):i._root}function Mh(i,e){return i=rr(i),qe(i._path)===null?Z1("child","path",e):zv("child","path",e),new Ci(i._repo,Pt(i._path,e))}function Th(i,e){i=rr(i),J1("set",i._path),j1("set",e,i._path);const t=new Nl;return uI(i._repo,i._path,e,null,t.wrapCallback(()=>{})),t.promise}function Bd(i){i=rr(i);const e=new SI(()=>{}),t=new zd(e);return cI(i._repo,i,t).then(n=>new qo(n,new Ci(i._repo,i._path),i._queryParams.getIndex()))}class zd{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const n=t._queryParams.getIndex();return new xI("value",this,new qo(e.snapshotNode,new Ci(t._repo,t._path),n))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new yI(this,e,t):null}matches(e){return e instanceof zd?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}E1(Ci);A1(Ci);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EI="FIREBASE_DATABASE_EMULATOR_HOST",bh={};let MI=!1;function TI(i,e,t,n){i.repoInfo_=new qg(e,!1,i.repoInfo_.namespace,i.repoInfo_.webSocketOnly,i.repoInfo_.nodeAdmin,i.repoInfo_.persistenceKey,i.repoInfo_.includeNamespaceInQueryParams,!0,t),n&&(i.authTokenProvider_=n)}function bI(i,e,t,n,r){let s=n||i.options.databaseURL;s===void 0&&(i.options.projectId||wi("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Wt("Using default host for project ",i.options.projectId),s=`${i.options.projectId}-default-rtdb.firebaseio.com`);let o=pm(s,r),a=o.repoInfo,l;typeof process<"u"&&Op&&(l=Op[EI]),l?(s=`http://${l}?ns=${a.namespace}`,o=pm(s,r),a=o.repoInfo):o.repoInfo.secure;const c=new zC(i.name,i.options,e);Q1("Invalid Firebase Database URL",o),We(o.path)||wi("Database URL must point to the root of a Firebase Database (not including a child path).");const u=AI(a,i,c,new BC(i,t));return new CI(u,i)}function wI(i,e){const t=bh[e];(!t||t[i.key]!==i)&&wi(`Database ${e}(${i.repoInfo_}) has already been deleted.`),dI(i),delete t[i.key]}function AI(i,e,t,n){let r=bh[e.name];r||(r={},bh[e.name]=r);let s=r[i.toURLString()];return s&&wi("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new sI(i,MI,t,n),r[i.toURLString()]=s,s}class CI{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(oI(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ci(this._repo,tt())),this._rootInternal}_delete(){return this._rootInternal!==null&&(wI(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&wi("Cannot call "+e+" on a deleted database.")}}function RI(i=ud(),e){const t=ea(i,"database").getImmediate({identifier:e});if(!t._instanceStarted){const n=Yw("database");n&&II(t,...n)}return t}function II(i,e,t,n={}){i=rr(i),i._checkNotDeleted("useEmulator");const r=`${e}:${t}`,s=i._repoInternal;if(i._instanceStarted){if(r===i._repoInternal.repoInfo_.host&&Fo(n,s.repoInfo_.emulatorOptions))return;wi("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(s.repoInfo_.nodeAdmin)n.mockUserToken&&wi('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Ya(Ya.OWNER);else if(n.mockUserToken){const a=typeof n.mockUserToken=="string"?n.mockUserToken:$w(n.mockUserToken,i.app.options.projectId);o=new Ya(a)}TI(s,r,n,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(i){MC(uC),Ji(new Ti("database",(e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return bI(n,r,s,t)},"PUBLIC").setMultipleInstances(!0)),Qn(Up,Fp,i),Qn(Up,Fp,"esm2017")}yi.prototype.simpleListen=function(i,e){this.sendRequest("q",{p:i},e)};yi.prototype.echo=function(i,e){this.sendRequest("echo",{d:i},e)};PI();const $v="@firebase/installations",Vd="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kv=1e4,jv=`w:${Vd}`,Zv="FIS_v2",DI="https://firebaseinstallations.googleapis.com/v1",LI=60*60*1e3,NI="installations",OI="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zI({appConfig:i,heartbeatServiceProvider:e},{fid:t}){const n=Qv(i),r=n0(i),s=e.getImmediate({optional:!0});if(s){const c=await s.getHeartbeatsHeader();c&&r.append("x-firebase-client",c)}const o={fid:t,authVersion:Zv,appId:i.appId,sdkVersion:jv},a={method:"POST",headers:r,body:JSON.stringify(o)},l=await i0(()=>fetch(n,a));if(l.ok){const c=await l.json();return{fid:c.fid||t,registrationStatus:2,refreshToken:c.refreshToken,authToken:e0(c.authToken)}}else throw await t0("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HI=/^[cdef][\w-]{21}$/,wh="";function GI(){try{const i=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(i),i[0]=112+i[0]%16;const t=WI(i);return HI.test(t)?t:wh}catch{return wh}}function WI(i){return VI(i).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s0=new Map;function o0(i,e){const t=ql(i);a0(t,e),XI(t,e)}function a0(i,e){const t=s0.get(i);if(t)for(const n of t)n(e)}function XI(i,e){const t=qI();t&&t.postMessage({key:i,fid:e}),YI()}let Cr=null;function qI(){return!Cr&&"BroadcastChannel"in self&&(Cr=new BroadcastChannel("[Firebase] FID Change"),Cr.onmessage=i=>{a0(i.data.key,i.data.fid)}),Cr}function YI(){s0.size===0&&Cr&&(Cr.close(),Cr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $I="firebase-installations-database",KI=1,Vr="firebase-installations-store";let Zc=null;function Hd(){return Zc||(Zc=Ag($I,KI,{upgrade:(i,e)=>{switch(e){case 0:i.createObjectStore(Vr)}}})),Zc}async function El(i,e){const t=ql(i),r=(await Hd()).transaction(Vr,"readwrite"),s=r.objectStore(Vr),o=await s.get(t);return await s.put(e,t),await r.done,(!o||o.fid!==e.fid)&&o0(i,e.fid),e}async function l0(i){const e=ql(i),n=(await Hd()).transaction(Vr,"readwrite");await n.objectStore(Vr).delete(e),await n.done}async function Yl(i,e){const t=ql(i),r=(await Hd()).transaction(Vr,"readwrite"),s=r.objectStore(Vr),o=await s.get(t),a=e(o);return a===void 0?await s.delete(t):await s.put(a,t),await r.done,a&&(!o||o.fid!==a.fid)&&o0(i,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gd(i){let e;const t=await Yl(i.appConfig,n=>{const r=jI(n),s=ZI(i,r);return e=s.registrationPromise,s.installationEntry});return t.fid===wh?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function jI(i){const e=i||{fid:GI(),registrationStatus:0};return c0(e)}function ZI(i,e){if(e.registrationStatus===0){if(!navigator.onLine){const r=Promise.reject(zr.create("app-offline"));return{installationEntry:e,registrationPromise:r}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},n=JI(i,t);return{installationEntry:t,registrationPromise:n}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:QI(i)}:{installationEntry:e}}async function JI(i,e){try{const t=await zI(i,e);return El(i.appConfig,t)}catch(t){throw Jv(t)&&t.customData.serverCode===409?await l0(i.appConfig):await El(i.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function QI(i){let e=await mm(i.appConfig);for(;e.registrationStatus===1;)await r0(100),e=await mm(i.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:n}=await Gd(i);return n||t}return e}function mm(i){return Yl(i,e=>{if(!e)throw zr.create("installation-not-found");return c0(e)})}function c0(i){return eP(i)?{fid:i.fid,registrationStatus:0}:i}function eP(i){return i.registrationStatus===1&&i.registrationTime+Kv<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tP({appConfig:i,heartbeatServiceProvider:e},t){const n=nP(i,t),r=FI(i,t),s=e.getImmediate({optional:!0});if(s){const c=await s.getHeartbeatsHeader();c&&r.append("x-firebase-client",c)}const o={installation:{sdkVersion:jv,appId:i.appId}},a={method:"POST",headers:r,body:JSON.stringify(o)},l=await i0(()=>fetch(n,a));if(l.ok){const c=await l.json();return e0(c)}else throw await t0("Generate Auth Token",l)}function nP(i,{fid:e}){return`${Qv(i)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wd(i,e=!1){let t;const n=await Yl(i.appConfig,s=>{if(!u0(s))throw zr.create("not-registered");const o=s.authToken;if(!e&&sP(o))return s;if(o.requestStatus===1)return t=iP(i,e),s;{if(!navigator.onLine)throw zr.create("app-offline");const a=aP(s);return t=rP(i,a),a}});return t?await t:n.authToken}async function iP(i,e){let t=await _m(i.appConfig);for(;t.authToken.requestStatus===1;)await r0(100),t=await _m(i.appConfig);const n=t.authToken;return n.requestStatus===0?Wd(i,e):n}function _m(i){return Yl(i,e=>{if(!u0(e))throw zr.create("not-registered");const t=e.authToken;return lP(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function rP(i,e){try{const t=await tP(i,e),n=Object.assign(Object.assign({},e),{authToken:t});return await El(i.appConfig,n),t}catch(t){if(Jv(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await l0(i.appConfig);else{const n=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await El(i.appConfig,n)}throw t}}function u0(i){return i!==void 0&&i.registrationStatus===2}function sP(i){return i.requestStatus===2&&!oP(i)}function oP(i){const e=Date.now();return e<i.creationTime||i.creationTime+i.expiresIn<e+LI}function aP(i){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},i),{authToken:e})}function lP(i){return i.requestStatus===1&&i.requestTime+Kv<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dP(i){if(!i||!i.options)throw Jc("App Configuration");if(!i.name)throw Jc("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!i.options[t])throw Jc(t);return{appName:i.name,projectId:i.options.projectId,apiKey:i.options.apiKey,appId:i.options.appId}}function Jc(i){return zr.create("missing-app-config-values",{valueName:i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const h0="installations",fP="installations-internal",pP=i=>{const e=i.getProvider("app").getImmediate(),t=dP(e),n=ea(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},mP=i=>{const e=i.getProvider("app").getImmediate(),t=ea(e,h0).getImmediate();return{getId:()=>cP(t),getToken:r=>uP(t,r)}};function _P(){Ji(new Ti(h0,pP,"PUBLIC")),Ji(new Ti(fP,mP,"PRIVATE"))}_P();Qn($v,Vd);Qn($v,Vd,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EP(i){if(!i.startsWith(Xd)){const e=Sn.create("invalid-gtag-resource",{gtagURL:i});return hn.warn(e.message),""}return i}function d0(i){return Promise.all(i.map(e=>e.catch(t=>t)))}function MP(i,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(i,e)),t}function TP(i,e){const t=MP("firebase-js-sdk-policy",{createScriptURL:EP}),n=document.createElement("script"),r=`${Xd}?l=${i}&id=${e}`;n.src=t?t==null?void 0:t.createScriptURL(r):r,n.async=!0,document.head.appendChild(n)}function bP(i){let e=[];return Array.isArray(window[i])?e=window[i]:window[i]=e,e}async function wP(i,e,t,n,r,s){const o=n[r];try{if(o)await e[o];else{const l=(await d0(t)).find(c=>c.measurementId===r);l&&await e[l.appId]}}catch(a){hn.error(a)}i("config",r,s)}async function AP(i,e,t,n,r){try{let s=[];if(r&&r.send_to){let o=r.send_to;Array.isArray(o)||(o=[o]);const a=await d0(t);for(const l of o){const c=a.find(h=>h.measurementId===l),u=c&&e[c.appId];if(u)s.push(u);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),i("event",n,r||{})}catch(s){hn.error(s)}}function CP(i,e,t,n){async function r(s,...o){try{if(s==="event"){const[a,l]=o;await AP(i,e,t,a,l)}else if(s==="config"){const[a,l]=o;await wP(i,e,t,n,a,l)}else if(s==="consent"){const[a,l]=o;i("consent",a,l)}else if(s==="get"){const[a,l,c]=o;i("get",a,l,c)}else if(s==="set"){const[a]=o;i("set",a)}else i(s,...o)}catch(a){hn.error(a)}}return r}function RP(i,e,t,n,r){let s=function(...o){window[n].push(arguments)};return window[r]&&typeof window[r]=="function"&&(s=window[r]),window[r]=CP(s,i,e,t),{gtagCore:s,wrappedGtag:window[r]}}function IP(i){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(Xd)&&t.src.includes(i))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PP=30,DP=1e3;class LP{constructor(e={},t=DP){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const f0=new LP;function NP(i){return new Headers({Accept:"application/json","x-goog-api-key":i})}async function OP(i){var e;const{appId:t,apiKey:n}=i,r={method:"GET",headers:NP(n)},s=yP.replace("{app-id}",t),o=await fetch(s,r);if(o.status!==200&&o.status!==304){let a="";try{const l=await o.json();!((e=l.error)===null||e===void 0)&&e.message&&(a=l.error.message)}catch{}throw Sn.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function UP(i,e=f0,t){const{appId:n,apiKey:r,measurementId:s}=i.options;if(!n)throw Sn.create("no-app-id");if(!r){if(s)return{measurementId:s,appId:n};throw Sn.create("no-api-key")}const o=e.getThrottleMetadata(n)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new BP;return setTimeout(async()=>{a.abort()},xP),p0({appId:n,apiKey:r,measurementId:s},o,a,e)}async function p0(i,{throttleEndTimeMillis:e,backoffCount:t},n,r=f0){var s;const{appId:o,measurementId:a}=i;try{await FP(n,e)}catch(l){if(a)return hn.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw l}try{const l=await OP(i);return r.deleteThrottleMetadata(o),l}catch(l){const c=l;if(!kP(c)){if(r.deleteThrottleMetadata(o),a)return hn.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:a};throw l}const u=Number((s=c==null?void 0:c.customData)===null||s===void 0?void 0:s.httpStatus)===503?wp(t,r.intervalMillis,PP):wp(t,r.intervalMillis),h={throttleEndTimeMillis:Date.now()+u,backoffCount:t+1};return r.setThrottleMetadata(o,h),hn.debug(`Calling attemptFetch again in ${u} millis`),p0(i,h,n,r)}}function FP(i,e){return new Promise((t,n)=>{const r=Math.max(e-Date.now(),0),s=setTimeout(t,r);i.addEventListener(()=>{clearTimeout(s),n(Sn.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function kP(i){if(!(i instanceof Wr)||!i.customData)return!1;const e=Number(i.customData.httpStatus);return e===429||e===500||e===503||e===504}class BP{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function zP(i,e,t,n,r){if(r&&r.global){i("event",t,n);return}else{const s=await e,o=Object.assign(Object.assign({},n),{send_to:s});i("event",t,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GP{constructor(e){this.app=e}_delete(){return delete To[this.app.options.appId],Promise.resolve()}}let To={},gm=[];const vm={};let Qc="dataLayer",WP="gtag",xm,m0,ym=!1;function XP(){const i=[];if(jw()&&i.push("This is a browser extension environment."),Qw()||i.push("Cookies are not available."),i.length>0){const e=i.map((n,r)=>`(${r+1}) ${n}`).join(" "),t=Sn.create("invalid-analytics-context",{errorInfo:e});hn.warn(t.message)}}function qP(i,e,t){XP();const n=i.options.appId;if(!n)throw Sn.create("no-app-id");if(!i.options.apiKey)if(i.options.measurementId)hn.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${i.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Sn.create("no-api-key");if(To[n]!=null)throw Sn.create("already-exists",{id:n});if(!ym){bP(Qc);const{wrappedGtag:s,gtagCore:o}=RP(To,gm,vm,Qc,WP);m0=s,xm=o,ym=!0}return To[n]=HP(i,gm,vm,e,xm,Qc,t),new GP(i)}function YP(i=ud()){i=rr(i);const e=ea(i,Ml);return e.isInitialized()?e.getImmediate():$P(i)}function $P(i,e={}){const t=ea(i,Ml);if(t.isInitialized()){const r=t.getImmediate();if(Fo(e,t.getOptions()))return r;throw Sn.create("already-initialized")}return t.initialize({options:e})}function KP(i,e,t,n){i=rr(i),zP(m0,To[i.app.options.appId],e,t,n).catch(r=>hn.error(r))}const Sm="@firebase/analytics",Em="0.10.12";function jP(){Ji(new Ti(Ml,(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return qP(n,r,t)},"PUBLIC")),Ji(new Ti("analytics-internal",i,"PRIVATE")),Qn(Sm,Em),Qn(Sm,Em,"esm2017");function i(e){try{const t=e.getProvider(Ml).getImmediate();return{logEvent:(n,r,s)=>KP(t,n,r,s)}}catch(t){throw Sn.create("interop-component-reg-failed",{reason:t})}}}jP();const ZP={apiKey:"AIzaSyCZc5d2NnbnbJQ6-NLCHC-p6GpAgxt9yoA",authDomain:"ipl-demo-1f34f.firebaseapp.com",databaseURL:"https://ipl-demo-1f34f-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"ipl-demo-1f34f",storageBucket:"ipl-demo-1f34f.firebasestorage.app",messagingSenderId:"1039982880775",appId:"1:1039982880775:web:65b69d364442fd1663e2a2",measurementId:"G-KKGNMTP40Z"};let Tl;try{Tl=ud()}catch{Tl=Cg(ZP)}const Hs=RI(Tl);YP(Tl);async function JP(i){var t;console.log(`Fetching scorecard for match ID: ${i}`);const e={method:"GET",headers:{"x-rapidapi-key":"1c37589a58mshc93066d03b8f756p10323bjsne1bd7a81f68f","x-rapidapi-host":"cricbuzz-cricket.p.rapidapi.com"}};try{const r=await(await fetch(`https://cricbuzz-cricket.p.rapidapi.com/mcenter/v1/${i}/scard`,e)).json();if(console.log(`Received scorecard data for match ${i}:`,r),r.isMatchComplete){console.log(`Match ${i} is complete. Status: ${r.status}`);const l=Vs(Hs,`IPL Data/Live Scores/${i}`);return await Th(l,{matchId:i,matchStatus:r.status,isComplete:!0,lastUpdated:Date.now()}),{isComplete:!0,status:r.status,matchId:i}}const s=(t=r.scorecard)==null?void 0:t[r.scorecard.length-1];if(console.log("Current innings data:",s),!s)return console.log(`No current innings data available for match ${i}`),null;const o={matchId:i,matchStatus:r.status,currentInnings:{battingTeam:s.batTeamSName||"",score:parseInt(s.score)||0,wickets:parseInt(s.wickets)||0,overs:parseFloat(s.overs)||0,runRate:parseFloat(s.runRate)||0},lastUpdated:Date.now()};console.log("Formatted score info for Firebase:",o);const a=Vs(Hs,`IPL Data/Live Scores/${i}`);return await Th(a,o),console.log(`Successfully stored score info in Firebase for match ${i}`),{isComplete:!1,scoreInfo:o}}catch(n){throw console.error(`Error fetching score for match ${i}:`,n),n}}async function QP(i){console.log("Fetching next match after:",i);try{const e=Vs(Hs,"IPL Data/Match Schedule"),t=await Bd(e);if(!t.exists())return console.log("No match schedule found in Firebase"),null;const n=t.val();console.log("All matches:",n);const r=Array.isArray(n)?n:Object.values(n),s=r.findIndex(l=>l.matchId===i);if(console.log("Current match index:",s),s===-1)return console.log("Current match not found in schedule"),null;const o=r[s+1];if(console.log("Found next match:",o),!o)return console.log("No next match found"),null;const a={matchId:o.matchId,matchNumber:o.matchNumber,teams:{team1:o.teams.team1,team2:o.teams.team2},venue:{ground:o.venue.ground,city:o.venue.city},timing:{startTime:o.timing.startTime}};return console.log("Formatted next match:",a),a}catch(e){return console.error("Error getting next match:",e),null}}console.log("Three.js Version:",wl);const aa=new Vx,$l=new Rn(50,window.innerWidth/window.innerHeight,.1,1e3);$l.position.set(0,0,1);$l.lookAt(0,0,0);const Ri=new gb({antialias:!0,alpha:!0});Ri.setSize(window.innerWidth,window.innerHeight);Ri.setPixelRatio(Math.min(window.devicePixelRatio,2));Ri.xr.enabled=!0;Ri.shadowMap.enabled=!0;Ri.shadowMap.type=Rm;document.body.appendChild(Ri.domElement);const eD=nD(Ri);document.body.appendChild(eD);const tD=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream;function nD(i){if(tD){const e=document.createElement("button");return e.style.cssText=`
            position: absolute;
            bottom: 20px;
            left: 50%;
            ...
            cursor: pointer;
            z-index: 999;
        `,e.textContent="Start AR",e.addEventListener("click",async()=>{try{const t=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:document.body}});i.xr.setReferenceSpaceType("local"),await i.xr.setSession(t),t.addEventListener("end",()=>{i.xr.setSession(null)}),i.setAnimationLoop(v0)}catch(t){console.error("Error starting AR session:",t),alert("AR not supported on this device")}}),e}else return vb.createButton(i)}const ot=new ao;ot.rotation.y=Math.PI;aa.add(ot);const iD=new Hr(.6,.3,.02),rD=new zh({color:16777215,metalness:.3,roughness:.1,transparent:!0,opacity:.95,side:Fn,envMapIntensity:1.5,clearcoat:.5,clearcoatRoughness:.1}),Kl=new In(iD,rD);Kl.castShadow=!0;Kl.receiveShadow=!0;ot.add(Kl);const sD=new Hr(.62,.32,.01),bl=new zh({color:1733608,transparent:!0,opacity:.15,side:Fn,emissive:1733608,emissiveIntensity:.5}),_0=new In(sD,bl);_0.position.z=-.01;ot.add(_0);ot.position.set(0,0,-.5);const oD=new Py(16777215,.6);aa.add(oD);const qd=new u_(16777215,1.2);qd.position.set(2,5,2);qd.castShadow=!0;aa.add(qd);const Yd=new u_(1733608,.4);Yd.position.set(0,0,-3);aa.add(Yd);function tn(i,e,t,n,r){const s=new Eb(i,{font:e,size:t,height:.001,curveSegments:12,bevelEnabled:!1,bevelThickness:0,bevelSize:0,bevelSegments:0});s.computeBoundingBox(),s.center();const o=new zh({color:n,metalness:.2,roughness:.4}),a=new In(s,o);a.position.set(0,r,-.011),a.rotation.set(0,Math.PI,0),a.scale.z=1e-4,a.castShadow=!0,ot.add(a)}let fo=!1;const Mm=new Ly,eu=new he;let Yo=!1,$a={x:0,y:0},pi={x:0,y:0},$o=!0,Tm=0,bm=0;function aD(i){if(Tm=i.clientX/window.innerWidth*2-1,bm=-(i.clientY/window.innerHeight)*2+1,eu.x=Tm,eu.y=bm,Yo){const t={x:i.clientX-$a.x,y:i.clientY-$a.y};pi.x=t.y*.005,pi.y=t.x*.005}$a={x:i.clientX,y:i.clientY},Mm.setFromCamera(eu,$l);const e=Mm.intersectObject(Kl);e.length>0&&!fo?(fo=!0,$o=!1,ho.to(ot.scale,{x:1.05,y:1.05,z:1.05,duration:.4,ease:"power2.out"}),ho.to(bl,{opacity:.25,emissiveIntensity:.8,duration:.4}),document.body.style.cursor="grab"):e.length===0&&fo&&(fo=!1,$o=!0,ho.to(ot.scale,{x:1,y:1,z:1,duration:.4,ease:"power2.out"}),ho.to(bl,{opacity:.15,emissiveIntensity:.5,duration:.4}),document.body.style.cursor="default")}function lD(i){Yo=!0,$o=!1,document.body.style.cursor="grabbing",$a={x:i.clientX,y:i.clientY}}function g0(){Yo=!1,$o=!0,document.body.style.cursor=fo?"grab":"default",pi={x:0,y:0}}function cD(){Ri.setAnimationLoop(v0)}function v0(){const i=Date.now()*1e-4%1;Yd.color.setHSL(i,.5,.5);const e=Math.sin(Date.now()*.002)*.1+.9;if(bl.emissiveIntensity=.5*e,$o){const t=ot.rotation.y+.005;ot.rotation.y+=(t-ot.rotation.y)*.98}Yo&&(ot.rotation.x+=pi.x,ot.rotation.y+=pi.y,ot.rotation.x=Math.max(-Math.PI/4,Math.min(Math.PI/4,ot.rotation.x))),Yo||(pi.x*=.95,pi.y*=.95,ot.rotation.x+=pi.x,ot.rotation.y+=pi.y),ot.position.y=Math.sin(Date.now()*.001)*.01,Ri.render(aa,$l)}async function uD(){try{const i=Vs(Hs,"IPL Data/test");await Th(i,{timestamp:Date.now(),message:"Test connection"}),console.log("Database connection successful");const e=Vs(Hs,"IPL Data/Match Schedule"),t=await Bd(e);if(t.exists()){const n=t.val();console.log("All matches:",n);const r=Array.isArray(n)?n:Object.values(n),s=r.findIndex(o=>o.matchId===114960);if(console.log("Current match index:",s),s!==-1){const o=r[s+1];if(console.log("Next match after 114960:",o),o)console.log("Displaying next match:",o),Ka(o);else{console.log("No next match found after 114960");const a=r[s];Ka(a)}}else{console.log("Match ID 114960 not found in schedule");const o=r[0];Ka(o)}}else console.log("No match schedule found in Firebase")}catch(i){console.error("Initialization error:",i)}}async function hD(i,e){console.log(`Match ${i} completed. Status: ${e}`),window.currentUpdateInterval&&(clearInterval(window.currentUpdateInterval),window.currentUpdateInterval=null);const t=await QP(i);if(console.log("Next match data:",t),t){for(console.log("Switching to next match:",t);ot.children.length>2;)ot.remove(ot.children[2]);ps=t.matchId,new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(r){tn(t.matchNumber,r,.03,1733608,.1),tn(`${t.teams.team1} vs ${t.teams.team2}`,r,.04,0,.05),tn(`${t.venue.ground}, ${t.venue.city}`,r,.02,6710886,-.08);const o=new Date(parseInt(t.timing.startTime)).toLocaleString("en-US",{timeZone:"Asia/Kolkata",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!0});tn(`${o} IST`,r,.02,6710886,-.12),x0(t.timing.startTime)})}else console.log("No more matches scheduled"),new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(r){for(;ot.children.length>2;)ot.remove(ot.children[2]);tn("No more matches scheduled",r,.04,0,0)})}function x0(i){let e,t=!1,n=!1;const r=()=>{const s=Date.now(),a=parseInt(i)-s;if(a>0){const l=Math.floor(a/864e5),c=Math.floor(a%(1e3*60*60*24)/(1e3*60*60)),u=Math.floor(a%(1e3*60*60)/(1e3*60)),h=Math.floor(a%(1e3*60)/1e3),d=`Starts in: ${l}d ${c}h ${u}m ${h}s`;wm(d),!n&&a<=6e5&&(console.log("Less than 10 minutes to match, starting API calls"),n=!0,ps&&Am(ps))}else t||(t=!0,wm("Match Started!"),ps&&Am(ps))};return e=setInterval(r,1e3),r(),()=>{e&&clearInterval(e)}}function wm(i){new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(t){const n=ot.children.find(s=>s.userData&&s.userData.isCountdown);n&&ot.remove(n);const r=tn(i,t,.025,1733608,-.13);r&&(r.userData.isCountdown=!0)})}async function Ka(i,e=null){new Qa().load("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json",function(n){for(;ot.children.length>2;)ot.remove(ot.children[2]);if(i)try{ps=i.matchId,tn(i.matchNumber,n,.03,1733608,.12);let r=i.teams.team1,s=i.teams.team2;if(e&&e.currentInnings){const l=e.currentInnings.battingTeam;l===i.teams.team1?r=`${r} *`:l===i.teams.team2&&(s=`${s} *`)}if(tn(`${r} vs ${s}`,n,.04,0,.06),e&&e.currentInnings){tn(e.matchStatus,n,.02,6710886,.02);const l=`${e.currentInnings.score}/${e.currentInnings.wickets} (${e.currentInnings.overs} ov)`;tn(l,n,.025,0,-.02),tn(`RR: ${e.currentInnings.runRate}`,n,.02,6710886,-.06)}tn(`${i.venue.ground}, ${i.venue.city}`,n,.02,6710886,-.1);const a=new Date(parseInt(i.timing.startTime)).toLocaleString("en-US",{timeZone:"Asia/Kolkata",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!0});tn(`${a} IST`,n,.02,6710886,-.14),x0(i.timing.startTime)}catch(r){console.error("Error updating match display:",r),tn("Error Loading Data",n,.04,1733608,0)}})}function Am(i){console.log(`Setting up periodic score updates for match ${i}`),window.currentUpdateInterval&&clearInterval(window.currentUpdateInterval);async function e(){try{console.log(`Fetching score for match ${i}`);const t=await JP(i);if(console.log("Score fetch result:",t),t!=null&&t.isComplete)return console.log(`Match ${i} is complete, handling completion...`),hD(t.matchId,t.status),!0;if(t!=null&&t.scoreInfo){const n=Vs(Hs,"IPL Data/Match Schedule"),r=await Bd(n);if(r.exists()){const s=r.val(),a=(Array.isArray(s)?s:Object.values(s)).find(l=>l.matchId===i);a&&Ka(a,t.scoreInfo)}}return!1}catch(t){return t.message.includes("429")?(console.log("Rate limit reached, waiting before next request..."),await new Promise(n=>setTimeout(n,12e4))):console.error("Error in score fetch:",t),!1}}e().then(t=>{if(t)return;const n=setInterval(async()=>{await e()&&(clearInterval(n),window.currentUpdateInterval=null)},6e4);window.currentUpdateInterval=n})}window.addEventListener("pointermove",aD);window.addEventListener("pointerdown",lD);window.addEventListener("pointerup",g0);window.addEventListener("pointerleave",g0);uD();cD();let ps=null;window.addEventListener("beforeunload",()=>{window.currentUpdateInterval&&clearInterval(window.currentUpdateInterval)});
